(function(){const p=document.createElement("link").relList;if(p&&p.supports&&p.supports("modulepreload"))return;for(const x of document.querySelectorAll('link[rel="modulepreload"]'))n(x);new MutationObserver(x=>{for(const E of x)if(E.type==="childList")for(const S of E.addedNodes)S.tagName==="LINK"&&S.rel==="modulepreload"&&n(S)}).observe(document,{childList:!0,subtree:!0});function T(x){const E={};return x.integrity&&(E.integrity=x.integrity),x.referrerPolicy&&(E.referrerPolicy=x.referrerPolicy),x.crossOrigin==="use-credentials"?E.credentials="include":x.crossOrigin==="anonymous"?E.credentials="omit":E.credentials="same-origin",E}function n(x){if(x.ep)return;x.ep=!0;const E=T(x);fetch(x.href,E)}})();var T5={exports:{}},Ht={};/**
 * @license React
 ...
 */var R6;function On(){if(R6)return Ht;R6=1;var d=Symbol.for("react.transitional.element"),p=Symbol.for("react.fragment");function T(n,x,E){var S=null;if(E!==void 0&&(S=""+E),x.key!==void 0&&(S=""+x.key),"key"in x){E={};for(var j in x)j!=="key"&&(E[j]=x[j])}else E=x;return x=E.ref,{$$typeof:d,type:n,key:S,ref:x!==void 0?x:null,props:E}}return Ht.Fragment=p,Ht.jsx=T,Ht.jsxs=T,Ht}var j6;function Nn(){return j6||(j6=1,T5.exports=On()),T5.exports}var R=Nn(),v5={exports:{}},I={};/**
 * @license React
 * react.production.js
 *
 * Copyright (c) Meta Platforms, Inc. and affiliates.
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var H6;function Cn(){if(H6)return I;H6=1;var d=Symbol.for("react.transitional.element"),p=Symbol.for("react.portal"),T=Symbol.for("react.fragment"),n=Symbol.for("react.strict_mode"),x=Symbol.for("react.profiler"),E=Symbol.for("react.consumer"),S=Symbol.for("react.context"),j=Symbol.for("react.forward_ref"),N=Symbol.for("react.suspense"),f=Symbol.for("react.memo"),B=Symbol.for("react.lazy"),Y=Symbol.for("react.activity"),X=Symbol.iterator;function i0(m){return m===null||typeof m!="object"?null:(m=X&&m[X]||m["@@iterator"],typeof m=="function"?m:null)}var h0={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},u0=Object.assign,y0={};function r0(m,D,v){this.props=m,this.context=D,this.refs=y0,this.updater=v||h0}r0.prototype.isReactComponent={},r0.prototype.setState=function(m,D){if(typeof m!="object"&&typeof m!="function"&&m!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,m,D,"setState")},r0.prototype.forceUpdate=function(m){this.updater.enqueueForceUpdate(this,m,"forceUpdate")};function n0(){}n0.prototype=r0.prototype;function d0(m,D,v){this.props=m,this.context=D,this.refs=y0,this.updater=v||h0}var P=d0.prototype=new n0;P.constructor=d0,u0(P,r0.prototype),P.isPureReactComponent=!0;var m0=Array.isArray;function U0(){}var W={H:null,A:null,T:null,S:null},Y0=Object.prototype.hasOwnProperty;function F0(m,D,v){var O=v.ref;return{$$typeof:d,type:m,key:D,ref:O!==void 0?O:null,props:v}}function H0(m,D){return F0(m.type,D,m.props)}function t0(m){return typeof m=="object"&&m!==null&&m.$$typeof===d}function E0(m){var D={"=":"=0",":":"=2"};return"$"+m.replace(/[=:]/g,function(v){return D[v]})}var K=/\/+/g;function G0(m,D){return typeof m=="object"&&m!==null&&m.key!=null?E0(""+m.key):D.toString(36)}function Z0(m){switch(m.status){case"fulfilled":return m.value;case"rejected":throw m.reason;default:switch(typeof m.status=="string"?m.then(U0,U0):(m.status="pending",m.then(function(D){m.status==="pending"&&(m.status="fulfilled",m.value=D)},function(D){m.status==="pending"&&(m.status="rejected",m.reason=D)})),m.status){case"fulfilled":return m.value;case"rejected":throw m.reason}}throw m}function M(m,D,v,O,q){var H=typeof m;(H==="undefined"||H==="boolean")&&(m=null);var z=!1;if(m===null)z=!0;else switch(H){case"bigint":case"string":case"number":z=!0;break;case"object":switch(m.$$typeof){case d:case p:z=!0;break;case B:return z=m._init,M(z(m._payload),D,v,O,q)}}if(z)return q=q(m),z=O===""?"."+G0(m,0):O,m0(q)?(v="",z!=null&&(v=z.replace(K,"$&/")+"/"),M(q,D,v,"",function(F){return F})):q!=null&&(t0(q)&&(q=H0(q,v+(q.key==null||m&&m.key===q.key?"":(""+q.key).replace(K,"$&/")+"/")+z)),D.push(q)),1;z=0;var G=O===""?".":O+":";if(m0(m))for(var Z=0;Z<m.length;Z++)O=m[Z],H=G+G0(O,Z),z+=M(O,D,v,H,q);else if(Z=i0(m),typeof Z=="function")for(m=Z.call(m),Z=0;!(O=m.next()).done;)O=O.value,H=G+G0(O,Z++),z+=M(O,D,v,H,q);else if(H==="object"){if(typeof m.then=="function")return M(Z0(m),D,v,O,q);throw D=String(m),Error("Objects are not valid as a React child (found: "+(D==="[object Object]"?"object with keys {"+Object.keys(m).join(", ")+"}":D)+"). If you meant to render a collection of children, use an array instead.")}return z}function L(m,D,v){if(m==null)return m;var O=[],q=0;return M(m,O,"","",function(H){return D.call(v,H,q++)}),O}function w(m){if(m._status===-1){var D=m._result;D=D(),D.then(function(v){(m._status===0||m._status===-1)&&(m._status=1,m._result=v)},function(v){(m._status===0||m._status===-1)&&(m._status=2,m._result=v)}),m._status===-1&&(m._status=0,m._result=D)}if(m._status===1)return m._result.default;throw m._result}var T0=typeof reportError=="function"?reportError:function(m){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var D=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof m=="object"&&m!==null&&typeof m.message=="string"?String(m.message):String(m),error:m});if(!window.dispatchEvent(D))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",m);return}console.error(m)},S0={map:L,forEach:function(m,D,v){L(m,function(){D.apply(this,arguments)},v)},count:function(m){var D=0;return L(m,function(){D++}),D},toArray:function(m){return L(m,function(D){return D})||[]},only:function(m){if(!t0(m))throw Error("React.Children.only expected to receive a single React element child.");return m}};return I.Activity=Y,I.Children=S0,I.Component=r0,I.Fragment=T,I.Profiler=x,I.PureComponent=d0,I.StrictMode=n,I.Suspense=N,I.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=W,I.__COMPILER_RUNTIME={__proto__:null,c:function(m){return W.H.useMemoCache(m)}},I.cache=function(m){return function(){return m.apply(null,arguments)}},I.cacheSignal=function(){return null},I.cloneElement=function(m,D,v){if(m==null)throw Error("The argument must be a React element, but you passed "+m+".");var O=u0({},m.props),q=m.key;if(D!=null)for(H in D.key!==void 0&&(q=""+D.key),D)!Y0.call(D,H)||H==="key"||H==="__self"||H==="__source"||H==="ref"&&D.ref===void 0||(O[H]=D[H]);var H=arguments.length-2;if(H===1)O.children=v;else if(1<H){for(var z=Array(H),G=0;G<H;G++)z[G]=arguments[G+2];O.children=z}return F0(m.type,q,O)},I.createContext=function(m){return m={$$typeof:S,_currentValue:m,_currentValue2:m,_threadCount:0,Provider:null,Consumer:null},m.Provider=m,m.Consumer={$$typeof:E,_context:m},m},I.createElement=function(m,D,v){var O,q={},H=null;if(D!=null)for(O in D.key!==void 0&&(H=""+D.key),D)Y0.call(D,O)&&O!=="key"&&O!=="__self"&&O!=="__source"&&(q[O]=D[O]);var z=arguments.length-2;if(z===1)q.children=v;else if(1<z){for(var G=Array(z),Z=0;Z<z;Z++)G[Z]=arguments[Z+2];q.children=G}if(m&&m.defaultProps)for(O in z=m.defaultProps,z)q[O]===void 0&&(q[O]=z[O]);return F0(m,H,q)},I.createRef=function(){return{current:null}},I.forwardRef=function(m){return{$$typeof:j,render:m}},I.isValidElement=t0,I.lazy=function(m){return{$$typeof:B,_payload:{_status:-1,_result:m},_init:w}},I.memo=function(m,D){return{$$typeof:f,type:m,compare:D===void 0?null:D}},I.startTransition=function(m){var D=W.T,v={};W.T=v;try{var O=m(),q=W.S;q!==null&&q(v,O),typeof O=="object"&&O!==null&&typeof O.then=="function"&&O.then(U0,T0)}catch(H){T0(H)}finally{D!==null&&v.types!==null&&(D.types=v.types),W.T=D}},I.unstable_useCacheRefresh=function(){return W.H.useCacheRefresh()},I.use=function(m){return W.H.use(m)},I.useActionState=function(m,D,v){return W.H.useActionState(m,D,v)},I.useCallback=function(m,D){return W.H.useCallback(m,D)},I.useContext=function(m){return W.H.useContext(m)},I.useDebugValue=function(){},I.useDeferredValue=function(m,D){return W.H.useDeferredValue(m,D)},I.useEffect=function(m,D){return W.H.useEffect(m,D)},I.useEffectEvent=function(m){return W.H.useEffectEvent(m)},I.useId=function(){return W.H.useId()},I.useImperativeHandle=function(m,D,v){return W.H.useImperativeHandle(m,D,v)},I.useInsertionEffect=function(m,D){return W.H.useInsertionEffect(m,D)},I.useLayoutEffect=function(m,D){return W.H.useLayoutEffect(m,D)},I.useMemo=function(m,D){return W.H.useMemo(m,D)},I.useOptimistic=function(m,D){return W.H.useOptimistic(m,D)},I.useReducer=function(m,D,v){return W.H.useReducer(m,D,v)},I.useRef=function(m){return W.H.useRef(m)},I.useState=function(m){return W.H.useState(m)},I.useSyncExternalStore=function(m,D,v){return W.H.useSyncExternalStore(m,D,v)},I.useTransition=function(){return W.H.useTransition()},I.version="19.2.7",I}var q6;function C5(){return q6||(q6=1,v5.exports=Cn()),v5.exports}var k=C5(),g5={exports:{}},qt={},S5={exports:{}},b5={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Y6;function Dn(){return Y6||(Y6=1,(function(d){function p(M,L){var w=M.length;M.push(L);e:for(;0<w;){var T0=w-1>>>1,S0=M[T0];if(0<x(S0,L))M[T0]=L,M[w]=S0,w=T0;else break e}}function T(M){return M.length===0?null:M[0]}function n(M){if(M.length===0)return null;var L=M[0],w=M.pop();if(w!==L){M[0]=w;e:for(var T0=0,S0=M.length,m=S0>>>1;T0<m;){var D=2*(T0+1)-1,v=M[D],O=D+1,q=M[O];if(0>x(v,w))O<S0&&0>x(q,v)?(M[T0]=q,M[O]=w,T0=O):(M[T0]=v,M[D]=w,T0=D);else if(O<S0&&0>x(q,w))M[T0]=q,M[O]=w,T0=O;else break e}}return L}function x(M,L){var w=M.sortIndex-L.sortIndex;return w!==0?w:M.id-L.id}if(d.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var E=performance;d.unstable_now=function(){return E.now()}}else{var S=Date,j=S.now();d.unstable_now=function(){return S.now()-j}}var N=[],f=[],B=1,Y=null,X=3,i0=!1,h0=!1,u0=!1,y0=!1,r0=typeof setTimeout=="function"?setTimeout:null,n0=typeof clearTimeout=="function"?clearTimeout:null,d0=typeof setImmediate<"u"?setImmediate:null;function P(M){for(var L=T(f);L!==null;){if(L.callback===null)n(f);else if(L.startTime<=M)n(f),L.sortIndex=L.expirationTime,p(N,L);else break;L=T(f)}}function m0(M){if(u0=!1,P(M),!h0)if(T(N)!==null)h0=!0,U0||(U0=!0,E0());else{var L=T(f);L!==null&&Z0(m0,L.startTime-M)}}var U0=!1,W=-1,Y0=5,F0=-1;function H0(){return y0?!0:!(d.unstable_now()-F0<Y0)}function t0(){if(y0=!1,U0){var M=d.unstable_now();F0=M;var L=!0;try{e:{h0=!1,u0&&(u0=!1,n0(W),W=-1),i0=!0;var w=X;try{t:{for(P(M),Y=T(N);Y!==null&&!(Y.expirationTime>M&&H0());){var T0=Y.callback;if(typeof T0=="function"){Y.callback=null,X=Y.priorityLevel;var S0=T0(Y.expirationTime<=M);if(M=d.unstable_now(),typeof S0=="function"){Y.callback=S0,P(M),L=!0;break t}Y===T(N)&&n(N),P(M)}else n(N);Y=T(N)}if(Y!==null)L=!0;else{var m=T(f);m!==null&&Z0(m0,m.startTime-M),L=!1}}break e}finally{Y=null,X=w,i0=!1}L=void 0}}finally{L?E0():U0=!1}}}var E0;if(typeof d0=="function")E0=function(){d0(t0)};else if(typeof MessageChannel<"u"){var K=new MessageChannel,G0=K.port2;K.port1.onmessage=t0,E0=function(){G0.postMessage(null)}}else E0=function(){r0(t0,0)};function Z0(M,L){W=r0(function(){M(d.unstable_now())},L)}d.unstable_IdlePriority=5,d.unstable_ImmediatePriority=1,d.unstable_LowPriority=4,d.unstable_NormalPriority=3,d.unstable_Profiling=null,d.unstable_UserBlockingPriority=2,d.unstable_cancelCallback=function(M){M.callback=null},d.unstable_forceFrameRate=function(M){0>M||125<M?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):Y0=0<M?Math.floor(1e3/M):5},d.unstable_getCurrentPriorityLevel=function(){return X},d.unstable_next=function(M){switch(X){case 1:case 2:case 3:var L=3;break;default:L=X}var w=X;X=L;try{return M()}finally{X=w}},d.unstable_requestPaint=function(){y0=!0},d.unstable_runWithPriority=function(M,L){switch(M){case 1:case 2:case 3:case 4:case 5:break;default:M=3}var w=X;X=M;try{return L()}finally{X=w}},d.unstable_scheduleCallback=function(M,L,w){var T0=d.unstable_now();switch(typeof w=="object"&&w!==null?(w=w.delay,w=typeof w=="number"&&0<w?T0+w:T0):w=T0,M){case 1:var S0=-1;break;case 2:S0=250;break;case 5:S0=1073741823;break;case 4:S0=1e4;break;default:S0=5e3}return S0=w+S0,M={id:B++,callback:L,priorityLevel:M,startTime:w,expirationTime:S0,sortIndex:-1},w>T0?(M.sortIndex=w,p(f,M),T(N)===null&&M===T(f)&&(u0?(n0(W),W=-1):u0=!0,Z0(m0,w-T0))):(M.sortIndex=S0,p(N,M),h0||i0||(h0=!0,U0||(U0=!0,E0()))),M},d.unstable_shouldYield=H0,d.unstable_wrapCallback=function(M){var L=X;return function(){var w=X;X=L;try{return M.apply(this,arguments)}finally{X=w}}}})(b5)),b5}var B6;function Un(){return B6||(B6=1,S5.exports=Dn()),S5.exports}var z5={exports:{}},l2={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var L6;function Rn(){if(L6)return l2;L6=1;var d=C5();function p(N){var f="https://react.dev/errors/"+N;if(1<arguments.length){f+="?args[]="+encodeURIComponent(arguments[1]);for(var B=2;B<arguments.length;B++)f+="&args[]="+encodeURIComponent(arguments[B])}return"Minified React error #"+N+"; visit "+f+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}function T(){}var n={d:{f:T,r:function(){throw Error(p(522))},D:T,C:T,L:T,m:T,X:T,S:T,M:T},p:0,findDOMNode:null},x=Symbol.for("react.portal");function E(N,f,B){var Y=3<arguments.length&&arguments[3]!==void 0?arguments[3]:null;return{$$typeof:x,key:Y==null?null:""+Y,children:N,containerInfo:f,implementation:B}}var S=d.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE;function j(N,f){if(N==="font")return"";if(typeof f=="string")return f==="use-credentials"?f:""}return l2.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=n,l2.createPortal=function(N,f){var B=2<arguments.length&&arguments[2]!==void 0?arguments[2]:null;if(!f||f.nodeType!==1&&f.nodeType!==9&&f.nodeType!==11)throw Error(p(299));return E(N,f,null,B)},l2.flushSync=function(N){var f=S.T,B=n.p;try{if(S.T=null,n.p=2,N)return N()}finally{S.T=f,n.p=B,n.d.f()}},l2.preconnect=function(N,f){typeof N=="string"&&(f?(f=f.crossOrigin,f=typeof f=="string"?f==="use-credentials"?f:"":void 0):f=null,n.d.C(N,f))},l2.prefetchDNS=function(N){typeof N=="string"&&n.d.D(N)},l2.preinit=function(N,f){if(typeof N=="string"&&f&&typeof f.as=="string"){var B=f.as,Y=j(B,f.crossOrigin),X=typeof f.integrity=="string"?f.integrity:void 0,i0=typeof f.fetchPriority=="string"?f.fetchPriority:void 0;B==="style"?n.d.S(N,typeof f.precedence=="string"?f.precedence:void 0,{crossOrigin:Y,integrity:X,fetchPriority:i0}):B==="script"&&n.d.X(N,{crossOrigin:Y,integrity:X,fetchPriority:i0,nonce:typeof f.nonce=="string"?f.nonce:void 0})}},l2.preinitModule=function(N,f){if(typeof N=="string")if(typeof f=="object"&&f!==null){if(f.as==null||f.as==="script"){var B=j(f.as,f.crossOrigin);n.d.M(N,{crossOrigin:B,integrity:typeof f.integrity=="string"?f.integrity:void 0,nonce:typeof f.nonce=="string"?f.nonce:void 0})}}else f==null&&n.d.M(N)},l2.preload=function(N,f){if(typeof N=="string"&&typeof f=="object"&&f!==null&&typeof f.as=="string"){var B=f.as,Y=j(B,f.crossOrigin);n.d.L(N,B,{crossOrigin:Y,integrity:typeof f.integrity=="string"?f.integrity:void 0,nonce:typeof f.nonce=="string"?f.nonce:void 0,type:typeof f.type=="string"?f.type:void 0,fetchPriority:typeof f.fetchPriority=="string"?f.fetchPriority:void 0,referrerPolicy:typeof f.referrerPolicy=="string"?f.referrerPolicy:void 0,imageSrcSet:typeof f.imageSrcSet=="string"?f.imageSrcSet:void 0,imageSizes:typeof f.imageSizes=="string"?f.imageSizes:void 0,media:typeof f.media=="string"?f.media:void 0})}},l2.preloadModule=function(N,f){if(typeof N=="string")if(f){var B=j(f.as,f.crossOrigin);n.d.m(N,{as:typeof f.as=="string"&&f.as!=="script"?f.as:void 0,crossOrigin:B,integrity:typeof f.integrity=="string"?f.integrity:void 0})}else n.d.m(N)},l2.requestFormReset=function(N){n.d.r(N)},l2.unstable_batchedUpdates=function(N,f){return N(f)},l2.useFormState=function(N,f,B){return S.H.useFormState(N,f,B)},l2.useFormStatus=function(){return S.H.useHostTransitionStatus()},l2.version="19.2.7",l2}var G6;function jn(){if(G6)return z5.exports;G6=1;function d(){if(!(typeof __REACT_DEVTOOLS_GLOBAL_HOOK__>"u"||typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE!="function"))try{__REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE(d)}catch(p){console.error(p)}}return d(),z5.exports=Rn(),z5.exports}/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var X6;function Hn(){if(X6)return qt;X6=1;var d=Un(),p=C5(),T=jn();function n(e){var t="https://react.dev/errors/"+e;if(1<arguments.length){t+="?args[]="+encodeURIComponent(arguments[1]);for(var s=2;s<arguments.length;s++)t+="&args[]="+encodeURIComponent(arguments[s])}return"Minified React error #"+e+"; visit "+t+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}function x(e){return!(!e||e.nodeType!==1&&e.nodeType!==9&&e.nodeType!==11)}function E(e){var t=e,s=e;if(e.alternate)for(;t.return;)t=t.return;else{e=t;do t=e,(t.flags&4098)!==0&&(s=t.return),e=t.return;while(e)}return t.tag===3?s:null}function S(e){if(e.tag===13){var t=e.memoizedState;if(t===null&&(e=e.alternate,e!==null&&(t=e.memoizedState)),t!==null)return t.dehydrated}return null}function j(e){if(e.tag===31){var t=e.memoizedState;if(t===null&&(e=e.alternate,e!==null&&(t=e.memoizedState)),t!==null)return t.dehydrated}return null}function N(e){if(E(e)!==e)throw Error(n(188))}function f(e){var t=e.alternate;if(!t){if(t=E(e),t===null)throw Error(n(188));return t!==e?null:e}for(var s=e,i=t;;){var r=s.return;if(r===null)break;var l=r.alternate;if(l===null){if(i=r.return,i!==null){s=i;continue}break}if(r.child===l.child){for(l=r.child;l;){if(l===s)return N(r),e;if(l===i)return N(r),t;l=l.sibling}throw Error(n(188))}if(s.return!==i.return)s=r,i=l;else{for(var a=!1,u=r.child;u;){if(u===s){a=!0,s=r,i=l;break}if(u===i){a=!0,i=r,s=l;break}u=u.sibling}if(!a){for(u=l.child;u;){if(u===s){a=!0,s=l,i=r;break}if(u===i){a=!0,i=l,s=r;break}u=u.sibling}if(!a)throw Error(n(189))}}if(s.alternate!==i)throw Error(n(190))}if(s.tag!==3)throw Error(n(188));return s.stateNode.current===s?e:t}function B(e){var t=e.tag;if(t===5||t===26||t===27||t===6)return e;for(e=e.child;e!==null;){if(t=B(e),t!==null)return t;e=e.sibling}return null}var Y=Object.assign,X=Symbol.for("react.element"),i0=Symbol.for("react.transitional.element"),h0=Symbol.for("react.portal"),u0=Symbol.for("react.fragment"),y0=Symbol.for("react.strict_mode"),r0=Symbol.for("react.profiler"),n0=Symbol.for("react.consumer"),d0=Symbol.for("react.context"),P=Symbol.for("react.forward_ref"),m0=Symbol.for("react.suspense"),U0=Symbol.for("react.suspense_list"),W=Symbol.for("react.memo"),Y0=Symbol.for("react.lazy"),F0=Symbol.for("react.activity"),H0=Symbol.for("react.memo_cache_sentinel"),t0=Symbol.iterator;function E0(e){return e===null||typeof e!="object"?null:(e=t0&&e[t0]||e["@@iterator"],typeof e=="function"?e:null)}var K=Symbol.for("react.client.reference");function G0(e){if(e==null)return null;if(typeof e=="function")return e.$$typeof===K?null:e.displayName||e.name||null;if(typeof e=="string")return e;switch(e){case u0:return"Fragment";case r0:return"Profiler";case y0:return"StrictMode";case m0:return"Suspense";case U0:return"SuspenseList";case F0:return"Activity"}if(typeof e=="object")switch(e.$$typeof){case h0:return"Portal";case d0:return e.displayName||"Context";case n0:return(e._context.displayName||"Context")+".Consumer";case P:var t=e.render;return e=e.displayName,e||(e=t.displayName||t.name||"",e=e!==""?"ForwardRef("+e+")":"ForwardRef"),e;case W:return t=e.displayName||null,t!==null?t:G0(e.type)||"Memo";case Y0:t=e._payload,e=e._init;try{return G0(e(t))}catch{}}return null}var Z0=Array.isArray,M=p.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE,L=T.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE,w={pending:!1,data:null,method:null,action:null},T0=[],S0=-1;function m(e){return{current:e}}function D(e){0>S0||(e.current=T0[S0],T0[S0]=null,S0--)}function v(e,t){S0++,T0[S0]=e.current,e.current=t}var O=m(null),q=m(null),H=m(null),z=m(null);function G(e,t){switch(v(H,t),v(q,e),v(O,null),t.nodeType){case 9:case 11:e=(e=t.documentElement)&&(e=e.namespaceURI)?s6(e):0;break;default:if(e=t.tagName,t=t.namespaceURI)t=s6(t),e=i6(t,e);else switch(e){case"svg":e=1;break;case"math":e=2;break;default:e=0}}D(O),v(O,e)}function Z(){D(O),D(q),D(H)}function F(e){e.memoizedState!==null&&v(z,e);var t=O.current,s=i6(t,e.type);t!==s&&(v(q,e),v(O,s))}function f0(e){q.current===e&&(D(O),D(q)),z.current===e&&(D(z),Dt._currentValue=w)}var C0,p0;function A0(e){if(C0===void 0)try{throw Error()}catch(s){var t=s.stack.trim().match(/\n( *(at )?)/);C0=t&&t[1]||"",p0=-1<s.stack.indexOf(`
    at`)?" (<anonymous>)":-1<s.stack.indexOf("@")?"@unknown:0:0":""}return`
`+C0+e+p0}var r2=!1;function q2(e,t){if(!e||r2)return"";r2=!0;var s=Error.prepareStackTrace;Error.prepareStackTrace=void 0;try{var i={DetermineComponentFrameRoot:function(){try{if(t){var U=function(){throw Error()};if(Object.defineProperty(U.prototype,"props",{set:function(){throw Error()}}),typeof Reflect=="object"&&Reflect.construct){try{Reflect.construct(U,[])}catch(b){var g=b}Reflect.construct(e,[],U)}else{try{U.call()}catch(b){g=b}e.call(U.prototype)}}else{try{throw Error()}catch(b){g=b}(U=e())&&typeof U.catch=="function"&&U.catch(function(){})}}catch(b){if(b&&g&&typeof b.stack=="string")return[b.stack,g.stack]}return[null,null]}};i.DetermineComponentFrameRoot.displayName="DetermineComponentFrameRoot";var r=Object.getOwnPropertyDescriptor(i.DetermineComponentFrameRoot,"name");r&&r.configurable&&Object.defineProperty(i.DetermineComponentFrameRoot,"name",{value:"DetermineComponentFrameRoot"});var l=i.DetermineComponentFrameRoot(),a=l[0],u=l[1];if(a&&u){var c=a.split(`
`),y=u.split(`
`);for(r=i=0;i<c.length&&!c[i].includes("DetermineComponentFrameRoot");)i++;for(;r<y.length&&!y[r].includes("DetermineComponentFrameRoot");)r++;if(i===c.length||r===y.length)for(i=c.length-1,r=y.length-1;1<=i&&0<=r&&c[i]!==y[r];)r--;for(;1<=i&&0<=r;i--,r--)if(c[i]!==y[r]){if(i!==1||r!==1)do if(i--,r--,0>r||c[i]!==y[r]){var A=`
`+c[i].replace(" at new "," at ");return e.displayName&&A.includes("<anonymous>")&&(A=A.replace("<anonymous>",e.displayName)),A}while(1<=i&&0<=r);break}}}finally{r2=!1,Error.prepareStackTrace=s}return(s=e?e.displayName||e.name:"")?A0(s):""}function n2(e,t){switch(e.tag){case 26:case 27:case 5:return A0(e.type);case 16:return A0("Lazy");case 13:return e.child!==t&&t!==null?A0("Suspense Fallback"):A0("Suspense");case 19:return A0("SuspenseList");case 0:case 15:return q2(e.type,!1);case 11:return q2(e.type.render,!1);case 1:return q2(e.type,!0);case 31:return A0("Activity");default:return""}}function J2(e){try{var t="",s=null;do t+=n2(e,s),s=e,e=e.return;while(e);return t}catch(i){return`
Error generating stack: `+i.message+`
`+i.stack}}var G2=Object.prototype.hasOwnProperty,X2=d.unstable_scheduleCallback,se=d.unstable_cancelCallback,R5=d.unstable_shouldYield,aa=d.unstable_requestPaint,h2=d.unstable_now,ua=d.unstable_getCurrentPriorityLevel,j5=d.unstable_ImmediatePriority,H5=d.unstable_UserBlockingPriority,Lt=d.unstable_NormalPriority,na=d.unstable_LowPriority,q5=d.unstable_IdlePriority,da=d.log,ca=d.unstable_setDisableYieldValue,Ze=null,y2=null;function m1(e){if(typeof da=="function"&&ca(e),y2&&typeof y2.setStrictMode=="function")try{y2.setStrictMode(Ze,e)}catch{}}var T2=Math.clz32?Math.clz32:pa,oa=Math.log,ma=Math.LN2;function pa(e){return e>>>=0,e===0?32:31-(oa(e)/ma|0)|0}var Gt=256,Xt=262144,Qt=4194304;function Y1(e){var t=e&42;if(t!==0)return t;switch(e&-e){case 1:return 1;case 2:return 2;case 4:return 4;case 8:return 8;case 16:return 16;case 32:return 32;case 64:return 64;case 128:return 128;case 256:case 512:case 1024:case 2048:case 4096:case 8192:case 16384:case 32768:case 65536:case 131072:return e&261888;case 262144:case 524288:case 1048576:case 2097152:return e&3932160;case 4194304:case 8388608:case 16777216:case 33554432:return e&62914560;case 67108864:return 67108864;case 134217728:return 134217728;case 268435456:return 268435456;case 536870912:return 536870912;case 1073741824:return 0;default:return e}}function Zt(e,t,s){var i=e.pendingLanes;if(i===0)return 0;var r=0,l=e.suspendedLanes,a=e.pingedLanes;e=e.warmLanes;var u=i&134217727;return u!==0?(i=u&~l,i!==0?r=Y1(i):(a&=u,a!==0?r=Y1(a):s||(s=u&~e,s!==0&&(r=Y1(s))))):(u=i&~l,u!==0?r=Y1(u):a!==0?r=Y1(a):s||(s=i&~e,s!==0&&(r=Y1(s)))),r===0?0:t!==0&&t!==r&&(t&l)===0&&(l=r&-r,s=t&-t,l>=s||l===32&&(s&4194048)!==0)?t:r}function Ve(e,t){return(e.pendingLanes&~(e.suspendedLanes&~e.pingedLanes)&t)===0}function _a(e,t){switch(e){case 1:case 2:case 4:case 8:case 64:return t+250;case 16:case 32:case 128:case 256:case 512:case 1024:case 2048:case 4096:case 8192:case 16384:case 32768:case 65536:case 131072:case 262144:case 524288:case 1048576:case 2097152:return t+5e3;case 4194304:case 8388608:case 16777216:case 33554432:return-1;case 67108864:case 134217728:case 268435456:case 536870912:case 1073741824:return-1;default:return-1}}function Y5(){var e=Qt;return Qt<<=1,(Qt&62914560)===0&&(Qt=4194304),e}function a4(e){for(var t=[],s=0;31>s;s++)t.push(e);return t}function Ke(e,t){e.pendingLanes|=t,t!==268435456&&(e.suspendedLanes=0,e.pingedLanes=0,e.warmLanes=0)}function fa(e,t,s,i,r,l){var a=e.pendingLanes;e.pendingLanes=s,e.suspendedLanes=0,e.pingedLanes=0,e.warmLanes=0,e.expiredLanes&=s,e.entangledLanes&=s,e.errorRecoveryDisabledLanes&=s,e.shellSuspendCounter=0;var u=e.entanglements,c=e.expirationTimes,y=e.hiddenUpdates;for(s=a&~s;0<s;){var A=31-T2(s),U=1<<A;u[A]=0,c[A]=-1;var g=y[A];if(g!==null)for(y[A]=null,A=0;A<g.length;A++){var b=g[A];b!==null&&(b.lane&=-536870913)}s&=~U}i!==0&&B5(e,i,0),l!==0&&r===0&&e.tag!==0&&(e.suspendedLanes|=l&~(a&~t))}function B5(e,t,s){e.pendingLanes|=t,e.suspendedLanes&=~t;var i=31-T2(t);e.entangledLanes|=t,e.entanglements[i]=e.entanglements[i]|1073741824|s&261930}function L5(e,t){var s=e.entangledLanes|=t;for(e=e.entanglements;s;){var i=31-T2(s),r=1<<i;r&t|e[i]&t&&(e[i]|=t),s&=~r}}function G5(e,t){var s=t&-t;return s=(s&42)!==0?1:u4(s),(s&(e.suspendedLanes|t))!==0?0:s}function u4(e){switch(e){case 2:e=1;break;case 8:e=4;break;case 32:e=16;break;case 256:case 512:case 1024:case 2048:case 4096:case 8192:case 16384:case 32768:case 65536:case 131072:case 262144:case 524288:case 1048576:case 2097152:case 4194304:case 8388608:case 16777216:case 33554432:e=128;break;case 268435456:e=134217728;break;default:e=0}return e}function n4(e){return e&=-e,2<e?8<e?(e&134217727)!==0?32:268435456:8:2}function X5(){var e=L.p;return e!==0?e:(e=window.event,e===void 0?32:A6(e.type))}function Q5(e,t){var s=L.p;try{return L.p=e,t()}finally{L.p=s}}var p1=Math.random().toString(36).slice(2),I0="__reactFiber$"+p1,d2="__reactProps$"+p1,ie="__reactContainer$"+p1,d4="__reactEvents$"+p1,ha="__reactListeners$"+p1,ya="__reactHandles$"+p1,Z5="__reactResources$"+p1,Je="__reactMarker$"+p1;function c4(e){delete e[I0],delete e[d2],delete e[d4],delete e[ha],delete e[ya]}function re(e){var t=e[I0];if(t)return t;for(var s=e.parentNode;s;){if(t=s[ie]||s[I0]){if(s=t.alternate,t.child!==null||s!==null&&s.child!==null)for(e=c6(e);e!==null;){if(s=e[I0])return s;e=c6(e)}return t}e=s,s=e.parentNode}return null}function le(e){if(e=e[I0]||e[ie]){var t=e.tag;if(t===5||t===6||t===13||t===31||t===26||t===27||t===3)return e}return null}function we(e){var t=e.tag;if(t===5||t===26||t===27||t===6)return e.stateNode;throw Error(n(33))}function ae(e){var t=e[Z5];return t||(t=e[Z5]={hoistableStyles:new Map,hoistableScripts:new Map}),t}function k0(e){e[Je]=!0}var V5=new Set,K5={};function B1(e,t){ue(e,t),ue(e+"Capture",t)}function ue(e,t){for(K5[e]=t,e=0;e<t.length;e++)V5.add(t[e])}var Ta=RegExp("^[:A-Z_a-z\\u00C0-\\u00D6\\u00D8-\\u00F6\\u00F8-\\u02FF\\u0370-\\u037D\\u037F-\\u1FFF\\u200C-\\u200D\\u2070-\\u218F\\u2C00-\\u2FEF\\u3001-\\uD7FF\\uF900-\\uFDCF\\uFDF0-\\uFFFD][:A-Z_a-z\\u00C0-\\u00D6\\u00D8-\\u00F6\\u00F8-\\u02FF\\u0370-\\u037D\\u037F-\\u1FFF\\u200C-\\u200D\\u2070-\\u218F\\u2C00-\\u2FEF\\u3001-\\uD7FF\\uF900-\\uFDCF\\uFDF0-\\uFFFD\\-.0-9\\u00B7\\u0300-\\u036F\\u203F-\\u2040]*$"),J5={},w5={};function va(e){return G2.call(w5,e)?!0:G2.call(J5,e)?!1:Ta.test(e)?w5[e]=!0:(J5[e]=!0,!1)}function Vt(e,t,s){if(va(t))if(s===null)e.removeAttribute(t);else{switch(typeof s){case"undefined":case"function":case"symbol":e.removeAttribute(t);return;case"boolean":var i=t.toLowerCase().slice(0,5);if(i!=="data-"&&i!=="aria-"){e.removeAttribute(t);return}}e.setAttribute(t,""+s)}}function Kt(e,t,s){if(s===null)e.removeAttribute(t);else{switch(typeof s){case"undefined":case"function":case"symbol":case"boolean":e.removeAttribute(t);return}e.setAttribute(t,""+s)}}function w2(e,t,s,i){if(i===null)e.removeAttribute(s);else{switch(typeof i){case"undefined":case"function":case"symbol":case"boolean":e.removeAttribute(s);return}e.setAttributeNS(t,s,""+i)}}function A2(e){switch(typeof e){case"bigint":case"boolean":case"number":case"string":case"undefined":return e;case"object":return e;default:return""}}function $5(e){var t=e.type;return(e=e.nodeName)&&e.toLowerCase()==="input"&&(t==="checkbox"||t==="radio")}function ga(e,t,s){var i=Object.getOwnPropertyDescriptor(e.constructor.prototype,t);if(!e.hasOwnProperty(t)&&typeof i<"u"&&typeof i.get=="function"&&typeof i.set=="function"){var r=i.get,l=i.set;return Object.defineProperty(e,t,{configurable:!0,get:function(){return r.call(this)},set:function(a){s=""+a,l.call(this,a)}}),Object.defineProperty(e,t,{enumerable:i.enumerable}),{getValue:function(){return s},setValue:function(a){s=""+a},stopTracking:function(){e._valueTracker=null,delete e[t]}}}}function o4(e){if(!e._valueTracker){var t=$5(e)?"checked":"value";e._valueTracker=ga(e,t,""+e[t])}}function k5(e){if(!e)return!1;var t=e._valueTracker;if(!t)return!0;var s=t.getValue(),i="";return e&&(i=$5(e)?e.checked?"true":"false":e.value),e=i,e!==s?(t.setValue(e),!0):!1}function Jt(e){if(e=e||(typeof document<"u"?document:void 0),typeof e>"u")return null;try{return e.activeElement||e.body}catch{return e.body}}var Sa=/[\n"\\]/g;function x2(e){return e.replace(Sa,function(t){return"\\"+t.charCodeAt(0).toString(16)+" "})}function m4(e,t,s,i,r,l,a,u){e.name="",a!=null&&typeof a!="function"&&typeof a!="symbol"&&typeof a!="boolean"?e.type=a:e.removeAttribute("type"),t!=null?a==="number"?(t===0&&e.value===""||e.value!=t)&&(e.value=""+A2(t)):e.value!==""+A2(t)&&(e.value=""+A2(t)):a!=="submit"&&a!=="reset"||e.removeAttribute("value"),t!=null?p4(e,a,A2(t)):s!=null?p4(e,a,A2(s)):i!=null&&e.removeAttribute("value"),r==null&&l!=null&&(e.defaultChecked=!!l),r!=null&&(e.checked=r&&typeof r!="function"&&typeof r!="symbol"),u!=null&&typeof u!="function"&&typeof u!="symbol"&&typeof u!="boolean"?e.name=""+A2(u):e.removeAttribute("name")}function W5(e,t,s,i,r,l,a,u){if(l!=null&&typeof l!="function"&&typeof l!="symbol"&&typeof l!="boolean"&&(e.type=l),t!=null||s!=null){if(!(l!=="submit"&&l!=="reset"||t!=null)){o4(e);return}s=s!=null?""+A2(s):"",t=t!=null?""+A2(t):s,u||t===e.value||(e.value=t),e.defaultValue=t}i=i??r,i=typeof i!="function"&&typeof i!="symbol"&&!!i,e.checked=u?e.checked:!!i,e.defaultChecked=!!i,a!=null&&typeof a!="function"&&typeof a!="symbol"&&typeof a!="boolean"&&(e.name=a),o4(e)}function p4(e,t,s){t==="number"&&Jt(e.ownerDocument)===e||e.defaultValue===""+s||(e.defaultValue=""+s)}function ne(e,t,s,i){if(e=e.options,t){t={};for(var r=0;r<s.length;r++)t["$"+s[r]]=!0;for(s=0;s<e.length;s++)r=t.hasOwnProperty("$"+e[s].value),e[s].selected!==r&&(e[s].selected=r),r&&i&&(e[s].defaultSelected=!0)}else{for(s=""+A2(s),t=null,r=0;r<e.length;r++){if(e[r].value===s){e[r].selected=!0,i&&(e[r].defaultSelected=!0);return}t!==null||e[r].disabled||(t=e[r])}t!==null&&(t.selected=!0)}}function F5(e,t,s){if(t!=null&&(t=""+A2(t),t!==e.value&&(e.value=t),s==null)){e.defaultValue!==t&&(e.defaultValue=t);return}e.defaultValue=s!=null?""+A2(s):""}function I5(e,t,s,i){if(t==null){if(i!=null){if(s!=null)throw Error(n(92));if(Z0(i)){if(1<i.length)throw Error(n(93));i=i[0]}s=i}s==null&&(s=""),t=s}s=A2(t),e.defaultValue=s,i=e.textContent,i===s&&i!==""&&i!==null&&(e.value=i),o4(e)}function de(e,t){if(t){var s=e.firstChild;if(s&&s===e.lastChild&&s.nodeType===3){s.nodeValue=t;return}}e.textContent=t}var ba=new Set("animationIterationCount aspectRatio borderImageOutset borderImageSlice borderImageWidth boxFlex boxFlexGroup boxOrdinalGroup columnCount columns flex flexGrow flexPositive flexShrink flexNegative flexOrder gridArea gridRow gridRowEnd gridRowSpan gridRowStart gridColumn gridColumnEnd gridColumnSpan gridColumnStart fontWeight lineClamp lineHeight opacity order orphans scale tabSize widows zIndex zoom fillOpacity floodOpacity stopOpacity strokeDasharray strokeDashoffset strokeMiterlimit strokeOpacity strokeWidth MozAnimationIterationCount MozBoxFlex MozBoxFlexGroup MozLineClamp msAnimationIterationCount msFlex msZoom msFlexGrow msFlexNegative msFlexOrder msFlexPositive msFlexShrink msGridColumn msGridColumnSpan msGridRow msGridRowSpan WebkitAnimationIterationCount WebkitBoxFlex WebKitBoxFlexGroup WebkitBoxOrdinalGroup WebkitColumnCount WebkitColumns WebkitFlex WebkitFlexGrow WebkitFlexPositive WebkitFlexShrink WebkitLineClamp".split(" "));function P5(e,t,s){var i=t.indexOf("--")===0;s==null||typeof s=="boolean"||s===""?i?e.setProperty(t,""):t==="float"?e.cssFloat="":e[t]="":i?e.setProperty(t,s):typeof s!="number"||s===0||ba.has(t)?t==="float"?e.cssFloat=s:e[t]=(""+s).trim():e[t]=s+"px"}function ei(e,t,s){if(t!=null&&typeof t!="object")throw Error(n(62));if(e=e.style,s!=null){for(var i in s)!s.hasOwnProperty(i)||t!=null&&t.hasOwnProperty(i)||(i.indexOf("--")===0?e.setProperty(i,""):i==="float"?e.cssFloat="":e[i]="");for(var r in t)i=t[r],t.hasOwnProperty(r)&&s[r]!==i&&P5(e,r,i)}else for(var l in t)t.hasOwnProperty(l)&&P5(e,l,t[l])}function _4(e){if(e.indexOf("-")===-1)return!1;switch(e){case"annotation-xml":case"color-profile":case"font-face":case"font-face-src":case"font-face-uri":case"font-face-format":case"font-face-name":case"missing-glyph":return!1;default:return!0}}var za=new Map([["acceptCharset","accept-charset"],["htmlFor","for"],["httpEquiv","http-equiv"],["crossOrigin","crossorigin"],["accentHeight","accent-height"],["alignmentBaseline","alignment-baseline"],["arabicForm","arabic-form"],["baselineShift","baseline-shift"],["capHeight","cap-height"],["clipPath","clip-path"],["clipRule","clip-rule"],["colorInterpolation","color-interpolation"],["colorInterpolationFilters","color-interpolation-filters"],["colorProfile","color-profile"],["colorRendering","color-rendering"],["dominantBaseline","dominant-baseline"],["enableBackground","enable-background"],["fillOpacity","fill-opacity"],["fillRule","fill-rule"],["floodColor","flood-color"],["floodOpacity","flood-opacity"],["fontFamily","font-family"],["fontSize","font-size"],["fontSizeAdjust","font-size-adjust"],["fontStretch","font-stretch"],["fontStyle","font-style"],["fontVariant","font-variant"],["fontWeight","font-weight"],["glyphName","glyph-name"],["glyphOrientationHorizontal","glyph-orientation-horizontal"],["glyphOrientationVertical","glyph-orientation-vertical"],["horizAdvX","horiz-adv-x"],["horizOriginX","horiz-origin-x"],["imageRendering","image-rendering"],["letterSpacing","letter-spacing"],["lightingColor","lighting-color"],["markerEnd","marker-end"],["markerMid","marker-mid"],["markerStart","marker-start"],["overlinePosition","overline-position"],["overlineThickness","overline-thickness"],["paintOrder","paint-order"],["panose-1","panose-1"],["pointerEvents","pointer-events"],["renderingIntent","rendering-intent"],["shapeRendering","shape-rendering"],["stopColor","stop-color"],["stopOpacity","stop-opacity"],["strikethroughPosition","strikethrough-position"],["strikethroughThickness","strikethrough-thickness"],["strokeDasharray","stroke-dasharray"],["strokeDashoffset","stroke-dashoffset"],["strokeLinecap","stroke-linecap"],["strokeLinejoin","stroke-linejoin"],["strokeMiterlimit","stroke-miterlimit"],["strokeOpacity","stroke-opacity"],["strokeWidth","stroke-width"],["textAnchor","text-anchor"],["textDecoration","text-decoration"],["textRendering","text-rendering"],["transformOrigin","transform-origin"],["underlinePosition","underline-position"],["underlineThickness","underline-thickness"],["unicodeBidi","unicode-bidi"],["unicodeRange","unicode-range"],["unitsPerEm","units-per-em"],["vAlphabetic","v-alphabetic"],["vHanging","v-hanging"],["vIdeographic","v-ideographic"],["vMathematical","v-mathematical"],["vectorEffect","vector-effect"],["vertAdvY","vert-adv-y"],["vertOriginX","vert-origin-x"],["vertOriginY","vert-origin-y"],["wordSpacing","word-spacing"],["writingMode","writing-mode"],["xmlnsXlink","xmlns:xlink"],["xHeight","x-height"]]),Ma=/^[\u0000-\u001F ]*j[\r\n\t]*a[\r\n\t]*v[\r\n\t]*a[\r\n\t]*s[\r\n\t]*c[\r\n\t]*r[\r\n\t]*i[\r\n\t]*p[\r\n\t]*t[\r\n\t]*:/i;function wt(e){return Ma.test(""+e)?"javascript:throw new Error('React has blocked a javascript: URL as a security precaution.')":e}function $2(){}var f4=null;function h4(e){return e=e.target||e.srcElement||window,e.correspondingUseElement&&(e=e.correspondingUseElement),e.nodeType===3?e.parentNode:e}var ce=null,oe=null;function ti(e){var t=le(e);if(t&&(e=t.stateNode)){var s=e[d2]||null;e:switch(e=t.stateNode,t.type){case"input":if(m4(e,s.value,s.defaultValue,s.defaultValue,s.checked,s.defaultChecked,s.type,s.name),t=s.name,s.type==="radio"&&t!=null){for(s=e;s.parentNode;)s=s.parentNode;for(s=s.querySelectorAll('input[name="'+x2(""+t)+'"][type="radio"]'),t=0;t<s.length;t++){var i=s[t];if(i!==e&&i.form===e.form){var r=i[d2]||null;if(!r)throw Error(n(90));m4(i,r.value,r.defaultValue,r.defaultValue,r.checked,r.defaultChecked,r.type,r.name)}}for(t=0;t<s.length;t++)i=s[t],i.form===e.form&&k5(i)}break e;case"textarea":F5(e,s.value,s.defaultValue);break e;case"select":t=s.value,t!=null&&ne(e,!!s.multiple,t,!1)}}}var y4=!1;function si(e,t,s){if(y4)return e(t,s);y4=!0;try{var i=e(t);return i}finally{if(y4=!1,(ce!==null||oe!==null)&&(j3(),ce&&(t=ce,e=oe,oe=ce=null,ti(t),e)))for(t=0;t<e.length;t++)ti(e[t])}}function $e(e,t){var s=e.stateNode;if(s===null)return null;var i=s[d2]||null;if(i===null)return null;s=i[t];e:switch(t){case"onClick":case"onClickCapture":case"onDoubleClick":case"onDoubleClickCapture":case"onMouseDown":case"onMouseDownCapture":case"onMouseMove":case"onMouseMoveCapture":case"onMouseUp":case"onMouseUpCapture":case"onMouseEnter":(i=!i.disabled)||(e=e.type,i=!(e==="button"||e==="input"||e==="select"||e==="textarea")),e=!i;break e;default:e=!1}if(e)return null;if(s&&typeof s!="function")throw Error(n(231,t,typeof s));return s}var k2=!(typeof window>"u"||typeof window.document>"u"||typeof window.document.createElement>"u"),T4=!1;if(k2)try{var ke={};Object.defineProperty(ke,"passive",{get:function(){T4=!0}}),window.addEventListener("test",ke,ke),window.removeEventListener("test",ke,ke)}catch{T4=!1}var _1=null,v4=null,$t=null;function ii(){if($t)return $t;var e,t=v4,s=t.length,i,r="value"in _1?_1.value:_1.textContent,l=r.length;for(e=0;e<s&&t[e]===r[e];e++);var a=s-e;for(i=1;i<=a&&t[s-i]===r[l-i];i++);return $t=r.slice(e,1<i?1-i:void 0)}function kt(e){var t=e.keyCode;return"charCode"in e?(e=e.charCode,e===0&&t===13&&(e=13)):e=t,e===10&&(e=13),32<=e||e===13?e:0}function Wt(){return!0}function ri(){return!1}function c2(e){function t(s,i,r,l,a){this._reactName=s,this._targetInst=r,this.type=i,this.nativeEvent=l,this.target=a,this.currentTarget=null;for(var u in e)e.hasOwnProperty(u)&&(s=e[u],this[u]=s?s(l):l[u]);return this.isDefaultPrevented=(l.defaultPrevented!=null?l.defaultPrevented:l.returnValue===!1)?Wt:ri,this.isPropagationStopped=ri,this}return Y(t.prototype,{preventDefault:function(){this.defaultPrevented=!0;var s=this.nativeEvent;s&&(s.preventDefault?s.preventDefault():typeof s.returnValue!="unknown"&&(s.returnValue=!1),this.isDefaultPrevented=Wt)},stopPropagation:function(){var s=this.nativeEvent;s&&(s.stopPropagation?s.stopPropagation():typeof s.cancelBubble!="unknown"&&(s.cancelBubble=!0),this.isPropagationStopped=Wt)},persist:function(){},isPersistent:Wt}),t}var L1={eventPhase:0,bubbles:0,cancelable:0,timeStamp:function(e){return e.timeStamp||Date.now()},defaultPrevented:0,isTrusted:0},Ft=c2(L1),We=Y({},L1,{view:0,detail:0}),Ea=c2(We),g4,S4,Fe,It=Y({},We,{screenX:0,screenY:0,clientX:0,clientY:0,pageX:0,pageY:0,ctrlKey:0,shiftKey:0,altKey:0,metaKey:0,getModifierState:z4,button:0,buttons:0,relatedTarget:function(e){return e.relatedTarget===void 0?e.fromElement===e.srcElement?e.toElement:e.fromElement:e.relatedTarget},movementX:function(e){return"movementX"in e?e.movementX:(e!==Fe&&(Fe&&e.type==="mousemove"?(g4=e.screenX-Fe.screenX,S4=e.screenY-Fe.screenY):S4=g4=0,Fe=e),g4)},movementY:function(e){return"movementY"in e?e.movementY:S4}}),li=c2(It),Aa=Y({},It,{dataTransfer:0}),xa=c2(Aa),Oa=Y({},We,{relatedTarget:0}),b4=c2(Oa),Na=Y({},L1,{animationName:0,elapsedTime:0,pseudoElement:0}),Ca=c2(Na),Da=Y({},L1,{clipboardData:function(e){return"clipboardData"in e?e.clipboardData:window.clipboardData}}),Ua=c2(Da),Ra=Y({},L1,{data:0}),ai=c2(Ra),ja={Esc:"Escape",Spacebar:" ",Left:"ArrowLeft",Up:"ArrowUp",Right:"ArrowRight",Down:"ArrowDown",Del:"Delete",Win:"OS",Menu:"ContextMenu",Apps:"ContextMenu",Scroll:"ScrollLock",MozPrintableKey:"Unidentified"},Ha={8:"Backspace",9:"Tab",12:"Clear",13:"Enter",16:"Shift",17:"Control",18:"Alt",19:"Pause",20:"CapsLock",27:"Escape",32:" ",33:"PageUp",34:"PageDown",35:"End",36:"Home",37:"ArrowLeft",38:"ArrowUp",39:"ArrowRight",40:"ArrowDown",45:"Insert",46:"Delete",112:"F1",113:"F2",114:"F3",115:"F4",116:"F5",117:"F6",118:"F7",119:"F8",120:"F9",121:"F10",122:"F11",123:"F12",144:"NumLock",145:"ScrollLock",224:"Meta"},qa={Alt:"altKey",Control:"ctrlKey",Meta:"metaKey",Shift:"shiftKey"};function Ya(e){var t=this.nativeEvent;return t.getModifierState?t.getModifierState(e):(e=qa[e])?!!t[e]:!1}function z4(){return Ya}var Ba=Y({},We,{key:function(e){if(e.key){var t=ja[e.key]||e.key;if(t!=="Unidentified")return t}return e.type==="keypress"?(e=kt(e),e===13?"Enter":String.fromCharCode(e)):e.type==="keydown"||e.type==="keyup"?Ha[e.keyCode]||"Unidentified":""},code:0,location:0,ctrlKey:0,shiftKey:0,altKey:0,metaKey:0,repeat:0,locale:0,getModifierState:z4,charCode:function(e){return e.type==="keypress"?kt(e):0},keyCode:function(e){return e.type==="keydown"||e.type==="keyup"?e.keyCode:0},which:function(e){return e.type==="keypress"?kt(e):e.type==="keydown"||e.type==="keyup"?e.keyCode:0}}),La=c2(Ba),Ga=Y({},It,{pointerId:0,width:0,height:0,pressure:0,tangentialPressure:0,tiltX:0,tiltY:0,twist:0,pointerType:0,isPrimary:0}),ui=c2(Ga),Xa=Y({},We,{touches:0,targetTouches:0,changedTouches:0,altKey:0,metaKey:0,ctrlKey:0,shiftKey:0,getModifierState:z4}),Qa=c2(Xa),Za=Y({},L1,{propertyName:0,elapsedTime:0,pseudoElement:0}),Va=c2(Za),Ka=Y({},It,{deltaX:function(e){return"deltaX"in e?e.deltaX:"wheelDeltaX"in e?-e.wheelDeltaX:0},deltaY:function(e){return"deltaY"in e?e.deltaY:"wheelDeltaY"in e?-e.wheelDeltaY:"wheelDelta"in e?-e.wheelDelta:0},deltaZ:0,deltaMode:0}),Ja=c2(Ka),wa=Y({},L1,{newState:0,oldState:0}),$a=c2(wa),ka=[9,13,27,32],M4=k2&&"CompositionEvent"in window,Ie=null;k2&&"documentMode"in document&&(Ie=document.documentMode);var Wa=k2&&"TextEvent"in window&&!Ie,ni=k2&&(!M4||Ie&&8<Ie&&11>=Ie),di=" ",ci=!1;function oi(e,t){switch(e){case"keyup":return ka.indexOf(t.keyCode)!==-1;case"keydown":return t.keyCode!==229;case"keypress":case"mousedown":case"focusout":return!0;default:return!1}}function mi(e){return e=e.detail,typeof e=="object"&&"data"in e?e.data:null}var me=!1;function Fa(e,t){switch(e){case"compositionend":return mi(t);case"keypress":return t.which!==32?null:(ci=!0,di);case"textInput":return e=t.data,e===di&&ci?null:e;default:return null}}function Ia(e,t){if(me)return e==="compositionend"||!M4&&oi(e,t)?(e=ii(),$t=v4=_1=null,me=!1,e):null;switch(e){case"paste":return null;case"keypress":if(!(t.ctrlKey||t.altKey||t.metaKey)||t.ctrlKey&&t.altKey){if(t.char&&1<t.char.length)return t.char;if(t.which)return String.fromCharCode(t.which)}return null;case"compositionend":return ni&&t.locale!=="ko"?null:t.data;default:return null}}var Pa={color:!0,date:!0,datetime:!0,"datetime-local":!0,email:!0,month:!0,number:!0,password:!0,range:!0,search:!0,tel:!0,text:!0,time:!0,url:!0,week:!0};function pi(e){var t=e&&e.nodeName&&e.nodeName.toLowerCase();return t==="input"?!!Pa[e.type]:t==="textarea"}function _i(e,t,s,i){ce?oe?oe.push(i):oe=[i]:ce=i,t=X3(t,"onChange"),0<t.length&&(s=new Ft("onChange","change",null,s,i),e.push({event:s,listeners:t}))}var Pe=null,et=null;function eu(e){Wl(e,0)}function Pt(e){var t=we(e);if(k5(t))return e}function fi(e,t){if(e==="change")return t}var hi=!1;if(k2){var E4;if(k2){var A4="oninput"in document;if(!A4){var yi=document.createElement("div");yi.setAttribute("oninput","return;"),A4=typeof yi.oninput=="function"}E4=A4}else E4=!1;hi=E4&&(!document.documentMode||9<document.documentMode)}function Ti(){Pe&&(Pe.detachEvent("onpropertychange",vi),et=Pe=null)}function vi(e){if(e.propertyName==="value"&&Pt(et)){var t=[];_i(t,et,e,h4(e)),si(eu,t)}}function tu(e,t,s){e==="focusin"?(Ti(),Pe=t,et=s,Pe.attachEvent("onpropertychange",vi)):e==="focusout"&&Ti()}function su(e){if(e==="selectionchange"||e==="keyup"||e==="keydown")return Pt(et)}function iu(e,t){if(e==="click")return Pt(t)}function ru(e,t){if(e==="input"||e==="change")return Pt(t)}function lu(e,t){return e===t&&(e!==0||1/e===1/t)||e!==e&&t!==t}var v2=typeof Object.is=="function"?Object.is:lu;function tt(e,t){if(v2(e,t))return!0;if(typeof e!="object"||e===null||typeof t!="object"||t===null)return!1;var s=Object.keys(e),i=Object.keys(t);if(s.length!==i.length)return!1;for(i=0;i<s.length;i++){var r=s[i];if(!G2.call(t,r)||!v2(e[r],t[r]))return!1}return!0}function gi(e){for(;e&&e.firstChild;)e=e.firstChild;return e}function Si(e,t){var s=gi(e);e=0;for(var i;s;){if(s.nodeType===3){if(i=e+s.textContent.length,e<=t&&i>=t)return{node:s,offset:t-e};e=i}e:{for(;s;){if(s.nextSibling){s=s.nextSibling;break e}s=s.parentNode}s=void 0}s=gi(s)}}function bi(e,t){return e&&t?e===t?!0:e&&e.nodeType===3?!1:t&&t.nodeType===3?bi(e,t.parentNode):"contains"in e?e.contains(t):e.compareDocumentPosition?!!(e.compareDocumentPosition(t)&16):!1:!1}function zi(e){e=e!=null&&e.ownerDocument!=null&&e.ownerDocument.defaultView!=null?e.ownerDocument.defaultView:window;for(var t=Jt(e.document);t instanceof e.HTMLIFrameElement;){try{var s=typeof t.contentWindow.location.href=="string"}catch{s=!1}if(s)e=t.contentWindow;else break;t=Jt(e.document)}return t}function x4(e){var t=e&&e.nodeName&&e.nodeName.toLowerCase();return t&&(t==="input"&&(e.type==="text"||e.type==="search"||e.type==="tel"||e.type==="url"||e.type==="password")||t==="textarea"||e.contentEditable==="true")}var au=k2&&"documentMode"in document&&11>=document.documentMode,pe=null,O4=null,st=null,N4=!1;function Mi(e,t,s){var i=s.window===s?s.document:s.nodeType===9?s:s.ownerDocument;N4||pe==null||pe!==Jt(i)||(i=pe,"selectionStart"in i&&x4(i)?i={start:i.selectionStart,end:i.selectionEnd}:(i=(i.ownerDocument&&i.ownerDocument.defaultView||window).getSelection(),i={anchorNode:i.anchorNode,anchorOffset:i.anchorOffset,focusNode:i.focusNode,focusOffset:i.focusOffset}),st&&tt(st,i)||(st=i,i=X3(O4,"onSelect"),0<i.length&&(t=new Ft("onSelect","select",null,t,s),e.push({event:t,listeners:i}),t.target=pe)))}function G1(e,t){var s={};return s[e.toLowerCase()]=t.toLowerCase(),s["Webkit"+e]="webkit"+t,s["Moz"+e]="moz"+t,s}var _e={animationend:G1("Animation","AnimationEnd"),animationiteration:G1("Animation","AnimationIteration"),animationstart:G1("Animation","AnimationStart"),transitionrun:G1("Transition","TransitionRun"),transitionstart:G1("Transition","TransitionStart"),transitioncancel:G1("Transition","TransitionCancel"),transitionend:G1("Transition","TransitionEnd")},C4={},Ei={};k2&&(Ei=document.createElement("div").style,"AnimationEvent"in window||(delete _e.animationend.animation,delete _e.animationiteration.animation,delete _e.animationstart.animation),"TransitionEvent"in window||delete _e.transitionend.transition);function X1(e){if(C4[e])return C4[e];if(!_e[e])return e;var t=_e[e],s;for(s in t)if(t.hasOwnProperty(s)&&s in Ei)return C4[e]=t[s];return e}var Ai=X1("animationend"),xi=X1("animationiteration"),Oi=X1("animationstart"),uu=X1("transitionrun"),nu=X1("transitionstart"),du=X1("transitioncancel"),Ni=X1("transitionend"),Ci=new Map,D4="abort auxClick beforeToggle cancel canPlay canPlayThrough click close contextMenu copy cut drag dragEnd dragEnter dragExit dragLeave dragOver dragStart drop durationChange emptied encrypted ended error gotPointerCapture input invalid keyDown keyPress keyUp load loadedData loadedMetadata loadStart lostPointerCapture mouseDown mouseMove mouseOut mouseOver mouseUp paste pause play playing pointerCancel pointerDown pointerMove pointerOut pointerOver pointerUp progress rateChange reset resize seeked seeking stalled submit suspend timeUpdate touchCancel touchEnd touchStart volumeChange scroll toggle touchMove waiting wheel".split(" ");D4.push("scrollEnd");function Y2(e,t){Ci.set(e,t),B1(t,[e])}var e3=typeof reportError=="function"?reportError:function(e){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var t=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof e=="object"&&e!==null&&typeof e.message=="string"?String(e.message):String(e),error:e});if(!window.dispatchEvent(t))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",e);return}console.error(e)},O2=[],fe=0,U4=0;function t3(){for(var e=fe,t=U4=fe=0;t<e;){var s=O2[t];O2[t++]=null;var i=O2[t];O2[t++]=null;var r=O2[t];O2[t++]=null;var l=O2[t];if(O2[t++]=null,i!==null&&r!==null){var a=i.pending;a===null?r.next=r:(r.next=a.next,a.next=r),i.pending=r}l!==0&&Di(s,r,l)}}function s3(e,t,s,i){O2[fe++]=e,O2[fe++]=t,O2[fe++]=s,O2[fe++]=i,U4|=i,e.lanes|=i,e=e.alternate,e!==null&&(e.lanes|=i)}function R4(e,t,s,i){return s3(e,t,s,i),i3(e)}function Q1(e,t){return s3(e,null,null,t),i3(e)}function Di(e,t,s){e.lanes|=s;var i=e.alternate;i!==null&&(i.lanes|=s);for(var r=!1,l=e.return;l!==null;)l.childLanes|=s,i=l.alternate,i!==null&&(i.childLanes|=s),l.tag===22&&(e=l.stateNode,e===null||e._visibility&1||(r=!0)),e=l,l=l.return;return e.tag===3?(l=e.stateNode,r&&t!==null&&(r=31-T2(s),e=l.hiddenUpdates,i=e[r],i===null?e[r]=[t]:i.push(t),t.lane=s|536870912),l):null}function i3(e){if(50<Mt)throw Mt=0,Qs=null,Error(n(185));for(var t=e.return;t!==null;)e=t,t=e.return;return e.tag===3?e.stateNode:null}var he={};function cu(e,t,s,i){this.tag=e,this.key=s,this.sibling=this.child=this.return=this.stateNode=this.type=this.elementType=null,this.index=0,this.refCleanup=this.ref=null,this.pendingProps=t,this.dependencies=this.memoizedState=this.updateQueue=this.memoizedProps=null,this.mode=i,this.subtreeFlags=this.flags=0,this.deletions=null,this.childLanes=this.lanes=0,this.alternate=null}function g2(e,t,s,i){return new cu(e,t,s,i)}function j4(e){return e=e.prototype,!(!e||!e.isReactComponent)}function W2(e,t){var s=e.alternate;return s===null?(s=g2(e.tag,t,e.key,e.mode),s.elementType=e.elementType,s.type=e.type,s.stateNode=e.stateNode,s.alternate=e,e.alternate=s):(s.pendingProps=t,s.type=e.type,s.flags=0,s.subtreeFlags=0,s.deletions=null),s.flags=e.flags&65011712,s.childLanes=e.childLanes,s.lanes=e.lanes,s.child=e.child,s.memoizedProps=e.memoizedProps,s.memoizedState=e.memoizedState,s.updateQueue=e.updateQueue,t=e.dependencies,s.dependencies=t===null?null:{lanes:t.lanes,firstContext:t.firstContext},s.sibling=e.sibling,s.index=e.index,s.ref=e.ref,s.refCleanup=e.refCleanup,s}function Ui(e,t){e.flags&=65011714;var s=e.alternate;return s===null?(e.childLanes=0,e.lanes=t,e.child=null,e.subtreeFlags=0,e.memoizedProps=null,e.memoizedState=null,e.updateQueue=null,e.dependencies=null,e.stateNode=null):(e.childLanes=s.childLanes,e.lanes=s.lanes,e.child=s.child,e.subtreeFlags=0,e.deletions=null,e.memoizedProps=s.memoizedProps,e.memoizedState=s.memoizedState,e.updateQueue=s.updateQueue,e.type=s.type,t=s.dependencies,e.dependencies=t===null?null:{lanes:t.lanes,firstContext:t.firstContext}),e}function r3(e,t,s,i,r,l){var a=0;if(i=e,typeof e=="function")j4(e)&&(a=1);else if(typeof e=="string")a=hn(e,s,O.current)?26:e==="html"||e==="head"||e==="body"?27:5;else e:switch(e){case F0:return e=g2(31,s,t,r),e.elementType=F0,e.lanes=l,e;case u0:return Z1(s.children,r,l,t);case y0:a=8,r|=24;break;case r0:return e=g2(12,s,t,r|2),e.elementType=r0,e.lanes=l,e;case m0:return e=g2(13,s,t,r),e.elementType=m0,e.lanes=l,e;case U0:return e=g2(19,s,t,r),e.elementType=U0,e.lanes=l,e;default:if(typeof e=="object"&&e!==null)switch(e.$$typeof){case d0:a=10;break e;case n0:a=9;break e;case P:a=11;break e;case W:a=14;break e;case Y0:a=16,i=null;break e}a=29,s=Error(n(130,e===null?"null":typeof e,"")),i=null}return t=g2(a,s,t,r),t.elementType=e,t.type=i,t.lanes=l,t}function Z1(e,t,s,i){return e=g2(7,e,i,t),e.lanes=s,e}function H4(e,t,s){return e=g2(6,e,null,t),e.lanes=s,e}function Ri(e){var t=g2(18,null,null,0);return t.stateNode=e,t}function q4(e,t,s){return t=g2(4,e.children!==null?e.children:[],e.key,t),t.lanes=s,t.stateNode={containerInfo:e.containerInfo,pendingChildren:null,implementation:e.implementation},t}var ji=new WeakMap;function N2(e,t){if(typeof e=="object"&&e!==null){var s=ji.get(e);return s!==void 0?s:(t={value:e,source:t,stack:J2(t)},ji.set(e,t),t)}return{value:e,source:t,stack:J2(t)}}var ye=[],Te=0,l3=null,it=0,C2=[],D2=0,f1=null,Q2=1,Z2="";function F2(e,t){ye[Te++]=it,ye[Te++]=l3,l3=e,it=t}function Hi(e,t,s){C2[D2++]=Q2,C2[D2++]=Z2,C2[D2++]=f1,f1=e;var i=Q2;e=Z2;var r=32-T2(i)-1;i&=~(1<<r),s+=1;var l=32-T2(t)+r;if(30<l){var a=r-r%5;l=(i&(1<<a)-1).toString(32),i>>=a,r-=a,Q2=1<<32-T2(t)+r|s<<r|i,Z2=l+e}else Q2=1<<l|s<<r|i,Z2=e}function Y4(e){e.return!==null&&(F2(e,1),Hi(e,1,0))}function B4(e){for(;e===l3;)l3=ye[--Te],ye[Te]=null,it=ye[--Te],ye[Te]=null;for(;e===f1;)f1=C2[--D2],C2[D2]=null,Z2=C2[--D2],C2[D2]=null,Q2=C2[--D2],C2[D2]=null}function qi(e,t){C2[D2++]=Q2,C2[D2++]=Z2,C2[D2++]=f1,Q2=t.id,Z2=t.overflow,f1=e}var P0=null,R0=null,_0=!1,h1=null,U2=!1,L4=Error(n(519));function y1(e){var t=Error(n(418,1<arguments.length&&arguments[1]!==void 0&&arguments[1]?"text":"HTML",""));throw rt(N2(t,e)),L4}function Yi(e){var t=e.stateNode,s=e.type,i=e.memoizedProps;switch(t[I0]=e,t[d2]=i,s){case"dialog":a0("cancel",t),a0("close",t);break;case"iframe":case"object":case"embed":a0("load",t);break;case"video":case"audio":for(s=0;s<At.length;s++)a0(At[s],t);break;case"source":a0("error",t);break;case"img":case"image":case"link":a0("error",t),a0("load",t);break;case"details":a0("toggle",t);break;case"input":a0("invalid",t),W5(t,i.value,i.defaultValue,i.checked,i.defaultChecked,i.type,i.name,!0);break;case"select":a0("invalid",t);break;case"textarea":a0("invalid",t),I5(t,i.value,i.defaultValue,i.children)}s=i.children,typeof s!="string"&&typeof s!="number"&&typeof s!="bigint"||t.textContent===""+s||i.suppressHydrationWarning===!0||e6(t.textContent,s)?(i.popover!=null&&(a0("beforetoggle",t),a0("toggle",t)),i.onScroll!=null&&a0("scroll",t),i.onScrollEnd!=null&&a0("scrollend",t),i.onClick!=null&&(t.onclick=$2),t=!0):t=!1,t||y1(e,!0)}function Bi(e){for(P0=e.return;P0;)switch(P0.tag){case 5:case 31:case 13:U2=!1;return;case 27:case 3:U2=!0;return;default:P0=P0.return}}function ve(e){if(e!==P0)return!1;if(!_0)return Bi(e),_0=!0,!1;var t=e.tag,s;if((s=t!==3&&t!==27)&&((s=t===5)&&(s=e.type,s=!(s!=="form"&&s!=="button")||i5(e.type,e.memoizedProps)),s=!s),s&&R0&&y1(e),Bi(e),t===13){if(e=e.memoizedState,e=e!==null?e.dehydrated:null,!e)throw Error(n(317));R0=d6(e)}else if(t===31){if(e=e.memoizedState,e=e!==null?e.dehydrated:null,!e)throw Error(n(317));R0=d6(e)}else t===27?(t=R0,D1(e.type)?(e=n5,n5=null,R0=e):R0=t):R0=P0?j2(e.stateNode.nextSibling):null;return!0}function V1(){R0=P0=null,_0=!1}function G4(){var e=h1;return e!==null&&(_2===null?_2=e:_2.push.apply(_2,e),h1=null),e}function rt(e){h1===null?h1=[e]:h1.push(e)}var X4=m(null),K1=null,I2=null;function T1(e,t,s){v(X4,t._currentValue),t._currentValue=s}function P2(e){e._currentValue=X4.current,D(X4)}function Q4(e,t,s){for(;e!==null;){var i=e.alternate;if((e.childLanes&t)!==t?(e.childLanes|=t,i!==null&&(i.childLanes|=t)):i!==null&&(i.childLanes&t)!==t&&(i.childLanes|=t),e===s)break;e=e.return}}function Z4(e,t,s,i){var r=e.child;for(r!==null&&(r.return=e);r!==null;){var l=r.dependencies;if(l!==null){var a=r.child;l=l.firstContext;e:for(;l!==null;){var u=l;l=r;for(var c=0;c<t.length;c++)if(u.context===t[c]){l.lanes|=s,u=l.alternate,u!==null&&(u.lanes|=s),Q4(l.return,s,e),i||(a=null);break e}l=u.next}}else if(r.tag===18){if(a=r.return,a===null)throw Error(n(341));a.lanes|=s,l=a.alternate,l!==null&&(l.lanes|=s),Q4(a,s,e),a=null}else a=r.child;if(a!==null)a.return=r;else for(a=r;a!==null;){if(a===e){a=null;break}if(r=a.sibling,r!==null){r.return=a.return,a=r;break}a=a.return}r=a}}function ge(e,t,s,i){e=null;for(var r=t,l=!1;r!==null;){if(!l){if((r.flags&524288)!==0)l=!0;else if((r.flags&262144)!==0)break}if(r.tag===10){var a=r.alternate;if(a===null)throw Error(n(387));if(a=a.memoizedProps,a!==null){var u=r.type;v2(r.pendingProps.value,a.value)||(e!==null?e.push(u):e=[u])}}else if(r===z.current){if(a=r.alternate,a===null)throw Error(n(387));a.memoizedState.memoizedState!==r.memoizedState.memoizedState&&(e!==null?e.push(Dt):e=[Dt])}r=r.return}e!==null&&Z4(t,e,s,i),t.flags|=262144}function a3(e){for(e=e.firstContext;e!==null;){if(!v2(e.context._currentValue,e.memoizedValue))return!0;e=e.next}return!1}function J1(e){K1=e,I2=null,e=e.dependencies,e!==null&&(e.firstContext=null)}function e2(e){return Li(K1,e)}function u3(e,t){return K1===null&&J1(e),Li(e,t)}function Li(e,t){var s=t._currentValue;if(t={context:t,memoizedValue:s,next:null},I2===null){if(e===null)throw Error(n(308));I2=t,e.dependencies={lanes:0,firstContext:t},e.flags|=524288}else I2=I2.next=t;return s}var ou=typeof AbortController<"u"?AbortController:function(){var e=[],t=this.signal={aborted:!1,addEventListener:function(s,i){e.push(i)}};this.abort=function(){t.aborted=!0,e.forEach(function(s){return s()})}},mu=d.unstable_scheduleCallback,pu=d.unstable_NormalPriority,V0={$$typeof:d0,Consumer:null,Provider:null,_currentValue:null,_currentValue2:null,_threadCount:0};function V4(){return{controller:new ou,data:new Map,refCount:0}}function lt(e){e.refCount--,e.refCount===0&&mu(pu,function(){e.controller.abort()})}var at=null,K4=0,Se=0,be=null;function _u(e,t){if(at===null){var s=at=[];K4=0,Se=$s(),be={status:"pending",value:void 0,then:function(i){s.push(i)}}}return K4++,t.then(Gi,Gi),t}function Gi(){if(--K4===0&&at!==null){be!==null&&(be.status="fulfilled");var e=at;at=null,Se=0,be=null;for(var t=0;t<e.length;t++)(0,e[t])()}}function fu(e,t){var s=[],i={status:"pending",value:null,reason:null,then:function(r){s.push(r)}};return e.then(function(){i.status="fulfilled",i.value=t;for(var r=0;r<s.length;r++)(0,s[r])(t)},function(r){for(i.status="rejected",i.reason=r,r=0;r<s.length;r++)(0,s[r])(void 0)}),i}var Xi=M.S;M.S=function(e,t){Ml=h2(),typeof t=="object"&&t!==null&&typeof t.then=="function"&&_u(e,t),Xi!==null&&Xi(e,t)};var w1=m(null);function J4(){var e=w1.current;return e!==null?e:D0.pooledCache}function n3(e,t){t===null?v(w1,w1.current):v(w1,t.pool)}function Qi(){var e=J4();return e===null?null:{parent:V0._currentValue,pool:e}}var ze=Error(n(460)),w4=Error(n(474)),d3=Error(n(542)),c3={then:function(){}};function Zi(e){return e=e.status,e==="fulfilled"||e==="rejected"}function Vi(e,t,s){switch(s=e[s],s===void 0?e.push(t):s!==t&&(t.then($2,$2),t=s),t.status){case"fulfilled":return t.value;case"rejected":throw e=t.reason,Ji(e),e;default:if(typeof t.status=="string")t.then($2,$2);else{if(e=D0,e!==null&&100<e.shellSuspendCounter)throw Error(n(482));e=t,e.status="pending",e.then(function(i){if(t.status==="pending"){var r=t;r.status="fulfilled",r.value=i}},function(i){if(t.status==="pending"){var r=t;r.status="rejected",r.reason=i}})}switch(t.status){case"fulfilled":return t.value;case"rejected":throw e=t.reason,Ji(e),e}throw k1=t,ze}}function $1(e){try{var t=e._init;return t(e._payload)}catch(s){throw s!==null&&typeof s=="object"&&typeof s.then=="function"?(k1=s,ze):s}}var k1=null;function Ki(){if(k1===null)throw Error(n(459));var e=k1;return k1=null,e}function Ji(e){if(e===ze||e===d3)throw Error(n(483))}var Me=null,ut=0;function o3(e){var t=ut;return ut+=1,Me===null&&(Me=[]),Vi(Me,e,t)}function nt(e,t){t=t.props.ref,e.ref=t!==void 0?t:null}function m3(e,t){throw t.$$typeof===X?Error(n(525)):(e=Object.prototype.toString.call(t),Error(n(31,e==="[object Object]"?"object with keys {"+Object.keys(t).join(", ")+"}":e)))}function wi(e){function t(_,o){if(e){var h=_.deletions;h===null?(_.deletions=[o],_.flags|=16):h.push(o)}}function s(_,o){if(!e)return null;for(;o!==null;)t(_,o),o=o.sibling;return null}function i(_){for(var o=new Map;_!==null;)_.key!==null?o.set(_.key,_):o.set(_.index,_),_=_.sibling;return o}function r(_,o){return _=W2(_,o),_.index=0,_.sibling=null,_}function l(_,o,h){return _.index=h,e?(h=_.alternate,h!==null?(h=h.index,h<o?(_.flags|=67108866,o):h):(_.flags|=67108866,o)):(_.flags|=1048576,o)}function a(_){return e&&_.alternate===null&&(_.flags|=67108866),_}function u(_,o,h,C){return o===null||o.tag!==6?(o=H4(h,_.mode,C),o.return=_,o):(o=r(o,h),o.return=_,o)}function c(_,o,h,C){var J=h.type;return J===u0?A(_,o,h.props.children,C,h.key):o!==null&&(o.elementType===J||typeof J=="object"&&J!==null&&J.$$typeof===Y0&&$1(J)===o.type)?(o=r(o,h.props),nt(o,h),o.return=_,o):(o=r3(h.type,h.key,h.props,null,_.mode,C),nt(o,h),o.return=_,o)}function y(_,o,h,C){return o===null||o.tag!==4||o.stateNode.containerInfo!==h.containerInfo||o.stateNode.implementation!==h.implementation?(o=q4(h,_.mode,C),o.return=_,o):(o=r(o,h.children||[]),o.return=_,o)}function A(_,o,h,C,J){return o===null||o.tag!==7?(o=Z1(h,_.mode,C,J),o.return=_,o):(o=r(o,h),o.return=_,o)}function U(_,o,h){if(typeof o=="string"&&o!==""||typeof o=="number"||typeof o=="bigint")return o=H4(""+o,_.mode,h),o.return=_,o;if(typeof o=="object"&&o!==null){switch(o.$$typeof){case i0:return h=r3(o.type,o.key,o.props,null,_.mode,h),nt(h,o),h.return=_,h;case h0:return o=q4(o,_.mode,h),o.return=_,o;case Y0:return o=$1(o),U(_,o,h)}if(Z0(o)||E0(o))return o=Z1(o,_.mode,h,null),o.return=_,o;if(typeof o.then=="function")return U(_,o3(o),h);if(o.$$typeof===d0)return U(_,u3(_,o),h);m3(_,o)}return null}function g(_,o,h,C){var J=o!==null?o.key:null;if(typeof h=="string"&&h!==""||typeof h=="number"||typeof h=="bigint")return J!==null?null:u(_,o,""+h,C);if(typeof h=="object"&&h!==null){switch(h.$$typeof){case i0:return h.key===J?c(_,o,h,C):null;case h0:return h.key===J?y(_,o,h,C):null;case Y0:return h=$1(h),g(_,o,h,C)}if(Z0(h)||E0(h))return J!==null?null:A(_,o,h,C,null);if(typeof h.then=="function")return g(_,o,o3(h),C);if(h.$$typeof===d0)return g(_,o,u3(_,h),C);m3(_,h)}return null}function b(_,o,h,C,J){if(typeof C=="string"&&C!==""||typeof C=="number"||typeof C=="bigint")return _=_.get(h)||null,u(o,_,""+C,J);if(typeof C=="object"&&C!==null){switch(C.$$typeof){case i0:return _=_.get(C.key===null?h:C.key)||null,c(o,_,C,J);case h0:return _=_.get(C.key===null?h:C.key)||null,y(o,_,C,J);case Y0:return C=$1(C),b(_,o,h,C,J)}if(Z0(C)||E0(C))return _=_.get(h)||null,A(o,_,C,J,null);if(typeof C.then=="function")return b(_,o,h,o3(C),J);if(C.$$typeof===d0)return b(_,o,h,u3(o,C),J);m3(o,C)}return null}function Q(_,o,h,C){for(var J=null,v0=null,V=o,s0=o=0,o0=null;V!==null&&s0<h.length;s0++){V.index>s0?(o0=V,V=null):o0=V.sibling;var g0=g(_,V,h[s0],C);if(g0===null){V===null&&(V=o0);break}e&&V&&g0.alternate===null&&t(_,V),o=l(g0,o,s0),v0===null?J=g0:v0.sibling=g0,v0=g0,V=o0}if(s0===h.length)return s(_,V),_0&&F2(_,s0),J;if(V===null){for(;s0<h.length;s0++)V=U(_,h[s0],C),V!==null&&(o=l(V,o,s0),v0===null?J=V:v0.sibling=V,v0=V);return _0&&F2(_,s0),J}for(V=i(V);s0<h.length;s0++)o0=b(V,_,s0,h[s0],C),o0!==null&&(e&&o0.alternate!==null&&V.delete(o0.key===null?s0:o0.key),o=l(o0,o,s0),v0===null?J=o0:v0.sibling=o0,v0=o0);return e&&V.forEach(function(q1){return t(_,q1)}),_0&&F2(_,s0),J}function $(_,o,h,C){if(h==null)throw Error(n(151));for(var J=null,v0=null,V=o,s0=o=0,o0=null,g0=h.next();V!==null&&!g0.done;s0++,g0=h.next()){V.index>s0?(o0=V,V=null):o0=V.sibling;var q1=g(_,V,g0.value,C);if(q1===null){V===null&&(V=o0);break}e&&V&&q1.alternate===null&&t(_,V),o=l(q1,o,s0),v0===null?J=q1:v0.sibling=q1,v0=q1,V=o0}if(g0.done)return s(_,V),_0&&F2(_,s0),J;if(V===null){for(;!g0.done;s0++,g0=h.next())g0=U(_,g0.value,C),g0!==null&&(o=l(g0,o,s0),v0===null?J=g0:v0.sibling=g0,v0=g0);return _0&&F2(_,s0),J}for(V=i(V);!g0.done;s0++,g0=h.next())g0=b(V,_,s0,g0.value,C),g0!==null&&(e&&g0.alternate!==null&&V.delete(g0.key===null?s0:g0.key),o=l(g0,o,s0),v0===null?J=g0:v0.sibling=g0,v0=g0);return e&&V.forEach(function(xn){return t(_,xn)}),_0&&F2(_,s0),J}function N0(_,o,h,C){if(typeof h=="object"&&h!==null&&h.type===u0&&h.key===null&&(h=h.props.children),typeof h=="object"&&h!==null){switch(h.$$typeof){case i0:e:{for(var J=h.key;o!==null;){if(o.key===J){if(J=h.type,J===u0){if(o.tag===7){s(_,o.sibling),C=r(o,h.props.children),C.return=_,_=C;break e}}else if(o.elementType===J||typeof J=="object"&&J!==null&&J.$$typeof===Y0&&$1(J)===o.type){s(_,o.sibling),C=r(o,h.props),nt(C,h),C.return=_,_=C;break e}s(_,o);break}else t(_,o);o=o.sibling}h.type===u0?(C=Z1(h.props.children,_.mode,C,h.key),C.return=_,_=C):(C=r3(h.type,h.key,h.props,null,_.mode,C),nt(C,h),C.return=_,_=C)}return a(_);case h0:e:{for(J=h.key;o!==null;){if(o.key===J)if(o.tag===4&&o.stateNode.containerInfo===h.containerInfo&&o.stateNode.implementation===h.implementation){s(_,o.sibling),C=r(o,h.children||[]),C.return=_,_=C;break e}else{s(_,o);break}else t(_,o);o=o.sibling}C=q4(h,_.mode,C),C.return=_,_=C}return a(_);case Y0:return h=$1(h),N0(_,o,h,C)}if(Z0(h))return Q(_,o,h,C);if(E0(h)){if(J=E0(h),typeof J!="function")throw Error(n(150));return h=J.call(h),$(_,o,h,C)}if(typeof h.then=="function")return N0(_,o,o3(h),C);if(h.$$typeof===d0)return N0(_,o,u3(_,h),C);m3(_,h)}return typeof h=="string"&&h!==""||typeof h=="number"||typeof h=="bigint"?(h=""+h,o!==null&&o.tag===6?(s(_,o.sibling),C=r(o,h),C.return=_,_=C):(s(_,o),C=H4(h,_.mode,C),C.return=_,_=C),a(_)):s(_,o)}return function(_,o,h,C){try{ut=0;var J=N0(_,o,h,C);return Me=null,J}catch(V){if(V===ze||V===d3)throw V;var v0=g2(29,V,null,_.mode);return v0.lanes=C,v0.return=_,v0}finally{}}}var W1=wi(!0),$i=wi(!1),v1=!1;function $4(e){e.updateQueue={baseState:e.memoizedState,firstBaseUpdate:null,lastBaseUpdate:null,shared:{pending:null,lanes:0,hiddenCallbacks:null},callbacks:null}}function k4(e,t){e=e.updateQueue,t.updateQueue===e&&(t.updateQueue={baseState:e.baseState,firstBaseUpdate:e.firstBaseUpdate,lastBaseUpdate:e.lastBaseUpdate,shared:e.shared,callbacks:null})}function g1(e){return{lane:e,tag:0,payload:null,callback:null,next:null}}function S1(e,t,s){var i=e.updateQueue;if(i===null)return null;if(i=i.shared,(b0&2)!==0){var r=i.pending;return r===null?t.next=t:(t.next=r.next,r.next=t),i.pending=t,t=i3(e),Di(e,null,s),t}return s3(e,i,t,s),i3(e)}function dt(e,t,s){if(t=t.updateQueue,t!==null&&(t=t.shared,(s&4194048)!==0)){var i=t.lanes;i&=e.pendingLanes,s|=i,t.lanes=s,L5(e,s)}}function W4(e,t){var s=e.updateQueue,i=e.alternate;if(i!==null&&(i=i.updateQueue,s===i)){var r=null,l=null;if(s=s.firstBaseUpdate,s!==null){do{var a={lane:s.lane,tag:s.tag,payload:s.payload,callback:null,next:null};l===null?r=l=a:l=l.next=a,s=s.next}while(s!==null);l===null?r=l=t:l=l.next=t}else r=l=t;s={baseState:i.baseState,firstBaseUpdate:r,lastBaseUpdate:l,shared:i.shared,callbacks:i.callbacks},e.updateQueue=s;return}e=s.lastBaseUpdate,e===null?s.firstBaseUpdate=t:e.next=t,s.lastBaseUpdate=t}var F4=!1;function ct(){if(F4){var e=be;if(e!==null)throw e}}function ot(e,t,s,i){F4=!1;var r=e.updateQueue;v1=!1;var l=r.firstBaseUpdate,a=r.lastBaseUpdate,u=r.shared.pending;if(u!==null){r.shared.pending=null;var c=u,y=c.next;c.next=null,a===null?l=y:a.next=y,a=c;var A=e.alternate;A!==null&&(A=A.updateQueue,u=A.lastBaseUpdate,u!==a&&(u===null?A.firstBaseUpdate=y:u.next=y,A.lastBaseUpdate=c))}if(l!==null){var U=r.baseState;a=0,A=y=c=null,u=l;do{var g=u.lane&-536870913,b=g!==u.lane;if(b?(c0&g)===g:(i&g)===g){g!==0&&g===Se&&(F4=!0),A!==null&&(A=A.next={lane:0,tag:u.tag,payload:u.payload,callback:null,next:null});e:{var Q=e,$=u;g=t;var N0=s;switch($.tag){case 1:if(Q=$.payload,typeof Q=="function"){U=Q.call(N0,U,g);break e}U=Q;break e;case 3:Q.flags=Q.flags&-65537|128;case 0:if(Q=$.payload,g=typeof Q=="function"?Q.call(N0,U,g):Q,g==null)break e;U=Y({},U,g);break e;case 2:v1=!0}}g=u.callback,g!==null&&(e.flags|=64,b&&(e.flags|=8192),b=r.callbacks,b===null?r.callbacks=[g]:b.push(g))}else b={lane:g,tag:u.tag,payload:u.payload,callback:u.callback,next:null},A===null?(y=A=b,c=U):A=A.next=b,a|=g;if(u=u.next,u===null){if(u=r.shared.pending,u===null)break;b=u,u=b.next,b.next=null,r.lastBaseUpdate=b,r.shared.pending=null}}while(!0);A===null&&(c=U),r.baseState=c,r.firstBaseUpdate=y,r.lastBaseUpdate=A,l===null&&(r.shared.lanes=0),A1|=a,e.lanes=a,e.memoizedState=U}}function ki(e,t){if(typeof e!="function")throw Error(n(191,e));e.call(t)}function Wi(e,t){var s=e.callbacks;if(s!==null)for(e.callbacks=null,e=0;e<s.length;e++)ki(s[e],t)}var Ee=m(null),p3=m(0);function Fi(e,t){e=n1,v(p3,e),v(Ee,t),n1=e|t.baseLanes}function I4(){v(p3,n1),v(Ee,Ee.current)}function P4(){n1=p3.current,D(Ee),D(p3)}var S2=m(null),R2=null;function b1(e){var t=e.alternate;v(X0,X0.current&1),v(S2,e),R2===null&&(t===null||Ee.current!==null||t.memoizedState!==null)&&(R2=e)}function es(e){v(X0,X0.current),v(S2,e),R2===null&&(R2=e)}function Ii(e){e.tag===22?(v(X0,X0.current),v(S2,e),R2===null&&(R2=e)):z1()}function z1(){v(X0,X0.current),v(S2,S2.current)}function b2(e){D(S2),R2===e&&(R2=null),D(X0)}var X0=m(0);function _3(e){for(var t=e;t!==null;){if(t.tag===13){var s=t.memoizedState;if(s!==null&&(s=s.dehydrated,s===null||a5(s)||u5(s)))return t}else if(t.tag===19&&(t.memoizedProps.revealOrder==="forwards"||t.memoizedProps.revealOrder==="backwards"||t.memoizedProps.revealOrder==="unstable_legacy-backwards"||t.memoizedProps.revealOrder==="together")){if((t.flags&128)!==0)return t}else if(t.child!==null){t.child.return=t,t=t.child;continue}if(t===e)break;for(;t.sibling===null;){if(t.return===null||t.return===e)return null;t=t.return}t.sibling.return=t.return,t=t.sibling}return null}var e1=0,e0=null,x0=null,K0=null,f3=!1,Ae=!1,F1=!1,h3=0,mt=0,xe=null,hu=0;function B0(){throw Error(n(321))}function ts(e,t){if(t===null)return!1;for(var s=0;s<t.length&&s<e.length;s++)if(!v2(e[s],t[s]))return!1;return!0}function ss(e,t,s,i,r,l){return e1=l,e0=t,t.memoizedState=null,t.updateQueue=null,t.lanes=0,M.H=e===null||e.memoizedState===null?Hr:ys,F1=!1,l=s(i,r),F1=!1,Ae&&(l=er(t,s,i,r)),Pi(e),l}function Pi(e){M.H=ft;var t=x0!==null&&x0.next!==null;if(e1=0,K0=x0=e0=null,f3=!1,mt=0,xe=null,t)throw Error(n(300));e===null||J0||(e=e.dependencies,e!==null&&a3(e)&&(J0=!0))}function er(e,t,s,i){e0=e;var r=0;do{if(Ae&&(xe=null),mt=0,Ae=!1,25<=r)throw Error(n(301));if(r+=1,K0=x0=null,e.updateQueue!=null){var l=e.updateQueue;l.lastEffect=null,l.events=null,l.stores=null,l.memoCache!=null&&(l.memoCache.index=0)}M.H=qr,l=t(s,i)}while(Ae);return l}function yu(){var e=M.H,t=e.useState()[0];return t=typeof t.then=="function"?pt(t):t,e=e.useState()[0],(x0!==null?x0.memoizedState:null)!==e&&(e0.flags|=1024),t}function is(){var e=h3!==0;return h3=0,e}function rs(e,t,s){t.updateQueue=e.updateQueue,t.flags&=-2053,e.lanes&=~s}function ls(e){if(f3){for(e=e.memoizedState;e!==null;){var t=e.queue;t!==null&&(t.pending=null),e=e.next}f3=!1}e1=0,K0=x0=e0=null,Ae=!1,mt=h3=0,xe=null}function a2(){var e={memoizedState:null,baseState:null,baseQueue:null,queue:null,next:null};return K0===null?e0.memoizedState=K0=e:K0=K0.next=e,K0}function Q0(){if(x0===null){var e=e0.alternate;e=e!==null?e.memoizedState:null}else e=x0.next;var t=K0===null?e0.memoizedState:K0.next;if(t!==null)K0=t,x0=e;else{if(e===null)throw e0.alternate===null?Error(n(467)):Error(n(310));x0=e,e={memoizedState:x0.memoizedState,baseState:x0.baseState,baseQueue:x0.baseQueue,queue:x0.queue,next:null},K0===null?e0.memoizedState=K0=e:K0=K0.next=e}return K0}function y3(){return{lastEffect:null,events:null,stores:null,memoCache:null}}function pt(e){var t=mt;return mt+=1,xe===null&&(xe=[]),e=Vi(xe,e,t),t=e0,(K0===null?t.memoizedState:K0.next)===null&&(t=t.alternate,M.H=t===null||t.memoizedState===null?Hr:ys),e}function T3(e){if(e!==null&&typeof e=="object"){if(typeof e.then=="function")return pt(e);if(e.$$typeof===d0)return e2(e)}throw Error(n(438,String(e)))}function as(e){var t=null,s=e0.updateQueue;if(s!==null&&(t=s.memoCache),t==null){var i=e0.alternate;i!==null&&(i=i.updateQueue,i!==null&&(i=i.memoCache,i!=null&&(t={data:i.data.map(function(r){return r.slice()}),index:0})))}if(t==null&&(t={data:[],index:0}),s===null&&(s=y3(),e0.updateQueue=s),s.memoCache=t,s=t.data[t.index],s===void 0)for(s=t.data[t.index]=Array(e),i=0;i<e;i++)s[i]=H0;return t.index++,s}function t1(e,t){return typeof t=="function"?t(e):t}function v3(e){var t=Q0();return us(t,x0,e)}function us(e,t,s){var i=e.queue;if(i===null)throw Error(n(311));i.lastRenderedReducer=s;var r=e.baseQueue,l=i.pending;if(l!==null){if(r!==null){var a=r.next;r.next=l.next,l.next=a}t.baseQueue=r=l,i.pending=null}if(l=e.baseState,r===null)e.memoizedState=l;else{t=r.next;var u=a=null,c=null,y=t,A=!1;do{var U=y.lane&-536870913;if(U!==y.lane?(c0&U)===U:(e1&U)===U){var g=y.revertLane;if(g===0)c!==null&&(c=c.next={lane:0,revertLane:0,gesture:null,action:y.action,hasEagerState:y.hasEagerState,eagerState:y.eagerState,next:null}),U===Se&&(A=!0);else if((e1&g)===g){y=y.next,g===Se&&(A=!0);continue}else U={lane:0,revertLane:y.revertLane,gesture:null,action:y.action,hasEagerState:y.hasEagerState,eagerState:y.eagerState,next:null},c===null?(u=c=U,a=l):c=c.next=U,e0.lanes|=g,A1|=g;U=y.action,F1&&s(l,U),l=y.hasEagerState?y.eagerState:s(l,U)}else g={lane:U,revertLane:y.revertLane,gesture:y.gesture,action:y.action,hasEagerState:y.hasEagerState,eagerState:y.eagerState,next:null},c===null?(u=c=g,a=l):c=c.next=g,e0.lanes|=U,A1|=U;y=y.next}while(y!==null&&y!==t);if(c===null?a=l:c.next=u,!v2(l,e.memoizedState)&&(J0=!0,A&&(s=be,s!==null)))throw s;e.memoizedState=l,e.baseState=a,e.baseQueue=c,i.lastRenderedState=l}return r===null&&(i.lanes=0),[e.memoizedState,i.dispatch]}function ns(e){var t=Q0(),s=t.queue;if(s===null)throw Error(n(311));s.lastRenderedReducer=e;var i=s.dispatch,r=s.pending,l=t.memoizedState;if(r!==null){s.pending=null;var a=r=r.next;do l=e(l,a.action),a=a.next;while(a!==r);v2(l,t.memoizedState)||(J0=!0),t.memoizedState=l,t.baseQueue===null&&(t.baseState=l),s.lastRenderedState=l}return[l,i]}function tr(e,t,s){var i=e0,r=Q0(),l=_0;if(l){if(s===void 0)throw Error(n(407));s=s()}else s=t();var a=!v2((x0||r).memoizedState,s);if(a&&(r.memoizedState=s,J0=!0),r=r.queue,os(rr.bind(null,i,r,e),[e]),r.getSnapshot!==t||a||K0!==null&&K0.memoizedState.tag&1){if(i.flags|=2048,Oe(9,{destroy:void 0},ir.bind(null,i,r,s,t),null),D0===null)throw Error(n(349));l||(e1&127)!==0||sr(i,t,s)}return s}function sr(e,t,s){e.flags|=16384,e={getSnapshot:t,value:s},t=e0.updateQueue,t===null?(t=y3(),e0.updateQueue=t,t.stores=[e]):(s=t.stores,s===null?t.stores=[e]:s.push(e))}function ir(e,t,s,i){t.value=s,t.getSnapshot=i,lr(t)&&ar(e)}function rr(e,t,s){return s(function(){lr(t)&&ar(e)})}function lr(e){var t=e.getSnapshot;e=e.value;try{var s=t();return!v2(e,s)}catch{return!0}}function ar(e){var t=Q1(e,2);t!==null&&f2(t,e,2)}function ds(e){var t=a2();if(typeof e=="function"){var s=e;if(e=s(),F1){m1(!0);try{s()}finally{m1(!1)}}}return t.memoizedState=t.baseState=e,t.queue={pending:null,lanes:0,dispatch:null,lastRenderedReducer:t1,lastRenderedState:e},t}function ur(e,t,s,i){return e.baseState=s,us(e,x0,typeof i=="function"?i:t1)}function Tu(e,t,s,i,r){if(b3(e))throw Error(n(485));if(e=t.action,e!==null){var l={payload:r,action:e,next:null,isTransition:!0,status:"pending",value:null,reason:null,listeners:[],then:function(a){l.listeners.push(a)}};M.T!==null?s(!0):l.isTransition=!1,i(l),s=t.pending,s===null?(l.next=t.pending=l,nr(t,l)):(l.next=s.next,t.pending=s.next=l)}}function nr(e,t){var s=t.action,i=t.payload,r=e.state;if(t.isTransition){var l=M.T,a={};M.T=a;try{var u=s(r,i),c=M.S;c!==null&&c(a,u),dr(e,t,u)}catch(y){cs(e,t,y)}finally{l!==null&&a.types!==null&&(l.types=a.types),M.T=l}}else try{l=s(r,i),dr(e,t,l)}catch(y){cs(e,t,y)}}function dr(e,t,s){s!==null&&typeof s=="object"&&typeof s.then=="function"?s.then(function(i){cr(e,t,i)},function(i){return cs(e,t,i)}):cr(e,t,s)}function cr(e,t,s){t.status="fulfilled",t.value=s,or(t),e.state=s,t=e.pending,t!==null&&(s=t.next,s===t?e.pending=null:(s=s.next,t.next=s,nr(e,s)))}function cs(e,t,s){var i=e.pending;if(e.pending=null,i!==null){i=i.next;do t.status="rejected",t.reason=s,or(t),t=t.next;while(t!==i)}e.action=null}function or(e){e=e.listeners;for(var t=0;t<e.length;t++)(0,e[t])()}function mr(e,t){return t}function pr(e,t){if(_0){var s=D0.formState;if(s!==null){e:{var i=e0;if(_0){if(R0){t:{for(var r=R0,l=U2;r.nodeType!==8;){if(!l){r=null;break t}if(r=j2(r.nextSibling),r===null){r=null;break t}}l=r.data,r=l==="F!"||l==="F"?r:null}if(r){R0=j2(r.nextSibling),i=r.data==="F!";break e}}y1(i)}i=!1}i&&(t=s[0])}}return s=a2(),s.memoizedState=s.baseState=t,i={pending:null,lanes:0,dispatch:null,lastRenderedReducer:mr,lastRenderedState:t},s.queue=i,s=Ur.bind(null,e0,i),i.dispatch=s,i=ds(!1),l=hs.bind(null,e0,!1,i.queue),i=a2(),r={state:t,dispatch:null,action:e,pending:null},i.queue=r,s=Tu.bind(null,e0,r,l,s),r.dispatch=s,i.memoizedState=e,[t,s,!1]}function _r(e){var t=Q0();return fr(t,x0,e)}function fr(e,t,s){if(t=us(e,t,mr)[0],e=v3(t1)[0],typeof t=="object"&&t!==null&&typeof t.then=="function")try{var i=pt(t)}catch(a){throw a===ze?d3:a}else i=t;t=Q0();var r=t.queue,l=r.dispatch;return s!==t.memoizedState&&(e0.flags|=2048,Oe(9,{destroy:void 0},vu.bind(null,r,s),null)),[i,l,e]}function vu(e,t){e.action=t}function hr(e){var t=Q0(),s=x0;if(s!==null)return fr(t,s,e);Q0(),t=t.memoizedState,s=Q0();var i=s.queue.dispatch;return s.memoizedState=e,[t,i,!1]}function Oe(e,t,s,i){return e={tag:e,create:s,deps:i,inst:t,next:null},t=e0.updateQueue,t===null&&(t=y3(),e0.updateQueue=t),s=t.lastEffect,s===null?t.lastEffect=e.next=e:(i=s.next,s.next=e,e.next=i,t.lastEffect=e),e}function yr(){return Q0().memoizedState}function g3(e,t,s,i){var r=a2();e0.flags|=e,r.memoizedState=Oe(1|t,{destroy:void 0},s,i===void 0?null:i)}function S3(e,t,s,i){var r=Q0();i=i===void 0?null:i;var l=r.memoizedState.inst;x0!==null&&i!==null&&ts(i,x0.memoizedState.deps)?r.memoizedState=Oe(t,l,s,i):(e0.flags|=e,r.memoizedState=Oe(1|t,l,s,i))}function Tr(e,t){g3(8390656,8,e,t)}function os(e,t){S3(2048,8,e,t)}function gu(e){e0.flags|=4;var t=e0.updateQueue;if(t===null)t=y3(),e0.updateQueue=t,t.events=[e];else{var s=t.events;s===null?t.events=[e]:s.push(e)}}function vr(e){var t=Q0().memoizedState;return gu({ref:t,nextImpl:e}),function(){if((b0&2)!==0)throw Error(n(440));return t.impl.apply(void 0,arguments)}}function gr(e,t){return S3(4,2,e,t)}function Sr(e,t){return S3(4,4,e,t)}function br(e,t){if(typeof t=="function"){e=e();var s=t(e);return function(){typeof s=="function"?s():t(null)}}if(t!=null)return e=e(),t.current=e,function(){t.current=null}}function zr(e,t,s){s=s!=null?s.concat([e]):null,S3(4,4,br.bind(null,t,e),s)}function ms(){}function Mr(e,t){var s=Q0();t=t===void 0?null:t;var i=s.memoizedState;return t!==null&&ts(t,i[1])?i[0]:(s.memoizedState=[e,t],e)}function Er(e,t){var s=Q0();t=t===void 0?null:t;var i=s.memoizedState;if(t!==null&&ts(t,i[1]))return i[0];if(i=e(),F1){m1(!0);try{e()}finally{m1(!1)}}return s.memoizedState=[i,t],i}function ps(e,t,s){return s===void 0||(e1&1073741824)!==0&&(c0&261930)===0?e.memoizedState=t:(e.memoizedState=s,e=Al(),e0.lanes|=e,A1|=e,s)}function Ar(e,t,s,i){return v2(s,t)?s:Ee.current!==null?(e=ps(e,s,i),v2(e,t)||(J0=!0),e):(e1&42)===0||(e1&1073741824)!==0&&(c0&261930)===0?(J0=!0,e.memoizedState=s):(e=Al(),e0.lanes|=e,A1|=e,t)}function xr(e,t,s,i,r){var l=L.p;L.p=l!==0&&8>l?l:8;var a=M.T,u={};M.T=u,hs(e,!1,t,s);try{var c=r(),y=M.S;if(y!==null&&y(u,c),c!==null&&typeof c=="object"&&typeof c.then=="function"){var A=fu(c,i);_t(e,t,A,E2(e))}else _t(e,t,i,E2(e))}catch(U){_t(e,t,{then:function(){},status:"rejected",reason:U},E2())}finally{L.p=l,a!==null&&u.types!==null&&(a.types=u.types),M.T=a}}function Su(){}function _s(e,t,s,i){if(e.tag!==5)throw Error(n(476));var r=Or(e).queue;xr(e,r,t,w,s===null?Su:function(){return Nr(e),s(i)})}function Or(e){var t=e.memoizedState;if(t!==null)return t;t={memoizedState:w,baseState:w,baseQueue:null,queue:{pending:null,lanes:0,dispatch:null,lastRenderedReducer:t1,lastRenderedState:w},next:null};var s={};return t.next={memoizedState:s,baseState:s,baseQueue:null,queue:{pending:null,lanes:0,dispatch:null,lastRenderedReducer:t1,lastRenderedState:s},next:null},e.memoizedState=t,e=e.alternate,e!==null&&(e.memoizedState=t),t}function Nr(e){var t=Or(e);t.next===null&&(t=e.alternate.memoizedState),_t(e,t.next.queue,{},E2())}function fs(){return e2(Dt)}function Cr(){return Q0().memoizedState}function Dr(){return Q0().memoizedState}function bu(e){for(var t=e.return;t!==null;){switch(t.tag){case 24:case 3:var s=E2();e=g1(s);var i=S1(t,e,s);i!==null&&(f2(i,t,s),dt(i,t,s)),t={cache:V4()},e.payload=t;return}t=t.return}}function zu(e,t,s){var i=E2();s={lane:i,revertLane:0,gesture:null,action:s,hasEagerState:!1,eagerState:null,next:null},b3(e)?Rr(t,s):(s=R4(e,t,s,i),s!==null&&(f2(s,e,i),jr(s,t,i)))}function Ur(e,t,s){var i=E2();_t(e,t,s,i)}function _t(e,t,s,i){var r={lane:i,revertLane:0,gesture:null,action:s,hasEagerState:!1,eagerState:null,next:null};if(b3(e))Rr(t,r);else{var l=e.alternate;if(e.lanes===0&&(l===null||l.lanes===0)&&(l=t.lastRenderedReducer,l!==null))try{var a=t.lastRenderedState,u=l(a,s);if(r.hasEagerState=!0,r.eagerState=u,v2(u,a))return s3(e,t,r,0),D0===null&&t3(),!1}catch{}finally{}if(s=R4(e,t,r,i),s!==null)return f2(s,e,i),jr(s,t,i),!0}return!1}function hs(e,t,s,i){if(i={lane:2,revertLane:$s(),gesture:null,action:i,hasEagerState:!1,eagerState:null,next:null},b3(e)){if(t)throw Error(n(479))}else t=R4(e,s,i,2),t!==null&&f2(t,e,2)}function b3(e){var t=e.alternate;return e===e0||t!==null&&t===e0}function Rr(e,t){Ae=f3=!0;var s=e.pending;s===null?t.next=t:(t.next=s.next,s.next=t),e.pending=t}function jr(e,t,s){if((s&4194048)!==0){var i=t.lanes;i&=e.pendingLanes,s|=i,t.lanes=s,L5(e,s)}}var ft={readContext:e2,use:T3,useCallback:B0,useContext:B0,useEffect:B0,useImperativeHandle:B0,useLayoutEffect:B0,useInsertionEffect:B0,useMemo:B0,useReducer:B0,useRef:B0,useState:B0,useDebugValue:B0,useDeferredValue:B0,useTransition:B0,useSyncExternalStore:B0,useId:B0,useHostTransitionStatus:B0,useFormState:B0,useActionState:B0,useOptimistic:B0,useMemoCache:B0,useCacheRefresh:B0};ft.useEffectEvent=B0;var Hr={readContext:e2,use:T3,useCallback:function(e,t){return a2().memoizedState=[e,t===void 0?null:t],e},useContext:e2,useEffect:Tr,useImperativeHandle:function(e,t,s){s=s!=null?s.concat([e]):null,g3(4194308,4,br.bind(null,t,e),s)},useLayoutEffect:function(e,t){return g3(4194308,4,e,t)},useInsertionEffect:function(e,t){g3(4,2,e,t)},useMemo:function(e,t){var s=a2();t=t===void 0?null:t;var i=e();if(F1){m1(!0);try{e()}finally{m1(!1)}}return s.memoizedState=[i,t],i},useReducer:function(e,t,s){var i=a2();if(s!==void 0){var r=s(t);if(F1){m1(!0);try{s(t)}finally{m1(!1)}}}else r=t;return i.memoizedState=i.baseState=r,e={pending:null,lanes:0,dispatch:null,lastRenderedReducer:e,lastRenderedState:r},i.queue=e,e=e.dispatch=zu.bind(null,e0,e),[i.memoizedState,e]},useRef:function(e){var t=a2();return e={current:e},t.memoizedState=e},useState:function(e){e=ds(e);var t=e.queue,s=Ur.bind(null,e0,t);return t.dispatch=s,[e.memoizedState,s]},useDebugValue:ms,useDeferredValue:function(e,t){var s=a2();return ps(s,e,t)},useTransition:function(){var e=ds(!1);return e=xr.bind(null,e0,e.queue,!0,!1),a2().memoizedState=e,[!1,e]},useSyncExternalStore:function(e,t,s){var i=e0,r=a2();if(_0){if(s===void 0)throw Error(n(407));s=s()}else{if(s=t(),D0===null)throw Error(n(349));(c0&127)!==0||sr(i,t,s)}r.memoizedState=s;var l={value:s,getSnapshot:t};return r.queue=l,Tr(rr.bind(null,i,l,e),[e]),i.flags|=2048,Oe(9,{destroy:void 0},ir.bind(null,i,l,s,t),null),s},useId:function(){var e=a2(),t=D0.identifierPrefix;if(_0){var s=Z2,i=Q2;s=(i&~(1<<32-T2(i)-1)).toString(32)+s,t="_"+t+"R_"+s,s=h3++,0<s&&(t+="H"+s.toString(32)),t+="_"}else s=hu++,t="_"+t+"r_"+s.toString(32)+"_";return e.memoizedState=t},useHostTransitionStatus:fs,useFormState:pr,useActionState:pr,useOptimistic:function(e){var t=a2();t.memoizedState=t.baseState=e;var s={pending:null,lanes:0,dispatch:null,lastRenderedReducer:null,lastRenderedState:null};return t.queue=s,t=hs.bind(null,e0,!0,s),s.dispatch=t,[e,t]},useMemoCache:as,useCacheRefresh:function(){return a2().memoizedState=bu.bind(null,e0)},useEffectEvent:function(e){var t=a2(),s={impl:e};return t.memoizedState=s,function(){if((b0&2)!==0)throw Error(n(440));return s.impl.apply(void 0,arguments)}}},ys={readContext:e2,use:T3,useCallback:Mr,useContext:e2,useEffect:os,useImperativeHandle:zr,useInsertionEffect:gr,useLayoutEffect:Sr,useMemo:Er,useReducer:v3,useRef:yr,useState:function(){return v3(t1)},useDebugValue:ms,useDeferredValue:function(e,t){var s=Q0();return Ar(s,x0.memoizedState,e,t)},useTransition:function(){var e=v3(t1)[0],t=Q0().memoizedState;return[typeof e=="boolean"?e:pt(e),t]},useSyncExternalStore:tr,useId:Cr,useHostTransitionStatus:fs,useFormState:_r,useActionState:_r,useOptimistic:function(e,t){var s=Q0();return ur(s,x0,e,t)},useMemoCache:as,useCacheRefresh:Dr};ys.useEffectEvent=vr;var qr={readContext:e2,use:T3,useCallback:Mr,useContext:e2,useEffect:os,useImperativeHandle:zr,useInsertionEffect:gr,useLayoutEffect:Sr,useMemo:Er,useReducer:ns,useRef:yr,useState:function(){return ns(t1)},useDebugValue:ms,useDeferredValue:function(e,t){var s=Q0();return x0===null?ps(s,e,t):Ar(s,x0.memoizedState,e,t)},useTransition:function(){var e=ns(t1)[0],t=Q0().memoizedState;return[typeof e=="boolean"?e:pt(e),t]},useSyncExternalStore:tr,useId:Cr,useHostTransitionStatus:fs,useFormState:hr,useActionState:hr,useOptimistic:function(e,t){var s=Q0();return x0!==null?ur(s,x0,e,t):(s.baseState=e,[e,s.queue.dispatch])},useMemoCache:as,useCacheRefresh:Dr};qr.useEffectEvent=vr;function Ts(e,t,s,i){t=e.memoizedState,s=s(i,t),s=s==null?t:Y({},t,s),e.memoizedState=s,e.lanes===0&&(e.updateQueue.baseState=s)}var vs={enqueueSetState:function(e,t,s){e=e._reactInternals;var i=E2(),r=g1(i);r.payload=t,s!=null&&(r.callback=s),t=S1(e,r,i),t!==null&&(f2(t,e,i),dt(t,e,i))},enqueueReplaceState:function(e,t,s){e=e._reactInternals;var i=E2(),r=g1(i);r.tag=1,r.payload=t,s!=null&&(r.callback=s),t=S1(e,r,i),t!==null&&(f2(t,e,i),dt(t,e,i))},enqueueForceUpdate:function(e,t){e=e._reactInternals;var s=E2(),i=g1(s);i.tag=2,t!=null&&(i.callback=t),t=S1(e,i,s),t!==null&&(f2(t,e,s),dt(t,e,s))}};function Yr(e,t,s,i,r,l,a){return e=e.stateNode,typeof e.shouldComponentUpdate=="function"?e.shouldComponentUpdate(i,l,a):t.prototype&&t.prototype.isPureReactComponent?!tt(s,i)||!tt(r,l):!0}function Br(e,t,s,i){e=t.state,typeof t.componentWillReceiveProps=="function"&&t.componentWillReceiveProps(s,i),typeof t.UNSAFE_componentWillReceiveProps=="function"&&t.UNSAFE_componentWillReceiveProps(s,i),t.state!==e&&vs.enqueueReplaceState(t,t.state,null)}function I1(e,t){var s=t;if("ref"in t){s={};for(var i in t)i!=="ref"&&(s[i]=t[i])}if(e=e.defaultProps){s===t&&(s=Y({},s));for(var r in e)s[r]===void 0&&(s[r]=e[r])}return s}function Lr(e){e3(e)}function Gr(e){console.error(e)}function Xr(e){e3(e)}function z3(e,t){try{var s=e.onUncaughtError;s(t.value,{componentStack:t.stack})}catch(i){setTimeout(function(){throw i})}}function Qr(e,t,s){try{var i=e.onCaughtError;i(s.value,{componentStack:s.stack,errorBoundary:t.tag===1?t.stateNode:null})}catch(r){setTimeout(function(){throw r})}}function gs(e,t,s){return s=g1(s),s.tag=3,s.payload={element:null},s.callback=function(){z3(e,t)},s}function Zr(e){return e=g1(e),e.tag=3,e}function Vr(e,t,s,i){var r=s.type.getDerivedStateFromError;if(typeof r=="function"){var l=i.value;e.payload=function(){return r(l)},e.callback=function(){Qr(t,s,i)}}var a=s.stateNode;a!==null&&typeof a.componentDidCatch=="function"&&(e.callback=function(){Qr(t,s,i),typeof r!="function"&&(x1===null?x1=new Set([this]):x1.add(this));var u=i.stack;this.componentDidCatch(i.value,{componentStack:u!==null?u:""})})}function Mu(e,t,s,i,r){if(s.flags|=32768,i!==null&&typeof i=="object"&&typeof i.then=="function"){if(t=s.alternate,t!==null&&ge(t,s,r,!0),s=S2.current,s!==null){switch(s.tag){case 31:case 13:return R2===null?H3():s.alternate===null&&L0===0&&(L0=3),s.flags&=-257,s.flags|=65536,s.lanes=r,i===c3?s.flags|=16384:(t=s.updateQueue,t===null?s.updateQueue=new Set([i]):t.add(i),Ks(e,i,r)),!1;case 22:return s.flags|=65536,i===c3?s.flags|=16384:(t=s.updateQueue,t===null?(t={transitions:null,markerInstances:null,retryQueue:new Set([i])},s.updateQueue=t):(s=t.retryQueue,s===null?t.retryQueue=new Set([i]):s.add(i)),Ks(e,i,r)),!1}throw Error(n(435,s.tag))}return Ks(e,i,r),H3(),!1}if(_0)return t=S2.current,t!==null?((t.flags&65536)===0&&(t.flags|=256),t.flags|=65536,t.lanes=r,i!==L4&&(e=Error(n(422),{cause:i}),rt(N2(e,s)))):(i!==L4&&(t=Error(n(423),{cause:i}),rt(N2(t,s))),e=e.current.alternate,e.flags|=65536,r&=-r,e.lanes|=r,i=N2(i,s),r=gs(e.stateNode,i,r),W4(e,r),L0!==4&&(L0=2)),!1;var l=Error(n(520),{cause:i});if(l=N2(l,s),zt===null?zt=[l]:zt.push(l),L0!==4&&(L0=2),t===null)return!0;i=N2(i,s),s=t;do{switch(s.tag){case 3:return s.flags|=65536,e=r&-r,s.lanes|=e,e=gs(s.stateNode,i,e),W4(s,e),!1;case 1:if(t=s.type,l=s.stateNode,(s.flags&128)===0&&(typeof t.getDerivedStateFromError=="function"||l!==null&&typeof l.componentDidCatch=="function"&&(x1===null||!x1.has(l))))return s.flags|=65536,r&=-r,s.lanes|=r,r=Zr(r),Vr(r,e,s,i),W4(s,r),!1}s=s.return}while(s!==null);return!1}var Ss=Error(n(461)),J0=!1;function t2(e,t,s,i){t.child=e===null?$i(t,null,s,i):W1(t,e.child,s,i)}function Kr(e,t,s,i,r){s=s.render;var l=t.ref;if("ref"in i){var a={};for(var u in i)u!=="ref"&&(a[u]=i[u])}else a=i;return J1(t),i=ss(e,t,s,a,l,r),u=is(),e!==null&&!J0?(rs(e,t,r),s1(e,t,r)):(_0&&u&&Y4(t),t.flags|=1,t2(e,t,i,r),t.child)}function Jr(e,t,s,i,r){if(e===null){var l=s.type;return typeof l=="function"&&!j4(l)&&l.defaultProps===void 0&&s.compare===null?(t.tag=15,t.type=l,wr(e,t,l,i,r)):(e=r3(s.type,null,i,t,t.mode,r),e.ref=t.ref,e.return=t,t.child=e)}if(l=e.child,!Ns(e,r)){var a=l.memoizedProps;if(s=s.compare,s=s!==null?s:tt,s(a,i)&&e.ref===t.ref)return s1(e,t,r)}return t.flags|=1,e=W2(l,i),e.ref=t.ref,e.return=t,t.child=e}function wr(e,t,s,i,r){if(e!==null){var l=e.memoizedProps;if(tt(l,i)&&e.ref===t.ref)if(J0=!1,t.pendingProps=i=l,Ns(e,r))(e.flags&131072)!==0&&(J0=!0);else return t.lanes=e.lanes,s1(e,t,r)}return bs(e,t,s,i,r)}function $r(e,t,s,i){var r=i.children,l=e!==null?e.memoizedState:null;if(e===null&&t.stateNode===null&&(t.stateNode={_visibility:1,_pendingMarkers:null,_retryCache:null,_transitions:null}),i.mode==="hidden"){if((t.flags&128)!==0){if(l=l!==null?l.baseLanes|s:s,e!==null){for(i=t.child=e.child,r=0;i!==null;)r=r|i.lanes|i.childLanes,i=i.sibling;i=r&~l}else i=0,t.child=null;return kr(e,t,l,s,i)}if((s&536870912)!==0)t.memoizedState={baseLanes:0,cachePool:null},e!==null&&n3(t,l!==null?l.cachePool:null),l!==null?Fi(t,l):I4(),Ii(t);else return i=t.lanes=536870912,kr(e,t,l!==null?l.baseLanes|s:s,s,i)}else l!==null?(n3(t,l.cachePool),Fi(t,l),z1(),t.memoizedState=null):(e!==null&&n3(t,null),I4(),z1());return t2(e,t,r,s),t.child}function ht(e,t){return e!==null&&e.tag===22||t.stateNode!==null||(t.stateNode={_visibility:1,_pendingMarkers:null,_retryCache:null,_transitions:null}),t.sibling}function kr(e,t,s,i,r){var l=J4();return l=l===null?null:{parent:V0._currentValue,pool:l},t.memoizedState={baseLanes:s,cachePool:l},e!==null&&n3(t,null),I4(),Ii(t),e!==null&&ge(e,t,i,!0),t.childLanes=r,null}function M3(e,t){return t=A3({mode:t.mode,children:t.children},e.mode),t.ref=e.ref,e.child=t,t.return=e,t}function Wr(e,t,s){return W1(t,e.child,null,s),e=M3(t,t.pendingProps),e.flags|=2,b2(t),t.memoizedState=null,e}function Eu(e,t,s){var i=t.pendingProps,r=(t.flags&128)!==0;if(t.flags&=-129,e===null){if(_0){if(i.mode==="hidden")return e=M3(t,i),t.lanes=536870912,ht(null,e);if(es(t),(e=R0)?(e=n6(e,U2),e=e!==null&&e.data==="&"?e:null,e!==null&&(t.memoizedState={dehydrated:e,treeContext:f1!==null?{id:Q2,overflow:Z2}:null,retryLane:536870912,hydrationErrors:null},s=Ri(e),s.return=t,t.child=s,P0=t,R0=null)):e=null,e===null)throw y1(t);return t.lanes=536870912,null}return M3(t,i)}var l=e.memoizedState;if(l!==null){var a=l.dehydrated;if(es(t),r)if(t.flags&256)t.flags&=-257,t=Wr(e,t,s);else if(t.memoizedState!==null)t.child=e.child,t.flags|=128,t=null;else throw Error(n(558));else if(J0||ge(e,t,s,!1),r=(s&e.childLanes)!==0,J0||r){if(i=D0,i!==null&&(a=G5(i,s),a!==0&&a!==l.retryLane))throw l.retryLane=a,Q1(e,a),f2(i,e,a),Ss;H3(),t=Wr(e,t,s)}else e=l.treeContext,R0=j2(a.nextSibling),P0=t,_0=!0,h1=null,U2=!1,e!==null&&qi(t,e),t=M3(t,i),t.flags|=4096;return t}return e=W2(e.child,{mode:i.mode,children:i.children}),e.ref=t.ref,t.child=e,e.return=t,e}function E3(e,t){var s=t.ref;if(s===null)e!==null&&e.ref!==null&&(t.flags|=4194816);else{if(typeof s!="function"&&typeof s!="object")throw Error(n(284));(e===null||e.ref!==s)&&(t.flags|=4194816)}}function bs(e,t,s,i,r){return J1(t),s=ss(e,t,s,i,void 0,r),i=is(),e!==null&&!J0?(rs(e,t,r),s1(e,t,r)):(_0&&i&&Y4(t),t.flags|=1,t2(e,t,s,r),t.child)}function Fr(e,t,s,i,r,l){return J1(t),t.updateQueue=null,s=er(t,i,s,r),Pi(e),i=is(),e!==null&&!J0?(rs(e,t,l),s1(e,t,l)):(_0&&i&&Y4(t),t.flags|=1,t2(e,t,s,l),t.child)}function Ir(e,t,s,i,r){if(J1(t),t.stateNode===null){var l=he,a=s.contextType;typeof a=="object"&&a!==null&&(l=e2(a)),l=new s(i,l),t.memoizedState=l.state!==null&&l.state!==void 0?l.state:null,l.updater=vs,t.stateNode=l,l._reactInternals=t,l=t.stateNode,l.props=i,l.state=t.memoizedState,l.refs={},$4(t),a=s.contextType,l.context=typeof a=="object"&&a!==null?e2(a):he,l.state=t.memoizedState,a=s.getDerivedStateFromProps,typeof a=="function"&&(Ts(t,s,a,i),l.state=t.memoizedState),typeof s.getDerivedStateFromProps=="function"||typeof l.getSnapshotBeforeUpdate=="function"||typeof l.UNSAFE_componentWillMount!="function"&&typeof l.componentWillMount!="function"||(a=l.state,typeof l.componentWillMount=="function"&&l.componentWillMount(),typeof l.UNSAFE_componentWillMount=="function"&&l.UNSAFE_componentWillMount(),a!==l.state&&vs.enqueueReplaceState(l,l.state,null),ot(t,i,l,r),ct(),l.state=t.memoizedState),typeof l.componentDidMount=="function"&&(t.flags|=4194308),i=!0}else if(e===null){l=t.stateNode;var u=t.memoizedProps,c=I1(s,u);l.props=c;var y=l.context,A=s.contextType;a=he,typeof A=="object"&&A!==null&&(a=e2(A));var U=s.getDerivedStateFromProps;A=typeof U=="function"||typeof l.getSnapshotBeforeUpdate=="function",u=t.pendingProps!==u,A||typeof l.UNSAFE_componentWillReceiveProps!="function"&&typeof l.componentWillReceiveProps!="function"||(u||y!==a)&&Br(t,l,i,a),v1=!1;var g=t.memoizedState;l.state=g,ot(t,i,l,r),ct(),y=t.memoizedState,u||g!==y||v1?(typeof U=="function"&&(Ts(t,s,U,i),y=t.memoizedState),(c=v1||Yr(t,s,c,i,g,y,a))?(A||typeof l.UNSAFE_componentWillMount!="function"&&typeof l.componentWillMount!="function"||(typeof l.componentWillMount=="function"&&l.componentWillMount(),typeof l.UNSAFE_componentWillMount=="function"&&l.UNSAFE_componentWillMount()),typeof l.componentDidMount=="function"&&(t.flags|=4194308)):(typeof l.componentDidMount=="function"&&(t.flags|=4194308),t.memoizedProps=i,t.memoizedState=y),l.props=i,l.state=y,l.context=a,i=c):(typeof l.componentDidMount=="function"&&(t.flags|=4194308),i=!1)}else{l=t.stateNode,k4(e,t),a=t.memoizedProps,A=I1(s,a),l.props=A,U=t.pendingProps,g=l.context,y=s.contextType,c=he,typeof y=="object"&&y!==null&&(c=e2(y)),u=s.getDerivedStateFromProps,(y=typeof u=="function"||typeof l.getSnapshotBeforeUpdate=="function")||typeof l.UNSAFE_componentWillReceiveProps!="function"&&typeof l.componentWillReceiveProps!="function"||(a!==U||g!==c)&&Br(t,l,i,c),v1=!1,g=t.memoizedState,l.state=g,ot(t,i,l,r),ct();var b=t.memoizedState;a!==U||g!==b||v1||e!==null&&e.dependencies!==null&&a3(e.dependencies)?(typeof u=="function"&&(Ts(t,s,u,i),b=t.memoizedState),(A=v1||Yr(t,s,A,i,g,b,c)||e!==null&&e.dependencies!==null&&a3(e.dependencies))?(y||typeof l.UNSAFE_componentWillUpdate!="function"&&typeof l.componentWillUpdate!="function"||(typeof l.componentWillUpdate=="function"&&l.componentWillUpdate(i,b,c),typeof l.UNSAFE_componentWillUpdate=="function"&&l.UNSAFE_componentWillUpdate(i,b,c)),typeof l.componentDidUpdate=="function"&&(t.flags|=4),typeof l.getSnapshotBeforeUpdate=="function"&&(t.flags|=1024)):(typeof l.componentDidUpdate!="function"||a===e.memoizedProps&&g===e.memoizedState||(t.flags|=4),typeof l.getSnapshotBeforeUpdate!="function"||a===e.memoizedProps&&g===e.memoizedState||(t.flags|=1024),t.memoizedProps=i,t.memoizedState=b),l.props=i,l.state=b,l.context=c,i=A):(typeof l.componentDidUpdate!="function"||a===e.memoizedProps&&g===e.memoizedState||(t.flags|=4),typeof l.getSnapshotBeforeUpdate!="function"||a===e.memoizedProps&&g===e.memoizedState||(t.flags|=1024),i=!1)}return l=i,E3(e,t),i=(t.flags&128)!==0,l||i?(l=t.stateNode,s=i&&typeof s.getDerivedStateFromError!="function"?null:l.render(),t.flags|=1,e!==null&&i?(t.child=W1(t,e.child,null,r),t.child=W1(t,null,s,r)):t2(e,t,s,r),t.memoizedState=l.state,e=t.child):e=s1(e,t,r),e}function Pr(e,t,s,i){return V1(),t.flags|=256,t2(e,t,s,i),t.child}var zs={dehydrated:null,treeContext:null,retryLane:0,hydrationErrors:null};function Ms(e){return{baseLanes:e,cachePool:Qi()}}function Es(e,t,s){return e=e!==null?e.childLanes&~s:0,t&&(e|=M2),e}function el(e,t,s){var i=t.pendingProps,r=!1,l=(t.flags&128)!==0,a;if((a=l)||(a=e!==null&&e.memoizedState===null?!1:(X0.current&2)!==0),a&&(r=!0,t.flags&=-129),a=(t.flags&32)!==0,t.flags&=-33,e===null){if(_0){if(r?b1(t):z1(),(e=R0)?(e=n6(e,U2),e=e!==null&&e.data!=="&"?e:null,e!==null&&(t.memoizedState={dehydrated:e,treeContext:f1!==null?{id:Q2,overflow:Z2}:null,retryLane:536870912,hydrationErrors:null},s=Ri(e),s.return=t,t.child=s,P0=t,R0=null)):e=null,e===null)throw y1(t);return u5(e)?t.lanes=32:t.lanes=536870912,null}var u=i.children;return i=i.fallback,r?(z1(),r=t.mode,u=A3({mode:"hidden",children:u},r),i=Z1(i,r,s,null),u.return=t,i.return=t,u.sibling=i,t.child=u,i=t.child,i.memoizedState=Ms(s),i.childLanes=Es(e,a,s),t.memoizedState=zs,ht(null,i)):(b1(t),As(t,u))}var c=e.memoizedState;if(c!==null&&(u=c.dehydrated,u!==null)){if(l)t.flags&256?(b1(t),t.flags&=-257,t=xs(e,t,s)):t.memoizedState!==null?(z1(),t.child=e.child,t.flags|=128,t=null):(z1(),u=i.fallback,r=t.mode,i=A3({mode:"visible",children:i.children},r),u=Z1(u,r,s,null),u.flags|=2,i.return=t,u.return=t,i.sibling=u,t.child=i,W1(t,e.child,null,s),i=t.child,i.memoizedState=Ms(s),i.childLanes=Es(e,a,s),t.memoizedState=zs,t=ht(null,i));else if(b1(t),u5(u)){if(a=u.nextSibling&&u.nextSibling.dataset,a)var y=a.dgst;a=y,i=Error(n(419)),i.stack="",i.digest=a,rt({value:i,source:null,stack:null}),t=xs(e,t,s)}else if(J0||ge(e,t,s,!1),a=(s&e.childLanes)!==0,J0||a){if(a=D0,a!==null&&(i=G5(a,s),i!==0&&i!==c.retryLane))throw c.retryLane=i,Q1(e,i),f2(a,e,i),Ss;a5(u)||H3(),t=xs(e,t,s)}else a5(u)?(t.flags|=192,t.child=e.child,t=null):(e=c.treeContext,R0=j2(u.nextSibling),P0=t,_0=!0,h1=null,U2=!1,e!==null&&qi(t,e),t=As(t,i.children),t.flags|=4096);return t}return r?(z1(),u=i.fallback,r=t.mode,c=e.child,y=c.sibling,i=W2(c,{mode:"hidden",children:i.children}),i.subtreeFlags=c.subtreeFlags&65011712,y!==null?u=W2(y,u):(u=Z1(u,r,s,null),u.flags|=2),u.return=t,i.return=t,i.sibling=u,t.child=i,ht(null,i),i=t.child,u=e.child.memoizedState,u===null?u=Ms(s):(r=u.cachePool,r!==null?(c=V0._currentValue,r=r.parent!==c?{parent:c,pool:c}:r):r=Qi(),u={baseLanes:u.baseLanes|s,cachePool:r}),i.memoizedState=u,i.childLanes=Es(e,a,s),t.memoizedState=zs,ht(e.child,i)):(b1(t),s=e.child,e=s.sibling,s=W2(s,{mode:"visible",children:i.children}),s.return=t,s.sibling=null,e!==null&&(a=t.deletions,a===null?(t.deletions=[e],t.flags|=16):a.push(e)),t.child=s,t.memoizedState=null,s)}function As(e,t){return t=A3({mode:"visible",children:t},e.mode),t.return=e,e.child=t}function A3(e,t){return e=g2(22,e,null,t),e.lanes=0,e}function xs(e,t,s){return W1(t,e.child,null,s),e=As(t,t.pendingProps.children),e.flags|=2,t.memoizedState=null,e}function tl(e,t,s){e.lanes|=t;var i=e.alternate;i!==null&&(i.lanes|=t),Q4(e.return,t,s)}function Os(e,t,s,i,r,l){var a=e.memoizedState;a===null?e.memoizedState={isBackwards:t,rendering:null,renderingStartTime:0,last:i,tail:s,tailMode:r,treeForkCount:l}:(a.isBackwards=t,a.rendering=null,a.renderingStartTime=0,a.last=i,a.tail=s,a.tailMode=r,a.treeForkCount=l)}function sl(e,t,s){var i=t.pendingProps,r=i.revealOrder,l=i.tail;i=i.children;var a=X0.current,u=(a&2)!==0;if(u?(a=a&1|2,t.flags|=128):a&=1,v(X0,a),t2(e,t,i,s),i=_0?it:0,!u&&e!==null&&(e.flags&128)!==0)e:for(e=t.child;e!==null;){if(e.tag===13)e.memoizedState!==null&&tl(e,s,t);else if(e.tag===19)tl(e,s,t);else if(e.child!==null){e.child.return=e,e=e.child;continue}if(e===t)break e;for(;e.sibling===null;){if(e.return===null||e.return===t)break e;e=e.return}e.sibling.return=e.return,e=e.sibling}switch(r){case"forwards":for(s=t.child,r=null;s!==null;)e=s.alternate,e!==null&&_3(e)===null&&(r=s),s=s.sibling;s=r,s===null?(r=t.child,t.child=null):(r=s.sibling,s.sibling=null),Os(t,!1,r,s,l,i);break;case"backwards":case"unstable_legacy-backwards":for(s=null,r=t.child,t.child=null;r!==null;){if(e=r.alternate,e!==null&&_3(e)===null){t.child=r;break}e=r.sibling,r.sibling=s,s=r,r=e}Os(t,!0,s,null,l,i);break;case"together":Os(t,!1,null,null,void 0,i);break;default:t.memoizedState=null}return t.child}function s1(e,t,s){if(e!==null&&(t.dependencies=e.dependencies),A1|=t.lanes,(s&t.childLanes)===0)if(e!==null){if(ge(e,t,s,!1),(s&t.childLanes)===0)return null}else return null;if(e!==null&&t.child!==e.child)throw Error(n(153));if(t.child!==null){for(e=t.child,s=W2(e,e.pendingProps),t.child=s,s.return=t;e.sibling!==null;)e=e.sibling,s=s.sibling=W2(e,e.pendingProps),s.return=t;s.sibling=null}return t.child}function Ns(e,t){return(e.lanes&t)!==0?!0:(e=e.dependencies,!!(e!==null&&a3(e)))}function Au(e,t,s){switch(t.tag){case 3:G(t,t.stateNode.containerInfo),T1(t,V0,e.memoizedState.cache),V1();break;case 27:case 5:F(t);break;case 4:G(t,t.stateNode.containerInfo);break;case 10:T1(t,t.type,t.memoizedProps.value);break;case 31:if(t.memoizedState!==null)return t.flags|=128,es(t),null;break;case 13:var i=t.memoizedState;if(i!==null)return i.dehydrated!==null?(b1(t),t.flags|=128,null):(s&t.child.childLanes)!==0?el(e,t,s):(b1(t),e=s1(e,t,s),e!==null?e.sibling:null);b1(t);break;case 19:var r=(e.flags&128)!==0;if(i=(s&t.childLanes)!==0,i||(ge(e,t,s,!1),i=(s&t.childLanes)!==0),r){if(i)return sl(e,t,s);t.flags|=128}if(r=t.memoizedState,r!==null&&(r.rendering=null,r.tail=null,r.lastEffect=null),v(X0,X0.current),i)break;return null;case 22:return t.lanes=0,$r(e,t,s,t.pendingProps);case 24:T1(t,V0,e.memoizedState.cache)}return s1(e,t,s)}function il(e,t,s){if(e!==null)if(e.memoizedProps!==t.pendingProps)J0=!0;else{if(!Ns(e,s)&&(t.flags&128)===0)return J0=!1,Au(e,t,s);J0=(e.flags&131072)!==0}else J0=!1,_0&&(t.flags&1048576)!==0&&Hi(t,it,t.index);switch(t.lanes=0,t.tag){case 16:e:{var i=t.pendingProps;if(e=$1(t.elementType),t.type=e,typeof e=="function")j4(e)?(i=I1(e,i),t.tag=1,t=Ir(null,t,e,i,s)):(t.tag=0,t=bs(null,t,e,i,s));else{if(e!=null){var r=e.$$typeof;if(r===P){t.tag=11,t=Kr(null,t,e,i,s);break e}else if(r===W){t.tag=14,t=Jr(null,t,e,i,s);break e}}throw t=G0(e)||e,Error(n(306,t,""))}}return t;case 0:return bs(e,t,t.type,t.pendingProps,s);case 1:return i=t.type,r=I1(i,t.pendingProps),Ir(e,t,i,r,s);case 3:e:{if(G(t,t.stateNode.containerInfo),e===null)throw Error(n(387));i=t.pendingProps;var l=t.memoizedState;r=l.element,k4(e,t),ot(t,i,null,s);var a=t.memoizedState;if(i=a.cache,T1(t,V0,i),i!==l.cache&&Z4(t,[V0],s,!0),ct(),i=a.element,l.isDehydrated)if(l={element:i,isDehydrated:!1,cache:a.cache},t.updateQueue.baseState=l,t.memoizedState=l,t.flags&256){t=Pr(e,t,i,s);break e}else if(i!==r){r=N2(Error(n(424)),t),rt(r),t=Pr(e,t,i,s);break e}else{switch(e=t.stateNode.containerInfo,e.nodeType){case 9:e=e.body;break;default:e=e.nodeName==="HTML"?e.ownerDocument.body:e}for(R0=j2(e.firstChild),P0=t,_0=!0,h1=null,U2=!0,s=$i(t,null,i,s),t.child=s;s;)s.flags=s.flags&-3|4096,s=s.sibling}else{if(V1(),i===r){t=s1(e,t,s);break e}t2(e,t,i,s)}t=t.child}return t;case 26:return E3(e,t),e===null?(s=_6(t.type,null,t.pendingProps,null))?t.memoizedState=s:_0||(s=t.type,e=t.pendingProps,i=Q3(H.current).createElement(s),i[I0]=t,i[d2]=e,s2(i,s,e),k0(i),t.stateNode=i):t.memoizedState=_6(t.type,e.memoizedProps,t.pendingProps,e.memoizedState),null;case 27:return F(t),e===null&&_0&&(i=t.stateNode=o6(t.type,t.pendingProps,H.current),P0=t,U2=!0,r=R0,D1(t.type)?(n5=r,R0=j2(i.firstChild)):R0=r),t2(e,t,t.pendingProps.children,s),E3(e,t),e===null&&(t.flags|=4194304),t.child;case 5:return e===null&&_0&&((r=i=R0)&&(i=sn(i,t.type,t.pendingProps,U2),i!==null?(t.stateNode=i,P0=t,R0=j2(i.firstChild),U2=!1,r=!0):r=!1),r||y1(t)),F(t),r=t.type,l=t.pendingProps,a=e!==null?e.memoizedProps:null,i=l.children,i5(r,l)?i=null:a!==null&&i5(r,a)&&(t.flags|=32),t.memoizedState!==null&&(r=ss(e,t,yu,null,null,s),Dt._currentValue=r),E3(e,t),t2(e,t,i,s),t.child;case 6:return e===null&&_0&&((e=s=R0)&&(s=rn(s,t.pendingProps,U2),s!==null?(t.stateNode=s,P0=t,R0=null,e=!0):e=!1),e||y1(t)),null;case 13:return el(e,t,s);case 4:return G(t,t.stateNode.containerInfo),i=t.pendingProps,e===null?t.child=W1(t,null,i,s):t2(e,t,i,s),t.child;case 11:return Kr(e,t,t.type,t.pendingProps,s);case 7:return t2(e,t,t.pendingProps,s),t.child;case 8:return t2(e,t,t.pendingProps.children,s),t.child;case 12:return t2(e,t,t.pendingProps.children,s),t.child;case 10:return i=t.pendingProps,T1(t,t.type,i.value),t2(e,t,i.children,s),t.child;case 9:return r=t.type._context,i=t.pendingProps.children,J1(t),r=e2(r),i=i(r),t.flags|=1,t2(e,t,i,s),t.child;case 14:return Jr(e,t,t.type,t.pendingProps,s);case 15:return wr(e,t,t.type,t.pendingProps,s);case 19:return sl(e,t,s);case 31:return Eu(e,t,s);case 22:return $r(e,t,s,t.pendingProps);case 24:return J1(t),i=e2(V0),e===null?(r=J4(),r===null&&(r=D0,l=V4(),r.pooledCache=l,l.refCount++,l!==null&&(r.pooledCacheLanes|=s),r=l),t.memoizedState={parent:i,cache:r},$4(t),T1(t,V0,r)):((e.lanes&s)!==0&&(k4(e,t),ot(t,null,null,s),ct()),r=e.memoizedState,l=t.memoizedState,r.parent!==i?(r={parent:i,cache:i},t.memoizedState=r,t.lanes===0&&(t.memoizedState=t.updateQueue.baseState=r),T1(t,V0,i)):(i=l.cache,T1(t,V0,i),i!==r.cache&&Z4(t,[V0],s,!0))),t2(e,t,t.pendingProps.children,s),t.child;case 29:throw t.pendingProps}throw Error(n(156,t.tag))}function i1(e){e.flags|=4}function Cs(e,t,s,i,r){if((t=(e.mode&32)!==0)&&(t=!1),t){if(e.flags|=16777216,(r&335544128)===r)if(e.stateNode.complete)e.flags|=8192;else if(Cl())e.flags|=8192;else throw k1=c3,w4}else e.flags&=-16777217}function rl(e,t){if(t.type!=="stylesheet"||(t.state.loading&4)!==0)e.flags&=-16777217;else if(e.flags|=16777216,!v6(t))if(Cl())e.flags|=8192;else throw k1=c3,w4}function x3(e,t){t!==null&&(e.flags|=4),e.flags&16384&&(t=e.tag!==22?Y5():536870912,e.lanes|=t,Ue|=t)}function yt(e,t){if(!_0)switch(e.tailMode){case"hidden":t=e.tail;for(var s=null;t!==null;)t.alternate!==null&&(s=t),t=t.sibling;s===null?e.tail=null:s.sibling=null;break;case"collapsed":s=e.tail;for(var i=null;s!==null;)s.alternate!==null&&(i=s),s=s.sibling;i===null?t||e.tail===null?e.tail=null:e.tail.sibling=null:i.sibling=null}}function j0(e){var t=e.alternate!==null&&e.alternate.child===e.child,s=0,i=0;if(t)for(var r=e.child;r!==null;)s|=r.lanes|r.childLanes,i|=r.subtreeFlags&65011712,i|=r.flags&65011712,r.return=e,r=r.sibling;else for(r=e.child;r!==null;)s|=r.lanes|r.childLanes,i|=r.subtreeFlags,i|=r.flags,r.return=e,r=r.sibling;return e.subtreeFlags|=i,e.childLanes=s,t}function xu(e,t,s){var i=t.pendingProps;switch(B4(t),t.tag){case 16:case 15:case 0:case 11:case 7:case 8:case 12:case 9:case 14:return j0(t),null;case 1:return j0(t),null;case 3:return s=t.stateNode,i=null,e!==null&&(i=e.memoizedState.cache),t.memoizedState.cache!==i&&(t.flags|=2048),P2(V0),Z(),s.pendingContext&&(s.context=s.pendingContext,s.pendingContext=null),(e===null||e.child===null)&&(ve(t)?i1(t):e===null||e.memoizedState.isDehydrated&&(t.flags&256)===0||(t.flags|=1024,G4())),j0(t),null;case 26:var r=t.type,l=t.memoizedState;return e===null?(i1(t),l!==null?(j0(t),rl(t,l)):(j0(t),Cs(t,r,null,i,s))):l?l!==e.memoizedState?(i1(t),j0(t),rl(t,l)):(j0(t),t.flags&=-16777217):(e=e.memoizedProps,e!==i&&i1(t),j0(t),Cs(t,r,e,i,s)),null;case 27:if(f0(t),s=H.current,r=t.type,e!==null&&t.stateNode!=null)e.memoizedProps!==i&&i1(t);else{if(!i){if(t.stateNode===null)throw Error(n(166));return j0(t),null}e=O.current,ve(t)?Yi(t):(e=o6(r,i,s),t.stateNode=e,i1(t))}return j0(t),null;case 5:if(f0(t),r=t.type,e!==null&&t.stateNode!=null)e.memoizedProps!==i&&i1(t);else{if(!i){if(t.stateNode===null)throw Error(n(166));return j0(t),null}if(l=O.current,ve(t))Yi(t);else{var a=Q3(H.current);switch(l){case 1:l=a.createElementNS("http://www.w3.org/2000/svg",r);break;case 2:l=a.createElementNS("http://www.w3.org/1998/Math/MathML",r);break;default:switch(r){case"svg":l=a.createElementNS("http://www.w3.org/2000/svg",r);break;case"math":l=a.createElementNS("http://www.w3.org/1998/Math/MathML",r);break;case"script":l=a.createElement("div"),l.innerHTML="<script><\/script>",l=l.removeChild(l.firstChild);break;case"select":l=typeof i.is=="string"?a.createElement("select",{is:i.is}):a.createElement("select"),i.multiple?l.multiple=!0:i.size&&(l.size=i.size);break;default:l=typeof i.is=="string"?a.createElement(r,{is:i.is}):a.createElement(r)}}l[I0]=t,l[d2]=i;e:for(a=t.child;a!==null;){if(a.tag===5||a.tag===6)l.appendChild(a.stateNode);else if(a.tag!==4&&a.tag!==27&&a.child!==null){a.child.return=a,a=a.child;continue}if(a===t)break e;for(;a.sibling===null;){if(a.return===null||a.return===t)break e;a=a.return}a.sibling.return=a.return,a=a.sibling}t.stateNode=l;e:switch(s2(l,r,i),r){case"button":case"input":case"select":case"textarea":i=!!i.autoFocus;break e;case"img":i=!0;break e;default:i=!1}i&&i1(t)}}return j0(t),Cs(t,t.type,e===null?null:e.memoizedProps,t.pendingProps,s),null;case 6:if(e&&t.stateNode!=null)e.memoizedProps!==i&&i1(t);else{if(typeof i!="string"&&t.stateNode===null)throw Error(n(166));if(e=H.current,ve(t)){if(e=t.stateNode,s=t.memoizedProps,i=null,r=P0,r!==null)switch(r.tag){case 27:case 5:i=r.memoizedProps}e[I0]=t,e=!!(e.nodeValue===s||i!==null&&i.suppressHydrationWarning===!0||e6(e.nodeValue,s)),e||y1(t,!0)}else e=Q3(e).createTextNode(i),e[I0]=t,t.stateNode=e}return j0(t),null;case 31:if(s=t.memoizedState,e===null||e.memoizedState!==null){if(i=ve(t),s!==null){if(e===null){if(!i)throw Error(n(318));if(e=t.memoizedState,e=e!==null?e.dehydrated:null,!e)throw Error(n(557));e[I0]=t}else V1(),(t.flags&128)===0&&(t.memoizedState=null),t.flags|=4;j0(t),e=!1}else s=G4(),e!==null&&e.memoizedState!==null&&(e.memoizedState.hydrationErrors=s),e=!0;if(!e)return t.flags&256?(b2(t),t):(b2(t),null);if((t.flags&128)!==0)throw Error(n(558))}return j0(t),null;case 13:if(i=t.memoizedState,e===null||e.memoizedState!==null&&e.memoizedState.dehydrated!==null){if(r=ve(t),i!==null&&i.dehydrated!==null){if(e===null){if(!r)throw Error(n(318));if(r=t.memoizedState,r=r!==null?r.dehydrated:null,!r)throw Error(n(317));r[I0]=t}else V1(),(t.flags&128)===0&&(t.memoizedState=null),t.flags|=4;j0(t),r=!1}else r=G4(),e!==null&&e.memoizedState!==null&&(e.memoizedState.hydrationErrors=r),r=!0;if(!r)return t.flags&256?(b2(t),t):(b2(t),null)}return b2(t),(t.flags&128)!==0?(t.lanes=s,t):(s=i!==null,e=e!==null&&e.memoizedState!==null,s&&(i=t.child,r=null,i.alternate!==null&&i.alternate.memoizedState!==null&&i.alternate.memoizedState.cachePool!==null&&(r=i.alternate.memoizedState.cachePool.pool),l=null,i.memoizedState!==null&&i.memoizedState.cachePool!==null&&(l=i.memoizedState.cachePool.pool),l!==r&&(i.flags|=2048)),s!==e&&s&&(t.child.flags|=8192),x3(t,t.updateQueue),j0(t),null);case 4:return Z(),e===null&&Is(t.stateNode.containerInfo),j0(t),null;case 10:return P2(t.type),j0(t),null;case 19:if(D(X0),i=t.memoizedState,i===null)return j0(t),null;if(r=(t.flags&128)!==0,l=i.rendering,l===null)if(r)yt(i,!1);else{if(L0!==0||e!==null&&(e.flags&128)!==0)for(e=t.child;e!==null;){if(l=_3(e),l!==null){for(t.flags|=128,yt(i,!1),e=l.updateQueue,t.updateQueue=e,x3(t,e),t.subtreeFlags=0,e=s,s=t.child;s!==null;)Ui(s,e),s=s.sibling;return v(X0,X0.current&1|2),_0&&F2(t,i.treeForkCount),t.child}e=e.sibling}i.tail!==null&&h2()>U3&&(t.flags|=128,r=!0,yt(i,!1),t.lanes=4194304)}else{if(!r)if(e=_3(l),e!==null){if(t.flags|=128,r=!0,e=e.updateQueue,t.updateQueue=e,x3(t,e),yt(i,!0),i.tail===null&&i.tailMode==="hidden"&&!l.alternate&&!_0)return j0(t),null}else 2*h2()-i.renderingStartTime>U3&&s!==536870912&&(t.flags|=128,r=!0,yt(i,!1),t.lanes=4194304);i.isBackwards?(l.sibling=t.child,t.child=l):(e=i.last,e!==null?e.sibling=l:t.child=l,i.last=l)}return i.tail!==null?(e=i.tail,i.rendering=e,i.tail=e.sibling,i.renderingStartTime=h2(),e.sibling=null,s=X0.current,v(X0,r?s&1|2:s&1),_0&&F2(t,i.treeForkCount),e):(j0(t),null);case 22:case 23:return b2(t),P4(),i=t.memoizedState!==null,e!==null?e.memoizedState!==null!==i&&(t.flags|=8192):i&&(t.flags|=8192),i?(s&536870912)!==0&&(t.flags&128)===0&&(j0(t),t.subtreeFlags&6&&(t.flags|=8192)):j0(t),s=t.updateQueue,s!==null&&x3(t,s.retryQueue),s=null,e!==null&&e.memoizedState!==null&&e.memoizedState.cachePool!==null&&(s=e.memoizedState.cachePool.pool),i=null,t.memoizedState!==null&&t.memoizedState.cachePool!==null&&(i=t.memoizedState.cachePool.pool),i!==s&&(t.flags|=2048),e!==null&&D(w1),null;case 24:return s=null,e!==null&&(s=e.memoizedState.cache),t.memoizedState.cache!==s&&(t.flags|=2048),P2(V0),j0(t),null;case 25:return null;case 30:return null}throw Error(n(156,t.tag))}function Ou(e,t){switch(B4(t),t.tag){case 1:return e=t.flags,e&65536?(t.flags=e&-65537|128,t):null;case 3:return P2(V0),Z(),e=t.flags,(e&65536)!==0&&(e&128)===0?(t.flags=e&-65537|128,t):null;case 26:case 27:case 5:return f0(t),null;case 31:if(t.memoizedState!==null){if(b2(t),t.alternate===null)throw Error(n(340));V1()}return e=t.flags,e&65536?(t.flags=e&-65537|128,t):null;case 13:if(b2(t),e=t.memoizedState,e!==null&&e.dehydrated!==null){if(t.alternate===null)throw Error(n(340));V1()}return e=t.flags,e&65536?(t.flags=e&-65537|128,t):null;case 19:return D(X0),null;case 4:return Z(),null;case 10:return P2(t.type),null;case 22:case 23:return b2(t),P4(),e!==null&&D(w1),e=t.flags,e&65536?(t.flags=e&-65537|128,t):null;case 24:return P2(V0),null;case 25:return null;default:return null}}function ll(e,t){switch(B4(t),t.tag){case 3:P2(V0),Z();break;case 26:case 27:case 5:f0(t);break;case 4:Z();break;case 31:t.memoizedState!==null&&b2(t);break;case 13:b2(t);break;case 19:D(X0);break;case 10:P2(t.type);break;case 22:case 23:b2(t),P4(),e!==null&&D(w1);break;case 24:P2(V0)}}function Tt(e,t){try{var s=t.updateQueue,i=s!==null?s.lastEffect:null;if(i!==null){var r=i.next;s=r;do{if((s.tag&e)===e){i=void 0;var l=s.create,a=s.inst;i=l(),a.destroy=i}s=s.next}while(s!==r)}}catch(u){M0(t,t.return,u)}}function M1(e,t,s){try{var i=t.updateQueue,r=i!==null?i.lastEffect:null;if(r!==null){var l=r.next;i=l;do{if((i.tag&e)===e){var a=i.inst,u=a.destroy;if(u!==void 0){a.destroy=void 0,r=t;var c=s,y=u;try{y()}catch(A){M0(r,c,A)}}}i=i.next}while(i!==l)}}catch(A){M0(t,t.return,A)}}function al(e){var t=e.updateQueue;if(t!==null){var s=e.stateNode;try{Wi(t,s)}catch(i){M0(e,e.return,i)}}}function ul(e,t,s){s.props=I1(e.type,e.memoizedProps),s.state=e.memoizedState;try{s.componentWillUnmount()}catch(i){M0(e,t,i)}}function vt(e,t){try{var s=e.ref;if(s!==null){switch(e.tag){case 26:case 27:case 5:var i=e.stateNode;break;case 30:i=e.stateNode;break;default:i=e.stateNode}typeof s=="function"?e.refCleanup=s(i):s.current=i}}catch(r){M0(e,t,r)}}function V2(e,t){var s=e.ref,i=e.refCleanup;if(s!==null)if(typeof i=="function")try{i()}catch(r){M0(e,t,r)}finally{e.refCleanup=null,e=e.alternate,e!=null&&(e.refCleanup=null)}else if(typeof s=="function")try{s(null)}catch(r){M0(e,t,r)}else s.current=null}function nl(e){var t=e.type,s=e.memoizedProps,i=e.stateNode;try{e:switch(t){case"button":case"input":case"select":case"textarea":s.autoFocus&&i.focus();break e;case"img":s.src?i.src=s.src:s.srcSet&&(i.srcset=s.srcSet)}}catch(r){M0(e,e.return,r)}}function Ds(e,t,s){try{var i=e.stateNode;Wu(i,e.type,s,t),i[d2]=t}catch(r){M0(e,e.return,r)}}function dl(e){return e.tag===5||e.tag===3||e.tag===26||e.tag===27&&D1(e.type)||e.tag===4}function Us(e){e:for(;;){for(;e.sibling===null;){if(e.return===null||dl(e.return))return null;e=e.return}for(e.sibling.return=e.return,e=e.sibling;e.tag!==5&&e.tag!==6&&e.tag!==18;){if(e.tag===27&&D1(e.type)||e.flags&2||e.child===null||e.tag===4)continue e;e.child.return=e,e=e.child}if(!(e.flags&2))return e.stateNode}}function Rs(e,t,s){var i=e.tag;if(i===5||i===6)e=e.stateNode,t?(s.nodeType===9?s.body:s.nodeName==="HTML"?s.ownerDocument.body:s).insertBefore(e,t):(t=s.nodeType===9?s.body:s.nodeName==="HTML"?s.ownerDocument.body:s,t.appendChild(e),s=s._reactRootContainer,s!=null||t.onclick!==null||(t.onclick=$2));else if(i!==4&&(i===27&&D1(e.type)&&(s=e.stateNode,t=null),e=e.child,e!==null))for(Rs(e,t,s),e=e.sibling;e!==null;)Rs(e,t,s),e=e.sibling}function O3(e,t,s){var i=e.tag;if(i===5||i===6)e=e.stateNode,t?s.insertBefore(e,t):s.appendChild(e);else if(i!==4&&(i===27&&D1(e.type)&&(s=e.stateNode),e=e.child,e!==null))for(O3(e,t,s),e=e.sibling;e!==null;)O3(e,t,s),e=e.sibling}function cl(e){var t=e.stateNode,s=e.memoizedProps;try{for(var i=e.type,r=t.attributes;r.length;)t.removeAttributeNode(r[0]);s2(t,i,s),t[I0]=e,t[d2]=s}catch(l){M0(e,e.return,l)}}var r1=!1,w0=!1,js=!1,ol=typeof WeakSet=="function"?WeakSet:Set,W0=null;function Nu(e,t){if(e=e.containerInfo,t5=k3,e=zi(e),x4(e)){if("selectionStart"in e)var s={start:e.selectionStart,end:e.selectionEnd};else e:{s=(s=e.ownerDocument)&&s.defaultView||window;var i=s.getSelection&&s.getSelection();if(i&&i.rangeCount!==0){s=i.anchorNode;var r=i.anchorOffset,l=i.focusNode;i=i.focusOffset;try{s.nodeType,l.nodeType}catch{s=null;break e}var a=0,u=-1,c=-1,y=0,A=0,U=e,g=null;t:for(;;){for(var b;U!==s||r!==0&&U.nodeType!==3||(u=a+r),U!==l||i!==0&&U.nodeType!==3||(c=a+i),U.nodeType===3&&(a+=U.nodeValue.length),(b=U.firstChild)!==null;)g=U,U=b;for(;;){if(U===e)break t;if(g===s&&++y===r&&(u=a),g===l&&++A===i&&(c=a),(b=U.nextSibling)!==null)break;U=g,g=U.parentNode}U=b}s=u===-1||c===-1?null:{start:u,end:c}}else s=null}s=s||{start:0,end:0}}else s=null;for(s5={focusedElem:e,selectionRange:s},k3=!1,W0=t;W0!==null;)if(t=W0,e=t.child,(t.subtreeFlags&1028)!==0&&e!==null)e.return=t,W0=e;else for(;W0!==null;){switch(t=W0,l=t.alternate,e=t.flags,t.tag){case 0:if((e&4)!==0&&(e=t.updateQueue,e=e!==null?e.events:null,e!==null))for(s=0;s<e.length;s++)r=e[s],r.ref.impl=r.nextImpl;break;case 11:case 15:break;case 1:if((e&1024)!==0&&l!==null){e=void 0,s=t,r=l.memoizedProps,l=l.memoizedState,i=s.stateNode;try{var Q=I1(s.type,r);e=i.getSnapshotBeforeUpdate(Q,l),i.__reactInternalSnapshotBeforeUpdate=e}catch($){M0(s,s.return,$)}}break;case 3:if((e&1024)!==0){if(e=t.stateNode.containerInfo,s=e.nodeType,s===9)l5(e);else if(s===1)switch(e.nodeName){case"HEAD":case"HTML":case"BODY":l5(e);break;default:e.textContent=""}}break;case 5:case 26:case 27:case 6:case 4:case 17:break;default:if((e&1024)!==0)throw Error(n(163))}if(e=t.sibling,e!==null){e.return=t.return,W0=e;break}W0=t.return}}function ml(e,t,s){var i=s.flags;switch(s.tag){case 0:case 11:case 15:a1(e,s),i&4&&Tt(5,s);break;case 1:if(a1(e,s),i&4)if(e=s.stateNode,t===null)try{e.componentDidMount()}catch(a){M0(s,s.return,a)}else{var r=I1(s.type,t.memoizedProps);t=t.memoizedState;try{e.componentDidUpdate(r,t,e.__reactInternalSnapshotBeforeUpdate)}catch(a){M0(s,s.return,a)}}i&64&&al(s),i&512&&vt(s,s.return);break;case 3:if(a1(e,s),i&64&&(e=s.updateQueue,e!==null)){if(t=null,s.child!==null)switch(s.child.tag){case 27:case 5:t=s.child.stateNode;break;case 1:t=s.child.stateNode}try{Wi(e,t)}catch(a){M0(s,s.return,a)}}break;case 27:t===null&&i&4&&cl(s);case 26:case 5:a1(e,s),t===null&&i&4&&nl(s),i&512&&vt(s,s.return);break;case 12:a1(e,s);break;case 31:a1(e,s),i&4&&fl(e,s);break;case 13:a1(e,s),i&4&&hl(e,s),i&64&&(e=s.memoizedState,e!==null&&(e=e.dehydrated,e!==null&&(s=Bu.bind(null,s),ln(e,s))));break;case 22:if(i=s.memoizedState!==null||r1,!i){t=t!==null&&t.memoizedState!==null||w0,r=r1;var l=w0;r1=i,(w0=t)&&!l?u1(e,s,(s.subtreeFlags&8772)!==0):a1(e,s),r1=r,w0=l}break;case 30:break;default:a1(e,s)}}function pl(e){var t=e.alternate;t!==null&&(e.alternate=null,pl(t)),e.child=null,e.deletions=null,e.sibling=null,e.tag===5&&(t=e.stateNode,t!==null&&c4(t)),e.stateNode=null,e.return=null,e.dependencies=null,e.memoizedProps=null,e.memoizedState=null,e.pendingProps=null,e.stateNode=null,e.updateQueue=null}var q0=null,o2=!1;function l1(e,t,s){for(s=s.child;s!==null;)_l(e,t,s),s=s.sibling}function _l(e,t,s){if(y2&&typeof y2.onCommitFiberUnmount=="function")try{y2.onCommitFiberUnmount(Ze,s)}catch{}switch(s.tag){case 26:w0||V2(s,t),l1(e,t,s),s.memoizedState?s.memoizedState.count--:s.stateNode&&(s=s.stateNode,s.parentNode.removeChild(s));break;case 27:w0||V2(s,t);var i=q0,r=o2;D1(s.type)&&(q0=s.stateNode,o2=!1),l1(e,t,s),Ot(s.stateNode),q0=i,o2=r;break;case 5:w0||V2(s,t);case 6:if(i=q0,r=o2,q0=null,l1(e,t,s),q0=i,o2=r,q0!==null)if(o2)try{(q0.nodeType===9?q0.body:q0.nodeName==="HTML"?q0.ownerDocument.body:q0).removeChild(s.stateNode)}catch(l){M0(s,t,l)}else try{q0.removeChild(s.stateNode)}catch(l){M0(s,t,l)}break;case 18:q0!==null&&(o2?(e=q0,a6(e.nodeType===9?e.body:e.nodeName==="HTML"?e.ownerDocument.body:e,s.stateNode),Ge(e)):a6(q0,s.stateNode));break;case 4:i=q0,r=o2,q0=s.stateNode.containerInfo,o2=!0,l1(e,t,s),q0=i,o2=r;break;case 0:case 11:case 14:case 15:M1(2,s,t),w0||M1(4,s,t),l1(e,t,s);break;case 1:w0||(V2(s,t),i=s.stateNode,typeof i.componentWillUnmount=="function"&&ul(s,t,i)),l1(e,t,s);break;case 21:l1(e,t,s);break;case 22:w0=(i=w0)||s.memoizedState!==null,l1(e,t,s),w0=i;break;default:l1(e,t,s)}}function fl(e,t){if(t.memoizedState===null&&(e=t.alternate,e!==null&&(e=e.memoizedState,e!==null))){e=e.dehydrated;try{Ge(e)}catch(s){M0(t,t.return,s)}}}function hl(e,t){if(t.memoizedState===null&&(e=t.alternate,e!==null&&(e=e.memoizedState,e!==null&&(e=e.dehydrated,e!==null))))try{Ge(e)}catch(s){M0(t,t.return,s)}}function Cu(e){switch(e.tag){case 31:case 13:case 19:var t=e.stateNode;return t===null&&(t=e.stateNode=new ol),t;case 22:return e=e.stateNode,t=e._retryCache,t===null&&(t=e._retryCache=new ol),t;default:throw Error(n(435,e.tag))}}function N3(e,t){var s=Cu(e);t.forEach(function(i){if(!s.has(i)){s.add(i);var r=Lu.bind(null,e,i);i.then(r,r)}})}function m2(e,t){var s=t.deletions;if(s!==null)for(var i=0;i<s.length;i++){var r=s[i],l=e,a=t,u=a;e:for(;u!==null;){switch(u.tag){case 27:if(D1(u.type)){q0=u.stateNode,o2=!1;break e}break;case 5:q0=u.stateNode,o2=!1;break e;case 3:case 4:q0=u.stateNode.containerInfo,o2=!0;break e}u=u.return}if(q0===null)throw Error(n(160));_l(l,a,r),q0=null,o2=!1,l=r.alternate,l!==null&&(l.return=null),r.return=null}if(t.subtreeFlags&13886)for(t=t.child;t!==null;)yl(t,e),t=t.sibling}var B2=null;function yl(e,t){var s=e.alternate,i=e.flags;switch(e.tag){case 0:case 11:case 14:case 15:m2(t,e),p2(e),i&4&&(M1(3,e,e.return),Tt(3,e),M1(5,e,e.return));break;case 1:m2(t,e),p2(e),i&512&&(w0||s===null||V2(s,s.return)),i&64&&r1&&(e=e.updateQueue,e!==null&&(i=e.callbacks,i!==null&&(s=e.shared.hiddenCallbacks,e.shared.hiddenCallbacks=s===null?i:s.concat(i))));break;case 26:var r=B2;if(m2(t,e),p2(e),i&512&&(w0||s===null||V2(s,s.return)),i&4){var l=s!==null?s.memoizedState:null;if(i=e.memoizedState,s===null)if(i===null)if(e.stateNode===null){e:{i=e.type,s=e.memoizedProps,r=r.ownerDocument||r;t:switch(i){case"title":l=r.getElementsByTagName("title")[0],(!l||l[Je]||l[I0]||l.namespaceURI==="http://www.w3.org/2000/svg"||l.hasAttribute("itemprop"))&&(l=r.createElement(i),r.head.insertBefore(l,r.querySelector("head > title"))),s2(l,i,s),l[I0]=e,k0(l),i=l;break e;case"link":var a=y6("link","href",r).get(i+(s.href||""));if(a){for(var u=0;u<a.length;u++)if(l=a[u],l.getAttribute("href")===(s.href==null||s.href===""?null:s.href)&&l.getAttribute("rel")===(s.rel==null?null:s.rel)&&l.getAttribute("title")===(s.title==null?null:s.title)&&l.getAttribute("crossorigin")===(s.crossOrigin==null?null:s.crossOrigin)){a.splice(u,1);break t}}l=r.createElement(i),s2(l,i,s),r.head.appendChild(l);break;case"meta":if(a=y6("meta","content",r).get(i+(s.content||""))){for(u=0;u<a.length;u++)if(l=a[u],l.getAttribute("content")===(s.content==null?null:""+s.content)&&l.getAttribute("name")===(s.name==null?null:s.name)&&l.getAttribute("property")===(s.property==null?null:s.property)&&l.getAttribute("http-equiv")===(s.httpEquiv==null?null:s.httpEquiv)&&l.getAttribute("charset")===(s.charSet==null?null:s.charSet)){a.splice(u,1);break t}}l=r.createElement(i),s2(l,i,s),r.head.appendChild(l);break;default:throw Error(n(468,i))}l[I0]=e,k0(l),i=l}e.stateNode=i}else T6(r,e.type,e.stateNode);else e.stateNode=h6(r,i,e.memoizedProps);else l!==i?(l===null?s.stateNode!==null&&(s=s.stateNode,s.parentNode.removeChild(s)):l.count--,i===null?T6(r,e.type,e.stateNode):h6(r,i,e.memoizedProps)):i===null&&e.stateNode!==null&&Ds(e,e.memoizedProps,s.memoizedProps)}break;case 27:m2(t,e),p2(e),i&512&&(w0||s===null||V2(s,s.return)),s!==null&&i&4&&Ds(e,e.memoizedProps,s.memoizedProps);break;case 5:if(m2(t,e),p2(e),i&512&&(w0||s===null||V2(s,s.return)),e.flags&32){r=e.stateNode;try{de(r,"")}catch(Q){M0(e,e.return,Q)}}i&4&&e.stateNode!=null&&(r=e.memoizedProps,Ds(e,r,s!==null?s.memoizedProps:r)),i&1024&&(js=!0);break;case 6:if(m2(t,e),p2(e),i&4){if(e.stateNode===null)throw Error(n(162));i=e.memoizedProps,s=e.stateNode;try{s.nodeValue=i}catch(Q){M0(e,e.return,Q)}}break;case 3:if(K3=null,r=B2,B2=Z3(t.containerInfo),m2(t,e),B2=r,p2(e),i&4&&s!==null&&s.memoizedState.isDehydrated)try{Ge(t.containerInfo)}catch(Q){M0(e,e.return,Q)}js&&(js=!1,Tl(e));break;case 4:i=B2,B2=Z3(e.stateNode.containerInfo),m2(t,e),p2(e),B2=i;break;case 12:m2(t,e),p2(e);break;case 31:m2(t,e),p2(e),i&4&&(i=e.updateQueue,i!==null&&(e.updateQueue=null,N3(e,i)));break;case 13:m2(t,e),p2(e),e.child.flags&8192&&e.memoizedState!==null!=(s!==null&&s.memoizedState!==null)&&(D3=h2()),i&4&&(i=e.updateQueue,i!==null&&(e.updateQueue=null,N3(e,i)));break;case 22:r=e.memoizedState!==null;var c=s!==null&&s.memoizedState!==null,y=r1,A=w0;if(r1=y||r,w0=A||c,m2(t,e),w0=A,r1=y,p2(e),i&8192)e:for(t=e.stateNode,t._visibility=r?t._visibility&-2:t._visibility|1,r&&(s===null||c||r1||w0||P1(e)),s=null,t=e;;){if(t.tag===5||t.tag===26){if(s===null){c=s=t;try{if(l=c.stateNode,r)a=l.style,typeof a.setProperty=="function"?a.setProperty("display","none","important"):a.display="none";else{u=c.stateNode;var U=c.memoizedProps.style,g=U!=null&&U.hasOwnProperty("display")?U.display:null;u.style.display=g==null||typeof g=="boolean"?"":(""+g).trim()}}catch(Q){M0(c,c.return,Q)}}}else if(t.tag===6){if(s===null){c=t;try{c.stateNode.nodeValue=r?"":c.memoizedProps}catch(Q){M0(c,c.return,Q)}}}else if(t.tag===18){if(s===null){c=t;try{var b=c.stateNode;r?u6(b,!0):u6(c.stateNode,!1)}catch(Q){M0(c,c.return,Q)}}}else if((t.tag!==22&&t.tag!==23||t.memoizedState===null||t===e)&&t.child!==null){t.child.return=t,t=t.child;continue}if(t===e)break e;for(;t.sibling===null;){if(t.return===null||t.return===e)break e;s===t&&(s=null),t=t.return}s===t&&(s=null),t.sibling.return=t.return,t=t.sibling}i&4&&(i=e.updateQueue,i!==null&&(s=i.retryQueue,s!==null&&(i.retryQueue=null,N3(e,s))));break;case 19:m2(t,e),p2(e),i&4&&(i=e.updateQueue,i!==null&&(e.updateQueue=null,N3(e,i)));break;case 30:break;case 21:break;default:m2(t,e),p2(e)}}function p2(e){var t=e.flags;if(t&2){try{for(var s,i=e.return;i!==null;){if(dl(i)){s=i;break}i=i.return}if(s==null)throw Error(n(160));switch(s.tag){case 27:var r=s.stateNode,l=Us(e);O3(e,l,r);break;case 5:var a=s.stateNode;s.flags&32&&(de(a,""),s.flags&=-33);var u=Us(e);O3(e,u,a);break;case 3:case 4:var c=s.stateNode.containerInfo,y=Us(e);Rs(e,y,c);break;default:throw Error(n(161))}}catch(A){M0(e,e.return,A)}e.flags&=-3}t&4096&&(e.flags&=-4097)}function Tl(e){if(e.subtreeFlags&1024)for(e=e.child;e!==null;){var t=e;Tl(t),t.tag===5&&t.flags&1024&&t.stateNode.reset(),e=e.sibling}}function a1(e,t){if(t.subtreeFlags&8772)for(t=t.child;t!==null;)ml(e,t.alternate,t),t=t.sibling}function P1(e){for(e=e.child;e!==null;){var t=e;switch(t.tag){case 0:case 11:case 14:case 15:M1(4,t,t.return),P1(t);break;case 1:V2(t,t.return);var s=t.stateNode;typeof s.componentWillUnmount=="function"&&ul(t,t.return,s),P1(t);break;case 27:Ot(t.stateNode);case 26:case 5:V2(t,t.return),P1(t);break;case 22:t.memoizedState===null&&P1(t);break;case 30:P1(t);break;default:P1(t)}e=e.sibling}}function u1(e,t,s){for(s=s&&(t.subtreeFlags&8772)!==0,t=t.child;t!==null;){var i=t.alternate,r=e,l=t,a=l.flags;switch(l.tag){case 0:case 11:case 15:u1(r,l,s),Tt(4,l);break;case 1:if(u1(r,l,s),i=l,r=i.stateNode,typeof r.componentDidMount=="function")try{r.componentDidMount()}catch(y){M0(i,i.return,y)}if(i=l,r=i.updateQueue,r!==null){var u=i.stateNode;try{var c=r.shared.hiddenCallbacks;if(c!==null)for(r.shared.hiddenCallbacks=null,r=0;r<c.length;r++)ki(c[r],u)}catch(y){M0(i,i.return,y)}}s&&a&64&&al(l),vt(l,l.return);break;case 27:cl(l);case 26:case 5:u1(r,l,s),s&&i===null&&a&4&&nl(l),vt(l,l.return);break;case 12:u1(r,l,s);break;case 31:u1(r,l,s),s&&a&4&&fl(r,l);break;case 13:u1(r,l,s),s&&a&4&&hl(r,l);break;case 22:l.memoizedState===null&&u1(r,l,s),vt(l,l.return);break;case 30:break;default:u1(r,l,s)}t=t.sibling}}function Hs(e,t){var s=null;e!==null&&e.memoizedState!==null&&e.memoizedState.cachePool!==null&&(s=e.memoizedState.cachePool.pool),e=null,t.memoizedState!==null&&t.memoizedState.cachePool!==null&&(e=t.memoizedState.cachePool.pool),e!==s&&(e!=null&&e.refCount++,s!=null&&lt(s))}function qs(e,t){e=null,t.alternate!==null&&(e=t.alternate.memoizedState.cache),t=t.memoizedState.cache,t!==e&&(t.refCount++,e!=null&&lt(e))}function L2(e,t,s,i){if(t.subtreeFlags&10256)for(t=t.child;t!==null;)vl(e,t,s,i),t=t.sibling}function vl(e,t,s,i){var r=t.flags;switch(t.tag){case 0:case 11:case 15:L2(e,t,s,i),r&2048&&Tt(9,t);break;case 1:L2(e,t,s,i);break;case 3:L2(e,t,s,i),r&2048&&(e=null,t.alternate!==null&&(e=t.alternate.memoizedState.cache),t=t.memoizedState.cache,t!==e&&(t.refCount++,e!=null&&lt(e)));break;case 12:if(r&2048){L2(e,t,s,i),e=t.stateNode;try{var l=t.memoizedProps,a=l.id,u=l.onPostCommit;typeof u=="function"&&u(a,t.alternate===null?"mount":"update",e.passiveEffectDuration,-0)}catch(c){M0(t,t.return,c)}}else L2(e,t,s,i);break;case 31:L2(e,t,s,i);break;case 13:L2(e,t,s,i);break;case 23:break;case 22:l=t.stateNode,a=t.alternate,t.memoizedState!==null?l._visibility&2?L2(e,t,s,i):gt(e,t):l._visibility&2?L2(e,t,s,i):(l._visibility|=2,Ne(e,t,s,i,(t.subtreeFlags&10256)!==0||!1)),r&2048&&Hs(a,t);break;case 24:L2(e,t,s,i),r&2048&&qs(t.alternate,t);break;default:L2(e,t,s,i)}}function Ne(e,t,s,i,r){for(r=r&&((t.subtreeFlags&10256)!==0||!1),t=t.child;t!==null;){var l=e,a=t,u=s,c=i,y=a.flags;switch(a.tag){case 0:case 11:case 15:Ne(l,a,u,c,r),Tt(8,a);break;case 23:break;case 22:var A=a.stateNode;a.memoizedState!==null?A._visibility&2?Ne(l,a,u,c,r):gt(l,a):(A._visibility|=2,Ne(l,a,u,c,r)),r&&y&2048&&Hs(a.alternate,a);break;case 24:Ne(l,a,u,c,r),r&&y&2048&&qs(a.alternate,a);break;default:Ne(l,a,u,c,r)}t=t.sibling}}function gt(e,t){if(t.subtreeFlags&10256)for(t=t.child;t!==null;){var s=e,i=t,r=i.flags;switch(i.tag){case 22:gt(s,i),r&2048&&Hs(i.alternate,i);break;case 24:gt(s,i),r&2048&&qs(i.alternate,i);break;default:gt(s,i)}t=t.sibling}}var St=8192;function Ce(e,t,s){if(e.subtreeFlags&St)for(e=e.child;e!==null;)gl(e,t,s),e=e.sibling}function gl(e,t,s){switch(e.tag){case 26:Ce(e,t,s),e.flags&St&&e.memoizedState!==null&&yn(s,B2,e.memoizedState,e.memoizedProps);break;case 5:Ce(e,t,s);break;case 3:case 4:var i=B2;B2=Z3(e.stateNode.containerInfo),Ce(e,t,s),B2=i;break;case 22:e.memoizedState===null&&(i=e.alternate,i!==null&&i.memoizedState!==null?(i=St,St=16777216,Ce(e,t,s),St=i):Ce(e,t,s));break;default:Ce(e,t,s)}}function Sl(e){var t=e.alternate;if(t!==null&&(e=t.child,e!==null)){t.child=null;do t=e.sibling,e.sibling=null,e=t;while(e!==null)}}function bt(e){var t=e.deletions;if((e.flags&16)!==0){if(t!==null)for(var s=0;s<t.length;s++){var i=t[s];W0=i,zl(i,e)}Sl(e)}if(e.subtreeFlags&10256)for(e=e.child;e!==null;)bl(e),e=e.sibling}function bl(e){switch(e.tag){case 0:case 11:case 15:bt(e),e.flags&2048&&M1(9,e,e.return);break;case 3:bt(e);break;case 12:bt(e);break;case 22:var t=e.stateNode;e.memoizedState!==null&&t._visibility&2&&(e.return===null||e.return.tag!==13)?(t._visibility&=-3,C3(e)):bt(e);break;default:bt(e)}}function C3(e){var t=e.deletions;if((e.flags&16)!==0){if(t!==null)for(var s=0;s<t.length;s++){var i=t[s];W0=i,zl(i,e)}Sl(e)}for(e=e.child;e!==null;){switch(t=e,t.tag){case 0:case 11:case 15:M1(8,t,t.return),C3(t);break;case 22:s=t.stateNode,s._visibility&2&&(s._visibility&=-3,C3(t));break;default:C3(t)}e=e.sibling}}function zl(e,t){for(;W0!==null;){var s=W0;switch(s.tag){case 0:case 11:case 15:M1(8,s,t);break;case 23:case 22:if(s.memoizedState!==null&&s.memoizedState.cachePool!==null){var i=s.memoizedState.cachePool.pool;i!=null&&i.refCount++}break;case 24:lt(s.memoizedState.cache)}if(i=s.child,i!==null)i.return=s,W0=i;else e:for(s=e;W0!==null;){i=W0;var r=i.sibling,l=i.return;if(pl(i),i===s){W0=null;break e}if(r!==null){r.return=l,W0=r;break e}W0=l}}}var Du={getCacheForType:function(e){var t=e2(V0),s=t.data.get(e);return s===void 0&&(s=e(),t.data.set(e,s)),s},cacheSignal:function(){return e2(V0).controller.signal}},Uu=typeof WeakMap=="function"?WeakMap:Map,b0=0,D0=null,l0=null,c0=0,z0=0,z2=null,E1=!1,De=!1,Ys=!1,n1=0,L0=0,A1=0,ee=0,Bs=0,M2=0,Ue=0,zt=null,_2=null,Ls=!1,D3=0,Ml=0,U3=1/0,R3=null,x1=null,$0=0,O1=null,Re=null,d1=0,Gs=0,Xs=null,El=null,Mt=0,Qs=null;function E2(){return(b0&2)!==0&&c0!==0?c0&-c0:M.T!==null?$s():X5()}function Al(){if(M2===0)if((c0&536870912)===0||_0){var e=Xt;Xt<<=1,(Xt&3932160)===0&&(Xt=262144),M2=e}else M2=536870912;return e=S2.current,e!==null&&(e.flags|=32),M2}function f2(e,t,s){(e===D0&&(z0===2||z0===9)||e.cancelPendingCommit!==null)&&(je(e,0),N1(e,c0,M2,!1)),Ke(e,s),((b0&2)===0||e!==D0)&&(e===D0&&((b0&2)===0&&(ee|=s),L0===4&&N1(e,c0,M2,!1)),K2(e))}function xl(e,t,s){if((b0&6)!==0)throw Error(n(327));var i=!s&&(t&127)===0&&(t&e.expiredLanes)===0||Ve(e,t),r=i?Hu(e,t):Vs(e,t,!0),l=i;do{if(r===0){De&&!i&&N1(e,t,0,!1);break}else{if(s=e.current.alternate,l&&!Ru(s)){r=Vs(e,t,!1),l=!1;continue}if(r===2){if(l=t,e.errorRecoveryDisabledLanes&l)var a=0;else a=e.pendingLanes&-536870913,a=a!==0?a:a&536870912?536870912:0;if(a!==0){t=a;e:{var u=e;r=zt;var c=u.current.memoizedState.isDehydrated;if(c&&(je(u,a).flags|=256),a=Vs(u,a,!1),a!==2){if(Ys&&!c){u.errorRecoveryDisabledLanes|=l,ee|=l,r=4;break e}l=_2,_2=r,l!==null&&(_2===null?_2=l:_2.push.apply(_2,l))}r=a}if(l=!1,r!==2)continue}}if(r===1){je(e,0),N1(e,t,0,!0);break}e:{switch(i=e,l=r,l){case 0:case 1:throw Error(n(345));case 4:if((t&4194048)!==t)break;case 6:N1(i,t,M2,!E1);break e;case 2:_2=null;break;case 3:case 5:break;default:throw Error(n(329))}if((t&62914560)===t&&(r=D3+300-h2(),10<r)){if(N1(i,t,M2,!E1),Zt(i,0,!0)!==0)break e;d1=t,i.timeoutHandle=r6(Ol.bind(null,i,s,_2,R3,Ls,t,M2,ee,Ue,E1,l,"Throttled",-0,0),r);break e}Ol(i,s,_2,R3,Ls,t,M2,ee,Ue,E1,l,null,-0,0)}}break}while(!0);K2(e)}function Ol(e,t,s,i,r,l,a,u,c,y,A,U,g,b){if(e.timeoutHandle=-1,U=t.subtreeFlags,U&8192||(U&16785408)===16785408){U={stylesheets:null,count:0,imgCount:0,imgBytes:0,suspenseyImages:[],waitingForImages:!0,waitingForViewTransition:!1,unsuspend:$2},gl(t,l,U);var Q=(l&62914560)===l?D3-h2():(l&4194048)===l?Ml-h2():0;if(Q=Tn(U,Q),Q!==null){d1=l,e.cancelPendingCommit=Q(ql.bind(null,e,t,l,s,i,r,a,u,c,A,U,null,g,b)),N1(e,l,a,!y);return}}ql(e,t,l,s,i,r,a,u,c)}function Ru(e){for(var t=e;;){var s=t.tag;if((s===0||s===11||s===15)&&t.flags&16384&&(s=t.updateQueue,s!==null&&(s=s.stores,s!==null)))for(var i=0;i<s.length;i++){var r=s[i],l=r.getSnapshot;r=r.value;try{if(!v2(l(),r))return!1}catch{return!1}}if(s=t.child,t.subtreeFlags&16384&&s!==null)s.return=t,t=s;else{if(t===e)break;for(;t.sibling===null;){if(t.return===null||t.return===e)return!0;t=t.return}t.sibling.return=t.return,t=t.sibling}}return!0}function N1(e,t,s,i){t&=~Bs,t&=~ee,e.suspendedLanes|=t,e.pingedLanes&=~t,i&&(e.warmLanes|=t),i=e.expirationTimes;for(var r=t;0<r;){var l=31-T2(r),a=1<<l;i[l]=-1,r&=~a}s!==0&&B5(e,s,t)}function j3(){return(b0&6)===0?(Et(0),!1):!0}function Zs(){if(l0!==null){if(z0===0)var e=l0.return;else e=l0,I2=K1=null,ls(e),Me=null,ut=0,e=l0;for(;e!==null;)ll(e.alternate,e),e=e.return;l0=null}}function je(e,t){var s=e.timeoutHandle;s!==-1&&(e.timeoutHandle=-1,Pu(s)),s=e.cancelPendingCommit,s!==null&&(e.cancelPendingCommit=null,s()),d1=0,Zs(),D0=e,l0=s=W2(e.current,null),c0=t,z0=0,z2=null,E1=!1,De=Ve(e,t),Ys=!1,Ue=M2=Bs=ee=A1=L0=0,_2=zt=null,Ls=!1,(t&8)!==0&&(t|=t&32);var i=e.entangledLanes;if(i!==0)for(e=e.entanglements,i&=t;0<i;){var r=31-T2(i),l=1<<r;t|=e[r],i&=~l}return n1=t,t3(),s}function Nl(e,t){e0=null,M.H=ft,t===ze||t===d3?(t=Ki(),z0=3):t===w4?(t=Ki(),z0=4):z0=t===Ss?8:t!==null&&typeof t=="object"&&typeof t.then=="function"?6:1,z2=t,l0===null&&(L0=1,z3(e,N2(t,e.current)))}function Cl(){var e=S2.current;return e===null?!0:(c0&4194048)===c0?R2===null:(c0&62914560)===c0||(c0&536870912)!==0?e===R2:!1}function Dl(){var e=M.H;return M.H=ft,e===null?ft:e}function Ul(){var e=M.A;return M.A=Du,e}function H3(){L0=4,E1||(c0&4194048)!==c0&&S2.current!==null||(De=!0),(A1&134217727)===0&&(ee&134217727)===0||D0===null||N1(D0,c0,M2,!1)}function Vs(e,t,s){var i=b0;b0|=2;var r=Dl(),l=Ul();(D0!==e||c0!==t)&&(R3=null,je(e,t)),t=!1;var a=L0;e:do try{if(z0!==0&&l0!==null){var u=l0,c=z2;switch(z0){case 8:Zs(),a=6;break e;case 3:case 2:case 9:case 6:S2.current===null&&(t=!0);var y=z0;if(z0=0,z2=null,He(e,u,c,y),s&&De){a=0;break e}break;default:y=z0,z0=0,z2=null,He(e,u,c,y)}}ju(),a=L0;break}catch(A){Nl(e,A)}while(!0);return t&&e.shellSuspendCounter++,I2=K1=null,b0=i,M.H=r,M.A=l,l0===null&&(D0=null,c0=0,t3()),a}function ju(){for(;l0!==null;)Rl(l0)}function Hu(e,t){var s=b0;b0|=2;var i=Dl(),r=Ul();D0!==e||c0!==t?(R3=null,U3=h2()+500,je(e,t)):De=Ve(e,t);e:do try{if(z0!==0&&l0!==null){t=l0;var l=z2;t:switch(z0){case 1:z0=0,z2=null,He(e,t,l,1);break;case 2:case 9:if(Zi(l)){z0=0,z2=null,jl(t);break}t=function(){z0!==2&&z0!==9||D0!==e||(z0=7),K2(e)},l.then(t,t);break e;case 3:z0=7;break e;case 4:z0=5;break e;case 7:Zi(l)?(z0=0,z2=null,jl(t)):(z0=0,z2=null,He(e,t,l,7));break;case 5:var a=null;switch(l0.tag){case 26:a=l0.memoizedState;case 5:case 27:var u=l0;if(a?v6(a):u.stateNode.complete){z0=0,z2=null;var c=u.sibling;if(c!==null)l0=c;else{var y=u.return;y!==null?(l0=y,q3(y)):l0=null}break t}}z0=0,z2=null,He(e,t,l,5);break;case 6:z0=0,z2=null,He(e,t,l,6);break;case 8:Zs(),L0=6;break e;default:throw Error(n(462))}}qu();break}catch(A){Nl(e,A)}while(!0);return I2=K1=null,M.H=i,M.A=r,b0=s,l0!==null?0:(D0=null,c0=0,t3(),L0)}function qu(){for(;l0!==null&&!R5();)Rl(l0)}function Rl(e){var t=il(e.alternate,e,n1);e.memoizedProps=e.pendingProps,t===null?q3(e):l0=t}function jl(e){var t=e,s=t.alternate;switch(t.tag){case 15:case 0:t=Fr(s,t,t.pendingProps,t.type,void 0,c0);break;case 11:t=Fr(s,t,t.pendingProps,t.type.render,t.ref,c0);break;case 5:ls(t);default:ll(s,t),t=l0=Ui(t,n1),t=il(s,t,n1)}e.memoizedProps=e.pendingProps,t===null?q3(e):l0=t}function He(e,t,s,i){I2=K1=null,ls(t),Me=null,ut=0;var r=t.return;try{if(Mu(e,r,t,s,c0)){L0=1,z3(e,N2(s,e.current)),l0=null;return}}catch(l){if(r!==null)throw l0=r,l;L0=1,z3(e,N2(s,e.current)),l0=null;return}t.flags&32768?(_0||i===1?e=!0:De||(c0&536870912)!==0?e=!1:(E1=e=!0,(i===2||i===9||i===3||i===6)&&(i=S2.current,i!==null&&i.tag===13&&(i.flags|=16384))),Hl(t,e)):q3(t)}function q3(e){var t=e;do{if((t.flags&32768)!==0){Hl(t,E1);return}e=t.return;var s=xu(t.alternate,t,n1);if(s!==null){l0=s;return}if(t=t.sibling,t!==null){l0=t;return}l0=t=e}while(t!==null);L0===0&&(L0=5)}function Hl(e,t){do{var s=Ou(e.alternate,e);if(s!==null){s.flags&=32767,l0=s;return}if(s=e.return,s!==null&&(s.flags|=32768,s.subtreeFlags=0,s.deletions=null),!t&&(e=e.sibling,e!==null)){l0=e;return}l0=e=s}while(e!==null);L0=6,l0=null}function ql(e,t,s,i,r,l,a,u,c){e.cancelPendingCommit=null;do Y3();while($0!==0);if((b0&6)!==0)throw Error(n(327));if(t!==null){if(t===e.current)throw Error(n(177));if(l=t.lanes|t.childLanes,l|=U4,fa(e,s,l,a,u,c),e===D0&&(l0=D0=null,c0=0),Re=t,O1=e,d1=s,Gs=l,Xs=r,El=i,(t.subtreeFlags&10256)!==0||(t.flags&10256)!==0?(e.callbackNode=null,e.callbackPriority=0,Gu(Lt,function(){return Xl(),null})):(e.callbackNode=null,e.callbackPriority=0),i=(t.flags&13878)!==0,(t.subtreeFlags&13878)!==0||i){i=M.T,M.T=null,r=L.p,L.p=2,a=b0,b0|=4;try{Nu(e,t,s)}finally{b0=a,L.p=r,M.T=i}}$0=1,Yl(),Bl(),Ll()}}function Yl(){if($0===1){$0=0;var e=O1,t=Re,s=(t.flags&13878)!==0;if((t.subtreeFlags&13878)!==0||s){s=M.T,M.T=null;var i=L.p;L.p=2;var r=b0;b0|=4;try{yl(t,e);var l=s5,a=zi(e.containerInfo),u=l.focusedElem,c=l.selectionRange;if(a!==u&&u&&u.ownerDocument&&bi(u.ownerDocument.documentElement,u)){if(c!==null&&x4(u)){var y=c.start,A=c.end;if(A===void 0&&(A=y),"selectionStart"in u)u.selectionStart=y,u.selectionEnd=Math.min(A,u.value.length);else{var U=u.ownerDocument||document,g=U&&U.defaultView||window;if(g.getSelection){var b=g.getSelection(),Q=u.textContent.length,$=Math.min(c.start,Q),N0=c.end===void 0?$:Math.min(c.end,Q);!b.extend&&$>N0&&(a=N0,N0=$,$=a);var _=Si(u,$),o=Si(u,N0);if(_&&o&&(b.rangeCount!==1||b.anchorNode!==_.node||b.anchorOffset!==_.offset||b.focusNode!==o.node||b.focusOffset!==o.offset)){var h=U.createRange();h.setStart(_.node,_.offset),b.removeAllRanges(),$>N0?(b.addRange(h),b.extend(o.node,o.offset)):(h.setEnd(o.node,o.offset),b.addRange(h))}}}}for(U=[],b=u;b=b.parentNode;)b.nodeType===1&&U.push({element:b,left:b.scrollLeft,top:b.scrollTop});for(typeof u.focus=="function"&&u.focus(),u=0;u<U.length;u++){var C=U[u];C.element.scrollLeft=C.left,C.element.scrollTop=C.top}}k3=!!t5,s5=t5=null}finally{b0=r,L.p=i,M.T=s}}e.current=t,$0=2}}function Bl(){if($0===2){$0=0;var e=O1,t=Re,s=(t.flags&8772)!==0;if((t.subtreeFlags&8772)!==0||s){s=M.T,M.T=null;var i=L.p;L.p=2;var r=b0;b0|=4;try{ml(e,t.alternate,t)}finally{b0=r,L.p=i,M.T=s}}$0=3}}function Ll(){if($0===4||$0===3){$0=0,aa();var e=O1,t=Re,s=d1,i=El;(t.subtreeFlags&10256)!==0||(t.flags&10256)!==0?$0=5:($0=0,Re=O1=null,Gl(e,e.pendingLanes));var r=e.pendingLanes;if(r===0&&(x1=null),n4(s),t=t.stateNode,y2&&typeof y2.onCommitFiberRoot=="function")try{y2.onCommitFiberRoot(Ze,t,void 0,(t.current.flags&128)===128)}catch{}if(i!==null){t=M.T,r=L.p,L.p=2,M.T=null;try{for(var l=e.onRecoverableError,a=0;a<i.length;a++){var u=i[a];l(u.value,{componentStack:u.stack})}}finally{M.T=t,L.p=r}}(d1&3)!==0&&Y3(),K2(e),r=e.pendingLanes,(s&261930)!==0&&(r&42)!==0?e===Qs?Mt++:(Mt=0,Qs=e):Mt=0,Et(0)}}function Gl(e,t){(e.pooledCacheLanes&=t)===0&&(t=e.pooledCache,t!=null&&(e.pooledCache=null,lt(t)))}function Y3(){return Yl(),Bl(),Ll(),Xl()}function Xl(){if($0!==5)return!1;var e=O1,t=Gs;Gs=0;var s=n4(d1),i=M.T,r=L.p;try{L.p=32>s?32:s,M.T=null,s=Xs,Xs=null;var l=O1,a=d1;if($0=0,Re=O1=null,d1=0,(b0&6)!==0)throw Error(n(331));var u=b0;if(b0|=4,bl(l.current),vl(l,l.current,a,s),b0=u,Et(0,!1),y2&&typeof y2.onPostCommitFiberRoot=="function")try{y2.onPostCommitFiberRoot(Ze,l)}catch{}return!0}finally{L.p=r,M.T=i,Gl(e,t)}}function Ql(e,t,s){t=N2(s,t),t=gs(e.stateNode,t,2),e=S1(e,t,2),e!==null&&(Ke(e,2),K2(e))}function M0(e,t,s){if(e.tag===3)Ql(e,e,s);else for(;t!==null;){if(t.tag===3){Ql(t,e,s);break}else if(t.tag===1){var i=t.stateNode;if(typeof t.type.getDerivedStateFromError=="function"||typeof i.componentDidCatch=="function"&&(x1===null||!x1.has(i))){e=N2(s,e),s=Zr(2),i=S1(t,s,2),i!==null&&(Vr(s,i,t,e),Ke(i,2),K2(i));break}}t=t.return}}function Ks(e,t,s){var i=e.pingCache;if(i===null){i=e.pingCache=new Uu;var r=new Set;i.set(t,r)}else r=i.get(t),r===void 0&&(r=new Set,i.set(t,r));r.has(s)||(Ys=!0,r.add(s),e=Yu.bind(null,e,t,s),t.then(e,e))}function Yu(e,t,s){var i=e.pingCache;i!==null&&i.delete(t),e.pingedLanes|=e.suspendedLanes&s,e.warmLanes&=~s,D0===e&&(c0&s)===s&&(L0===4||L0===3&&(c0&62914560)===c0&&300>h2()-D3?(b0&2)===0&&je(e,0):Bs|=s,Ue===c0&&(Ue=0)),K2(e)}function Zl(e,t){t===0&&(t=Y5()),e=Q1(e,t),e!==null&&(Ke(e,t),K2(e))}function Bu(e){var t=e.memoizedState,s=0;t!==null&&(s=t.retryLane),Zl(e,s)}function Lu(e,t){var s=0;switch(e.tag){case 31:case 13:var i=e.stateNode,r=e.memoizedState;r!==null&&(s=r.retryLane);break;case 19:i=e.stateNode;break;case 22:i=e.stateNode._retryCache;break;default:throw Error(n(314))}i!==null&&i.delete(t),Zl(e,s)}function Gu(e,t){return X2(e,t)}var B3=null,qe=null,Js=!1,L3=!1,ws=!1,C1=0;function K2(e){e!==qe&&e.next===null&&(qe===null?B3=qe=e:qe=qe.next=e),L3=!0,Js||(Js=!0,Qu())}function Et(e,t){if(!ws&&L3){ws=!0;do for(var s=!1,i=B3;i!==null;){if(e!==0){var r=i.pendingLanes;if(r===0)var l=0;else{var a=i.suspendedLanes,u=i.pingedLanes;l=(1<<31-T2(42|e)+1)-1,l&=r&~(a&~u),l=l&201326741?l&201326741|1:l?l|2:0}l!==0&&(s=!0,wl(i,l))}else l=c0,l=Zt(i,i===D0?l:0,i.cancelPendingCommit!==null||i.timeoutHandle!==-1),(l&3)===0||Ve(i,l)||(s=!0,wl(i,l));i=i.next}while(s);ws=!1}}function Xu(){Vl()}function Vl(){L3=Js=!1;var e=0;C1!==0&&Iu()&&(e=C1);for(var t=h2(),s=null,i=B3;i!==null;){var r=i.next,l=Kl(i,t);l===0?(i.next=null,s===null?B3=r:s.next=r,r===null&&(qe=s)):(s=i,(e!==0||(l&3)!==0)&&(L3=!0)),i=r}$0!==0&&$0!==5||Et(e),C1!==0&&(C1=0)}function Kl(e,t){for(var s=e.suspendedLanes,i=e.pingedLanes,r=e.expirationTimes,l=e.pendingLanes&-62914561;0<l;){var a=31-T2(l),u=1<<a,c=r[a];c===-1?((u&s)===0||(u&i)!==0)&&(r[a]=_a(u,t)):c<=t&&(e.expiredLanes|=u),l&=~u}if(t=D0,s=c0,s=Zt(e,e===t?s:0,e.cancelPendingCommit!==null||e.timeoutHandle!==-1),i=e.callbackNode,s===0||e===t&&(z0===2||z0===9)||e.cancelPendingCommit!==null)return i!==null&&i!==null&&se(i),e.callbackNode=null,e.callbackPriority=0;if((s&3)===0||Ve(e,s)){if(t=s&-s,t===e.callbackPriority)return t;switch(i!==null&&se(i),n4(s)){case 2:case 8:s=H5;break;case 32:s=Lt;break;case 268435456:s=q5;break;default:s=Lt}return i=Jl.bind(null,e),s=X2(s,i),e.callbackPriority=t,e.callbackNode=s,t}return i!==null&&i!==null&&se(i),e.callbackPriority=2,e.callbackNode=null,2}function Jl(e,t){if($0!==0&&$0!==5)return e.callbackNode=null,e.callbackPriority=0,null;var s=e.callbackNode;if(Y3()&&e.callbackNode!==s)return null;var i=c0;return i=Zt(e,e===D0?i:0,e.cancelPendingCommit!==null||e.timeoutHandle!==-1),i===0?null:(xl(e,i,t),Kl(e,h2()),e.callbackNode!=null&&e.callbackNode===s?Jl.bind(null,e):null)}function wl(e,t){if(Y3())return null;xl(e,t,!0)}function Qu(){en(function(){(b0&6)!==0?X2(j5,Xu):Vl()})}function $s(){if(C1===0){var e=Se;e===0&&(e=Gt,Gt<<=1,(Gt&261888)===0&&(Gt=256)),C1=e}return C1}function $l(e){return e==null||typeof e=="symbol"||typeof e=="boolean"?null:typeof e=="function"?e:wt(""+e)}function kl(e,t){var s=t.ownerDocument.createElement("input");return s.name=t.name,s.value=t.value,e.id&&s.setAttribute("form",e.id),t.parentNode.insertBefore(s,t),e=new FormData(e),s.parentNode.removeChild(s),e}function Zu(e,t,s,i,r){if(t==="submit"&&s&&s.stateNode===r){var l=$l((r[d2]||null).action),a=i.submitter;a&&(t=(t=a[d2]||null)?$l(t.formAction):a.getAttribute("formAction"),t!==null&&(l=t,a=null));var u=new Ft("action","action",null,i,r);e.push({event:u,listeners:[{instance:null,listener:function(){if(i.defaultPrevented){if(C1!==0){var c=a?kl(r,a):new FormData(r);_s(s,{pending:!0,data:c,method:r.method,action:l},null,c)}}else typeof l=="function"&&(u.preventDefault(),c=a?kl(r,a):new FormData(r),_s(s,{pending:!0,data:c,method:r.method,action:l},l,c))},currentTarget:r}]})}}for(var ks=0;ks<D4.length;ks++){var Ws=D4[ks],Vu=Ws.toLowerCase(),Ku=Ws[0].toUpperCase()+Ws.slice(1);Y2(Vu,"on"+Ku)}Y2(Ai,"onAnimationEnd"),Y2(xi,"onAnimationIteration"),Y2(Oi,"onAnimationStart"),Y2("dblclick","onDoubleClick"),Y2("focusin","onFocus"),Y2("focusout","onBlur"),Y2(uu,"onTransitionRun"),Y2(nu,"onTransitionStart"),Y2(du,"onTransitionCancel"),Y2(Ni,"onTransitionEnd"),ue("onMouseEnter",["mouseout","mouseover"]),ue("onMouseLeave",["mouseout","mouseover"]),ue("onPointerEnter",["pointerout","pointerover"]),ue("onPointerLeave",["pointerout","pointerover"]),B1("onChange","change click focusin focusout input keydown keyup selectionchange".split(" ")),B1("onSelect","focusout contextmenu dragend focusin keydown keyup mousedown mouseup selectionchange".split(" ")),B1("onBeforeInput",["compositionend","keypress","textInput","paste"]),B1("onCompositionEnd","compositionend focusout keydown keypress keyup mousedown".split(" ")),B1("onCompositionStart","compositionstart focusout keydown keypress keyup mousedown".split(" ")),B1("onCompositionUpdate","compositionupdate focusout keydown keypress keyup mousedown".split(" "));var At="abort canplay canplaythrough durationchange emptied encrypted ended error loadeddata loadedmetadata loadstart pause play playing progress ratechange resize seeked seeking stalled suspend timeupdate volumechange waiting".split(" "),Ju=new Set("beforetoggle cancel close invalid load scroll scrollend toggle".split(" ").concat(At));function Wl(e,t){t=(t&4)!==0;for(var s=0;s<e.length;s++){var i=e[s],r=i.event;i=i.listeners;e:{var l=void 0;if(t)for(var a=i.length-1;0<=a;a--){var u=i[a],c=u.instance,y=u.currentTarget;if(u=u.listener,c!==l&&r.isPropagationStopped())break e;l=u,r.currentTarget=y;try{l(r)}catch(A){e3(A)}r.currentTarget=null,l=c}else for(a=0;a<i.length;a++){if(u=i[a],c=u.instance,y=u.currentTarget,u=u.listener,c!==l&&r.isPropagationStopped())break e;l=u,r.currentTarget=y;try{l(r)}catch(A){e3(A)}r.currentTarget=null,l=c}}}}function a0(e,t){var s=t[d4];s===void 0&&(s=t[d4]=new Set);var i=e+"__bubble";s.has(i)||(Fl(t,e,2,!1),s.add(i))}function Fs(e,t,s){var i=0;t&&(i|=4),Fl(s,e,i,t)}var G3="_reactListening"+Math.random().toString(36).slice(2);function Is(e){if(!e[G3]){e[G3]=!0,V5.forEach(function(s){s!=="selectionchange"&&(Ju.has(s)||Fs(s,!1,e),Fs(s,!0,e))});var t=e.nodeType===9?e:e.ownerDocument;t===null||t[G3]||(t[G3]=!0,Fs("selectionchange",!1,t))}}function Fl(e,t,s,i){switch(A6(t)){case 2:var r=Sn;break;case 8:r=bn;break;default:r=p5}s=r.bind(null,t,s,e),r=void 0,!T4||t!=="touchstart"&&t!=="touchmove"&&t!=="wheel"||(r=!0),i?r!==void 0?e.addEventListener(t,s,{capture:!0,passive:r}):e.addEventListener(t,s,!0):r!==void 0?e.addEventListener(t,s,{passive:r}):e.addEventListener(t,s,!1)}function Ps(e,t,s,i,r){var l=i;if((t&1)===0&&(t&2)===0&&i!==null)e:for(;;){if(i===null)return;var a=i.tag;if(a===3||a===4){var u=i.stateNode.containerInfo;if(u===r)break;if(a===4)for(a=i.return;a!==null;){var c=a.tag;if((c===3||c===4)&&a.stateNode.containerInfo===r)return;a=a.return}for(;u!==null;){if(a=re(u),a===null)return;if(c=a.tag,c===5||c===6||c===26||c===27){i=l=a;continue e}u=u.parentNode}}i=i.return}si(function(){var y=l,A=h4(s),U=[];e:{var g=Ci.get(e);if(g!==void 0){var b=Ft,Q=e;switch(e){case"keypress":if(kt(s)===0)break e;case"keydown":case"keyup":b=La;break;case"focusin":Q="focus",b=b4;break;case"focusout":Q="blur",b=b4;break;case"beforeblur":case"afterblur":b=b4;break;case"click":if(s.button===2)break e;case"auxclick":case"dblclick":case"mousedown":case"mousemove":case"mouseup":case"mouseout":case"mouseover":case"contextmenu":b=li;break;case"drag":case"dragend":case"dragenter":case"dragexit":case"dragleave":case"dragover":case"dragstart":case"drop":b=xa;break;case"touchcancel":case"touchend":case"touchmove":case"touchstart":b=Qa;break;case Ai:case xi:case Oi:b=Ca;break;case Ni:b=Va;break;case"scroll":case"scrollend":b=Ea;break;case"wheel":b=Ja;break;case"copy":case"cut":case"paste":b=Ua;break;case"gotpointercapture":case"lostpointercapture":case"pointercancel":case"pointerdown":case"pointermove":case"pointerout":case"pointerover":case"pointerup":b=ui;break;case"toggle":case"beforetoggle":b=$a}var $=(t&4)!==0,N0=!$&&(e==="scroll"||e==="scrollend"),_=$?g!==null?g+"Capture":null:g;$=[];for(var o=y,h;o!==null;){var C=o;if(h=C.stateNode,C=C.tag,C!==5&&C!==26&&C!==27||h===null||_===null||(C=$e(o,_),C!=null&&$.push(xt(o,C,h))),N0)break;o=o.return}0<$.length&&(g=new b(g,Q,null,s,A),U.push({event:g,listeners:$}))}}if((t&7)===0){e:{if(g=e==="mouseover"||e==="pointerover",b=e==="mouseout"||e==="pointerout",g&&s!==f4&&(Q=s.relatedTarget||s.fromElement)&&(re(Q)||Q[ie]))break e;if((b||g)&&(g=A.window===A?A:(g=A.ownerDocument)?g.defaultView||g.parentWindow:window,b?(Q=s.relatedTarget||s.toElement,b=y,Q=Q?re(Q):null,Q!==null&&(N0=E(Q),$=Q.tag,Q!==N0||$!==5&&$!==27&&$!==6)&&(Q=null)):(b=null,Q=y),b!==Q)){if($=li,C="onMouseLeave",_="onMouseEnter",o="mouse",(e==="pointerout"||e==="pointerover")&&($=ui,C="onPointerLeave",_="onPointerEnter",o="pointer"),N0=b==null?g:we(b),h=Q==null?g:we(Q),g=new $(C,o+"leave",b,s,A),g.target=N0,g.relatedTarget=h,C=null,re(A)===y&&($=new $(_,o+"enter",Q,s,A),$.target=h,$.relatedTarget=N0,C=$),N0=C,b&&Q)t:{for($=wu,_=b,o=Q,h=0,C=_;C;C=$(C))h++;C=0;for(var J=o;J;J=$(J))C++;for(;0<h-C;)_=$(_),h--;for(;0<C-h;)o=$(o),C--;for(;h--;){if(_===o||o!==null&&_===o.alternate){$=_;break t}_=$(_),o=$(o)}$=null}else $=null;b!==null&&Il(U,g,b,$,!1),Q!==null&&N0!==null&&Il(U,N0,Q,$,!0)}}e:{if(g=y?we(y):window,b=g.nodeName&&g.nodeName.toLowerCase(),b==="select"||b==="input"&&g.type==="file")var v0=fi;else if(pi(g))if(hi)v0=ru;else{v0=su;var V=tu}else b=g.nodeName,!b||b.toLowerCase()!=="input"||g.type!=="checkbox"&&g.type!=="radio"?y&&_4(y.elementType)&&(v0=fi):v0=iu;if(v0&&(v0=v0(e,y))){_i(U,v0,s,A);break e}V&&V(e,g,y),e==="focusout"&&y&&g.type==="number"&&y.memoizedProps.value!=null&&p4(g,"number",g.value)}switch(V=y?we(y):window,e){case"focusin":(pi(V)||V.contentEditable==="true")&&(pe=V,O4=y,st=null);break;case"focusout":st=O4=pe=null;break;case"mousedown":N4=!0;break;case"contextmenu":case"mouseup":case"dragend":N4=!1,Mi(U,s,A);break;case"selectionchange":if(au)break;case"keydown":case"keyup":Mi(U,s,A)}var s0;if(M4)e:{switch(e){case"compositionstart":var o0="onCompositionStart";break e;case"compositionend":o0="onCompositionEnd";break e;case"compositionupdate":o0="onCompositionUpdate";break e}o0=void 0}else me?oi(e,s)&&(o0="onCompositionEnd"):e==="keydown"&&s.keyCode===229&&(o0="onCompositionStart");o0&&(ni&&s.locale!=="ko"&&(me||o0!=="onCompositionStart"?o0==="onCompositionEnd"&&me&&(s0=ii()):(_1=A,v4="value"in _1?_1.value:_1.textContent,me=!0)),V=X3(y,o0),0<V.length&&(o0=new ai(o0,e,null,s,A),U.push({event:o0,listeners:V}),s0?o0.data=s0:(s0=mi(s),s0!==null&&(o0.data=s0)))),(s0=Wa?Fa(e,s):Ia(e,s))&&(o0=X3(y,"onBeforeInput"),0<o0.length&&(V=new ai("onBeforeInput","beforeinput",null,s,A),U.push({event:V,listeners:o0}),V.data=s0)),Zu(U,e,y,s,A)}Wl(U,t)})}function xt(e,t,s){return{instance:e,listener:t,currentTarget:s}}function X3(e,t){for(var s=t+"Capture",i=[];e!==null;){var r=e,l=r.stateNode;if(r=r.tag,r!==5&&r!==26&&r!==27||l===null||(r=$e(e,s),r!=null&&i.unshift(xt(e,r,l)),r=$e(e,t),r!=null&&i.push(xt(e,r,l))),e.tag===3)return i;e=e.return}return[]}function wu(e){if(e===null)return null;do e=e.return;while(e&&e.tag!==5&&e.tag!==27);return e||null}function Il(e,t,s,i,r){for(var l=t._reactName,a=[];s!==null&&s!==i;){var u=s,c=u.alternate,y=u.stateNode;if(u=u.tag,c!==null&&c===i)break;u!==5&&u!==26&&u!==27||y===null||(c=y,r?(y=$e(s,l),y!=null&&a.unshift(xt(s,y,c))):r||(y=$e(s,l),y!=null&&a.push(xt(s,y,c)))),s=s.return}a.length!==0&&e.push({event:t,listeners:a})}var $u=/\r\n?/g,ku=/\u0000|\uFFFD/g;function Pl(e){return(typeof e=="string"?e:""+e).replace($u,`
`).replace(ku,"")}function e6(e,t){return t=Pl(t),Pl(e)===t}function O0(e,t,s,i,r,l){switch(s){case"children":typeof i=="string"?t==="body"||t==="textarea"&&i===""||de(e,i):(typeof i=="number"||typeof i=="bigint")&&t!=="body"&&de(e,""+i);break;case"className":Kt(e,"class",i);break;case"tabIndex":Kt(e,"tabindex",i);break;case"dir":case"role":case"viewBox":case"width":case"height":Kt(e,s,i);break;case"style":ei(e,i,l);break;case"data":if(t!=="object"){Kt(e,"data",i);break}case"src":case"href":if(i===""&&(t!=="a"||s!=="href")){e.removeAttribute(s);break}if(i==null||typeof i=="function"||typeof i=="symbol"||typeof i=="boolean"){e.removeAttribute(s);break}i=wt(""+i),e.setAttribute(s,i);break;case"action":case"formAction":if(typeof i=="function"){e.setAttribute(s,"javascript:throw new Error('A React form was unexpectedly submitted. If you called form.submit() manually, consider using form.requestSubmit() instead. If you\\'re trying to use event.stopPropagation() in a submit event handler, consider also calling event.preventDefault().')");break}else typeof l=="function"&&(s==="formAction"?(t!=="input"&&O0(e,t,"name",r.name,r,null),O0(e,t,"formEncType",r.formEncType,r,null),O0(e,t,"formMethod",r.formMethod,r,null),O0(e,t,"formTarget",r.formTarget,r,null)):(O0(e,t,"encType",r.encType,r,null),O0(e,t,"method",r.method,r,null),O0(e,t,"target",r.target,r,null)));if(i==null||typeof i=="symbol"||typeof i=="boolean"){e.removeAttribute(s);break}i=wt(""+i),e.setAttribute(s,i);break;case"onClick":i!=null&&(e.onclick=$2);break;case"onScroll":i!=null&&a0("scroll",e);break;case"onScrollEnd":i!=null&&a0("scrollend",e);break;case"dangerouslySetInnerHTML":if(i!=null){if(typeof i!="object"||!("__html"in i))throw Error(n(61));if(s=i.__html,s!=null){if(r.children!=null)throw Error(n(60));e.innerHTML=s}}break;case"multiple":e.multiple=i&&typeof i!="function"&&typeof i!="symbol";break;case"muted":e.muted=i&&typeof i!="function"&&typeof i!="symbol";break;case"suppressContentEditableWarning":case"suppressHydrationWarning":case"defaultValue":case"defaultChecked":case"innerHTML":case"ref":break;case"autoFocus":break;case"xlinkHref":if(i==null||typeof i=="function"||typeof i=="boolean"||typeof i=="symbol"){e.removeAttribute("xlink:href");break}s=wt(""+i),e.setAttributeNS("http://www.w3.org/1999/xlink","xlink:href",s);break;case"contentEditable":case"spellCheck":case"draggable":case"value":case"autoReverse":case"externalResourcesRequired":case"focusable":case"preserveAlpha":i!=null&&typeof i!="function"&&typeof i!="symbol"?e.setAttribute(s,""+i):e.removeAttribute(s);break;case"inert":case"allowFullScreen":case"async":case"autoPlay":case"controls":case"default":case"defer":case"disabled":case"disablePictureInPicture":case"disableRemotePlayback":case"formNoValidate":case"hidden":case"loop":case"noModule":case"noValidate":case"open":case"playsInline":case"readOnly":case"required":case"reversed":case"scoped":case"seamless":case"itemScope":i&&typeof i!="function"&&typeof i!="symbol"?e.setAttribute(s,""):e.removeAttribute(s);break;case"capture":case"download":i===!0?e.setAttribute(s,""):i!==!1&&i!=null&&typeof i!="function"&&typeof i!="symbol"?e.setAttribute(s,i):e.removeAttribute(s);break;case"cols":case"rows":case"size":case"span":i!=null&&typeof i!="function"&&typeof i!="symbol"&&!isNaN(i)&&1<=i?e.setAttribute(s,i):e.removeAttribute(s);break;case"rowSpan":case"start":i==null||typeof i=="function"||typeof i=="symbol"||isNaN(i)?e.removeAttribute(s):e.setAttribute(s,i);break;case"popover":a0("beforetoggle",e),a0("toggle",e),Vt(e,"popover",i);break;case"xlinkActuate":w2(e,"http://www.w3.org/1999/xlink","xlink:actuate",i);break;case"xlinkArcrole":w2(e,"http://www.w3.org/1999/xlink","xlink:arcrole",i);break;case"xlinkRole":w2(e,"http://www.w3.org/1999/xlink","xlink:role",i);break;case"xlinkShow":w2(e,"http://www.w3.org/1999/xlink","xlink:show",i);break;case"xlinkTitle":w2(e,"http://www.w3.org/1999/xlink","xlink:title",i);break;case"xlinkType":w2(e,"http://www.w3.org/1999/xlink","xlink:type",i);break;case"xmlBase":w2(e,"http://www.w3.org/XML/1998/namespace","xml:base",i);break;case"xmlLang":w2(e,"http://www.w3.org/XML/1998/namespace","xml:lang",i);break;case"xmlSpace":w2(e,"http://www.w3.org/XML/1998/namespace","xml:space",i);break;case"is":Vt(e,"is",i);break;case"innerText":case"textContent":break;default:(!(2<s.length)||s[0]!=="o"&&s[0]!=="O"||s[1]!=="n"&&s[1]!=="N")&&(s=za.get(s)||s,Vt(e,s,i))}}function e5(e,t,s,i,r,l){switch(s){case"style":ei(e,i,l);break;case"dangerouslySetInnerHTML":if(i!=null){if(typeof i!="object"||!("__html"in i))throw Error(n(61));if(s=i.__html,s!=null){if(r.children!=null)throw Error(n(60));e.innerHTML=s}}break;case"children":typeof i=="string"?de(e,i):(typeof i=="number"||typeof i=="bigint")&&de(e,""+i);break;case"onScroll":i!=null&&a0("scroll",e);break;case"onScrollEnd":i!=null&&a0("scrollend",e);break;case"onClick":i!=null&&(e.onclick=$2);break;case"suppressContentEditableWarning":case"suppressHydrationWarning":case"innerHTML":case"ref":break;case"innerText":case"textContent":break;default:if(!K5.hasOwnProperty(s))e:{if(s[0]==="o"&&s[1]==="n"&&(r=s.endsWith("Capture"),t=s.slice(2,r?s.length-7:void 0),l=e[d2]||null,l=l!=null?l[s]:null,typeof l=="function"&&e.removeEventListener(t,l,r),typeof i=="function")){typeof l!="function"&&l!==null&&(s in e?e[s]=null:e.hasAttribute(s)&&e.removeAttribute(s)),e.addEventListener(t,i,r);break e}s in e?e[s]=i:i===!0?e.setAttribute(s,""):Vt(e,s,i)}}}function s2(e,t,s){switch(t){case"div":case"span":case"svg":case"path":case"a":case"g":case"p":case"li":break;case"img":a0("error",e),a0("load",e);var i=!1,r=!1,l;for(l in s)if(s.hasOwnProperty(l)){var a=s[l];if(a!=null)switch(l){case"src":i=!0;break;case"srcSet":r=!0;break;case"children":case"dangerouslySetInnerHTML":throw Error(n(137,t));default:O0(e,t,l,a,s,null)}}r&&O0(e,t,"srcSet",s.srcSet,s,null),i&&O0(e,t,"src",s.src,s,null);return;case"input":a0("invalid",e);var u=l=a=r=null,c=null,y=null;for(i in s)if(s.hasOwnProperty(i)){var A=s[i];if(A!=null)switch(i){case"name":r=A;break;case"type":a=A;break;case"checked":c=A;break;case"defaultChecked":y=A;break;case"value":l=A;break;case"defaultValue":u=A;break;case"children":case"dangerouslySetInnerHTML":if(A!=null)throw Error(n(137,t));break;default:O0(e,t,i,A,s,null)}}W5(e,l,u,c,y,a,r,!1);return;case"select":a0("invalid",e),i=a=l=null;for(r in s)if(s.hasOwnProperty(r)&&(u=s[r],u!=null))switch(r){case"value":l=u;break;case"defaultValue":a=u;break;case"multiple":i=u;default:O0(e,t,r,u,s,null)}t=l,s=a,e.multiple=!!i,t!=null?ne(e,!!i,t,!1):s!=null&&ne(e,!!i,s,!0);return;case"textarea":a0("invalid",e),l=r=i=null;for(a in s)if(s.hasOwnProperty(a)&&(u=s[a],u!=null))switch(a){case"value":i=u;break;case"defaultValue":r=u;break;case"children":l=u;break;case"dangerouslySetInnerHTML":if(u!=null)throw Error(n(91));break;default:O0(e,t,a,u,s,null)}I5(e,i,r,l);return;case"option":for(c in s)if(s.hasOwnProperty(c)&&(i=s[c],i!=null))switch(c){case"selected":e.selected=i&&typeof i!="function"&&typeof i!="symbol";break;default:O0(e,t,c,i,s,null)}return;case"dialog":a0("beforetoggle",e),a0("toggle",e),a0("cancel",e),a0("close",e);break;case"iframe":case"object":a0("load",e);break;case"video":case"audio":for(i=0;i<At.length;i++)a0(At[i],e);break;case"image":a0("error",e),a0("load",e);break;case"details":a0("toggle",e);break;case"embed":case"source":case"link":a0("error",e),a0("load",e);case"area":case"base":case"br":case"col":case"hr":case"keygen":case"meta":case"param":case"track":case"wbr":case"menuitem":for(y in s)if(s.hasOwnProperty(y)&&(i=s[y],i!=null))switch(y){case"children":case"dangerouslySetInnerHTML":throw Error(n(137,t));default:O0(e,t,y,i,s,null)}return;default:if(_4(t)){for(A in s)s.hasOwnProperty(A)&&(i=s[A],i!==void 0&&e5(e,t,A,i,s,void 0));return}}for(u in s)s.hasOwnProperty(u)&&(i=s[u],i!=null&&O0(e,t,u,i,s,null))}function Wu(e,t,s,i){switch(t){case"div":case"span":case"svg":case"path":case"a":case"g":case"p":case"li":break;case"input":var r=null,l=null,a=null,u=null,c=null,y=null,A=null;for(b in s){var U=s[b];if(s.hasOwnProperty(b)&&U!=null)switch(b){case"checked":break;case"value":break;case"defaultValue":c=U;default:i.hasOwnProperty(b)||O0(e,t,b,null,i,U)}}for(var g in i){var b=i[g];if(U=s[g],i.hasOwnProperty(g)&&(b!=null||U!=null))switch(g){case"type":l=b;break;case"name":r=b;break;case"checked":y=b;break;case"defaultChecked":A=b;break;case"value":a=b;break;case"defaultValue":u=b;break;case"children":case"dangerouslySetInnerHTML":if(b!=null)throw Error(n(137,t));break;default:b!==U&&O0(e,t,g,b,i,U)}}m4(e,a,u,c,y,A,l,r);return;case"select":b=a=u=g=null;for(l in s)if(c=s[l],s.hasOwnProperty(l)&&c!=null)switch(l){case"value":break;case"multiple":b=c;default:i.hasOwnProperty(l)||O0(e,t,l,null,i,c)}for(r in i)if(l=i[r],c=s[r],i.hasOwnProperty(r)&&(l!=null||c!=null))switch(r){case"value":g=l;break;case"defaultValue":u=l;break;case"multiple":a=l;default:l!==c&&O0(e,t,r,l,i,c)}t=u,s=a,i=b,g!=null?ne(e,!!s,g,!1):!!i!=!!s&&(t!=null?ne(e,!!s,t,!0):ne(e,!!s,s?[]:"",!1));return;case"textarea":b=g=null;for(u in s)if(r=s[u],s.hasOwnProperty(u)&&r!=null&&!i.hasOwnProperty(u))switch(u){case"value":break;case"children":break;default:O0(e,t,u,null,i,r)}for(a in i)if(r=i[a],l=s[a],i.hasOwnProperty(a)&&(r!=null||l!=null))switch(a){case"value":g=r;break;case"defaultValue":b=r;break;case"children":break;case"dangerouslySetInnerHTML":if(r!=null)throw Error(n(91));break;default:r!==l&&O0(e,t,a,r,i,l)}F5(e,g,b);return;case"option":for(var Q in s)if(g=s[Q],s.hasOwnProperty(Q)&&g!=null&&!i.hasOwnProperty(Q))switch(Q){case"selected":e.selected=!1;break;default:O0(e,t,Q,null,i,g)}for(c in i)if(g=i[c],b=s[c],i.hasOwnProperty(c)&&g!==b&&(g!=null||b!=null))switch(c){case"selected":e.selected=g&&typeof g!="function"&&typeof g!="symbol";break;default:O0(e,t,c,g,i,b)}return;case"img":case"link":case"area":case"base":case"br":case"col":case"embed":case"hr":case"keygen":case"meta":case"param":case"source":case"track":case"wbr":case"menuitem":for(var $ in s)g=s[$],s.hasOwnProperty($)&&g!=null&&!i.hasOwnProperty($)&&O0(e,t,$,null,i,g);for(y in i)if(g=i[y],b=s[y],i.hasOwnProperty(y)&&g!==b&&(g!=null||b!=null))switch(y){case"children":case"dangerouslySetInnerHTML":if(g!=null)throw Error(n(137,t));break;default:O0(e,t,y,g,i,b)}return;default:if(_4(t)){for(var N0 in s)g=s[N0],s.hasOwnProperty(N0)&&g!==void 0&&!i.hasOwnProperty(N0)&&e5(e,t,N0,void 0,i,g);for(A in i)g=i[A],b=s[A],!i.hasOwnProperty(A)||g===b||g===void 0&&b===void 0||e5(e,t,A,g,i,b);return}}for(var _ in s)g=s[_],s.hasOwnProperty(_)&&g!=null&&!i.hasOwnProperty(_)&&O0(e,t,_,null,i,g);for(U in i)g=i[U],b=s[U],!i.hasOwnProperty(U)||g===b||g==null&&b==null||O0(e,t,U,g,i,b)}function t6(e){switch(e){case"css":case"script":case"font":case"img":case"image":case"input":case"link":return!0;default:return!1}}function Fu(){if(typeof performance.getEntriesByType=="function"){for(var e=0,t=0,s=performance.getEntriesByType("resource"),i=0;i<s.length;i++){var r=s[i],l=r.transferSize,a=r.initiatorType,u=r.duration;if(l&&u&&t6(a)){for(a=0,u=r.responseEnd,i+=1;i<s.length;i++){var c=s[i],y=c.startTime;if(y>u)break;var A=c.transferSize,U=c.initiatorType;A&&t6(U)&&(c=c.responseEnd,a+=A*(c<u?1:(u-y)/(c-y)))}if(--i,t+=8*(l+a)/(r.duration/1e3),e++,10<e)break}}if(0<e)return t/e/1e6}return navigator.connection&&(e=navigator.connection.downlink,typeof e=="number")?e:5}var t5=null,s5=null;function Q3(e){return e.nodeType===9?e:e.ownerDocument}function s6(e){switch(e){case"http://www.w3.org/2000/svg":return 1;case"http://www.w3.org/1998/Math/MathML":return 2;default:return 0}}function i6(e,t){if(e===0)switch(t){case"svg":return 1;case"math":return 2;default:return 0}return e===1&&t==="foreignObject"?0:e}function i5(e,t){return e==="textarea"||e==="noscript"||typeof t.children=="string"||typeof t.children=="number"||typeof t.children=="bigint"||typeof t.dangerouslySetInnerHTML=="object"&&t.dangerouslySetInnerHTML!==null&&t.dangerouslySetInnerHTML.__html!=null}var r5=null;function Iu(){var e=window.event;return e&&e.type==="popstate"?e===r5?!1:(r5=e,!0):(r5=null,!1)}var r6=typeof setTimeout=="function"?setTimeout:void 0,Pu=typeof clearTimeout=="function"?clearTimeout:void 0,l6=typeof Promise=="function"?Promise:void 0,en=typeof queueMicrotask=="function"?queueMicrotask:typeof l6<"u"?function(e){return l6.resolve(null).then(e).catch(tn)}:r6;function tn(e){setTimeout(function(){throw e})}function D1(e){return e==="head"}function a6(e,t){var s=t,i=0;do{var r=s.nextSibling;if(e.removeChild(s),r&&r.nodeType===8)if(s=r.data,s==="/$"||s==="/&"){if(i===0){e.removeChild(r),Ge(t);return}i--}else if(s==="$"||s==="$?"||s==="$~"||s==="$!"||s==="&")i++;else if(s==="html")Ot(e.ownerDocument.documentElement);else if(s==="head"){s=e.ownerDocument.head,Ot(s);for(var l=s.firstChild;l;){var a=l.nextSibling,u=l.nodeName;l[Je]||u==="SCRIPT"||u==="STYLE"||u==="LINK"&&l.rel.toLowerCase()==="stylesheet"||s.removeChild(l),l=a}}else s==="body"&&Ot(e.ownerDocument.body);s=r}while(s);Ge(t)}function u6(e,t){var s=e;e=0;do{var i=s.nextSibling;if(s.nodeType===1?t?(s._stashedDisplay=s.style.display,s.style.display="none"):(s.style.display=s._stashedDisplay||"",s.getAttribute("style")===""&&s.removeAttribute("style")):s.nodeType===3&&(t?(s._stashedText=s.nodeValue,s.nodeValue=""):s.nodeValue=s._stashedText||""),i&&i.nodeType===8)if(s=i.data,s==="/$"){if(e===0)break;e--}else s!=="$"&&s!=="$?"&&s!=="$~"&&s!=="$!"||e++;s=i}while(s)}function l5(e){var t=e.firstChild;for(t&&t.nodeType===10&&(t=t.nextSibling);t;){var s=t;switch(t=t.nextSibling,s.nodeName){case"HTML":case"HEAD":case"BODY":l5(s),c4(s);continue;case"SCRIPT":case"STYLE":continue;case"LINK":if(s.rel.toLowerCase()==="stylesheet")continue}e.removeChild(s)}}function sn(e,t,s,i){for(;e.nodeType===1;){var r=s;if(e.nodeName.toLowerCase()!==t.toLowerCase()){if(!i&&(e.nodeName!=="INPUT"||e.type!=="hidden"))break}else if(i){if(!e[Je])switch(t){case"meta":if(!e.hasAttribute("itemprop"))break;return e;case"link":if(l=e.getAttribute("rel"),l==="stylesheet"&&e.hasAttribute("data-precedence"))break;if(l!==r.rel||e.getAttribute("href")!==(r.href==null||r.href===""?null:r.href)||e.getAttribute("crossorigin")!==(r.crossOrigin==null?null:r.crossOrigin)||e.getAttribute("title")!==(r.title==null?null:r.title))break;return e;case"style":if(e.hasAttribute("data-precedence"))break;return e;case"script":if(l=e.getAttribute("src"),(l!==(r.src==null?null:r.src)||e.getAttribute("type")!==(r.type==null?null:r.type)||e.getAttribute("crossorigin")!==(r.crossOrigin==null?null:r.crossOrigin))&&l&&e.hasAttribute("async")&&!e.hasAttribute("itemprop"))break;return e;default:return e}}else if(t==="input"&&e.type==="hidden"){var l=r.name==null?null:""+r.name;if(r.type==="hidden"&&e.getAttribute("name")===l)return e}else return e;if(e=j2(e.nextSibling),e===null)break}return null}function rn(e,t,s){if(t==="")return null;for(;e.nodeType!==3;)if((e.nodeType!==1||e.nodeName!=="INPUT"||e.type!=="hidden")&&!s||(e=j2(e.nextSibling),e===null))return null;return e}function n6(e,t){for(;e.nodeType!==8;)if((e.nodeType!==1||e.nodeName!=="INPUT"||e.type!=="hidden")&&!t||(e=j2(e.nextSibling),e===null))return null;return e}function a5(e){return e.data==="$?"||e.data==="$~"}function u5(e){return e.data==="$!"||e.data==="$?"&&e.ownerDocument.readyState!=="loading"}function ln(e,t){var s=e.ownerDocument;if(e.data==="$~")e._reactRetry=t;else if(e.data!=="$?"||s.readyState!=="loading")t();else{var i=function(){t(),s.removeEventListener("DOMContentLoaded",i)};s.addEventListener("DOMContentLoaded",i),e._reactRetry=i}}function j2(e){for(;e!=null;e=e.nextSibling){var t=e.nodeType;if(t===1||t===3)break;if(t===8){if(t=e.data,t==="$"||t==="$!"||t==="$?"||t==="$~"||t==="&"||t==="F!"||t==="F")break;if(t==="/$"||t==="/&")return null}}return e}var n5=null;function d6(e){e=e.nextSibling;for(var t=0;e;){if(e.nodeType===8){var s=e.data;if(s==="/$"||s==="/&"){if(t===0)return j2(e.nextSibling);t--}else s!=="$"&&s!=="$!"&&s!=="$?"&&s!=="$~"&&s!=="&"||t++}e=e.nextSibling}return null}function c6(e){e=e.previousSibling;for(var t=0;e;){if(e.nodeType===8){var s=e.data;if(s==="$"||s==="$!"||s==="$?"||s==="$~"||s==="&"){if(t===0)return e;t--}else s!=="/$"&&s!=="/&"||t++}e=e.previousSibling}return null}function o6(e,t,s){switch(t=Q3(s),e){case"html":if(e=t.documentElement,!e)throw Error(n(452));return e;case"head":if(e=t.head,!e)throw Error(n(453));return e;case"body":if(e=t.body,!e)throw Error(n(454));return e;default:throw Error(n(451))}}function Ot(e){for(var t=e.attributes;t.length;)e.removeAttributeNode(t[0]);c4(e)}var H2=new Map,m6=new Set;function Z3(e){return typeof e.getRootNode=="function"?e.getRootNode():e.nodeType===9?e:e.ownerDocument}var c1=L.d;L.d={f:an,r:un,D:nn,C:dn,L:cn,m:on,X:pn,S:mn,M:_n};function an(){var e=c1.f(),t=j3();return e||t}function un(e){var t=le(e);t!==null&&t.tag===5&&t.type==="form"?Nr(t):c1.r(e)}var Ye=typeof document>"u"?null:document;function p6(e,t,s){var i=Ye;if(i&&typeof t=="string"&&t){var r=x2(t);r='link[rel="'+e+'"][href="'+r+'"]',typeof s=="string"&&(r+='[crossorigin="'+s+'"]'),m6.has(r)||(m6.add(r),e={rel:e,crossOrigin:s,href:t},i.querySelector(r)===null&&(t=i.createElement("link"),s2(t,"link",e),k0(t),i.head.appendChild(t)))}}function nn(e){c1.D(e),p6("dns-prefetch",e,null)}function dn(e,t){c1.C(e,t),p6("preconnect",e,t)}function cn(e,t,s){c1.L(e,t,s);var i=Ye;if(i&&e&&t){var r='link[rel="preload"][as="'+x2(t)+'"]';t==="image"&&s&&s.imageSrcSet?(r+='[imagesrcset="'+x2(s.imageSrcSet)+'"]',typeof s.imageSizes=="string"&&(r+='[imagesizes="'+x2(s.imageSizes)+'"]')):r+='[href="'+x2(e)+'"]';var l=r;switch(t){case"style":l=Be(e);break;case"script":l=Le(e)}H2.has(l)||(e=Y({rel:"preload",href:t==="image"&&s&&s.imageSrcSet?void 0:e,as:t},s),H2.set(l,e),i.querySelector(r)!==null||t==="style"&&i.querySelector(Nt(l))||t==="script"&&i.querySelector(Ct(l))||(t=i.createElement("link"),s2(t,"link",e),k0(t),i.head.appendChild(t)))}}function on(e,t){c1.m(e,t);var s=Ye;if(s&&e){var i=t&&typeof t.as=="string"?t.as:"script",r='link[rel="modulepreload"][as="'+x2(i)+'"][href="'+x2(e)+'"]',l=r;switch(i){case"audioworklet":case"paintworklet":case"serviceworker":case"sharedworker":case"worker":case"script":l=Le(e)}if(!H2.has(l)&&(e=Y({rel:"modulepreload",href:e},t),H2.set(l,e),s.querySelector(r)===null)){switch(i){case"audioworklet":case"paintworklet":case"serviceworker":case"sharedworker":case"worker":case"script":if(s.querySelector(Ct(l)))return}i=s.createElement("link"),s2(i,"link",e),k0(i),s.head.appendChild(i)}}}function mn(e,t,s){c1.S(e,t,s);var i=Ye;if(i&&e){var r=ae(i).hoistableStyles,l=Be(e);t=t||"default";var a=r.get(l);if(!a){var u={loading:0,preload:null};if(a=i.querySelector(Nt(l)))u.loading=5;else{e=Y({rel:"stylesheet",href:e,"data-precedence":t},s),(s=H2.get(l))&&d5(e,s);var c=a=i.createElement("link");k0(c),s2(c,"link",e),c._p=new Promise(function(y,A){c.onload=y,c.onerror=A}),c.addEventListener("load",function(){u.loading|=1}),c.addEventListener("error",function(){u.loading|=2}),u.loading|=4,V3(a,t,i)}a={type:"stylesheet",instance:a,count:1,state:u},r.set(l,a)}}}function pn(e,t){c1.X(e,t);var s=Ye;if(s&&e){var i=ae(s).hoistableScripts,r=Le(e),l=i.get(r);l||(l=s.querySelector(Ct(r)),l||(e=Y({src:e,async:!0},t),(t=H2.get(r))&&c5(e,t),l=s.createElement("script"),k0(l),s2(l,"link",e),s.head.appendChild(l)),l={type:"script",instance:l,count:1,state:null},i.set(r,l))}}function _n(e,t){c1.M(e,t);var s=Ye;if(s&&e){var i=ae(s).hoistableScripts,r=Le(e),l=i.get(r);l||(l=s.querySelector(Ct(r)),l||(e=Y({src:e,async:!0,type:"module"},t),(t=H2.get(r))&&c5(e,t),l=s.createElement("script"),k0(l),s2(l,"link",e),s.head.appendChild(l)),l={type:"script",instance:l,count:1,state:null},i.set(r,l))}}function _6(e,t,s,i){var r=(r=H.current)?Z3(r):null;if(!r)throw Error(n(446));switch(e){case"meta":case"title":return null;case"style":return typeof s.precedence=="string"&&typeof s.href=="string"?(t=Be(s.href),s=ae(r).hoistableStyles,i=s.get(t),i||(i={type:"style",instance:null,count:0,state:null},s.set(t,i)),i):{type:"void",instance:null,count:0,state:null};case"link":if(s.rel==="stylesheet"&&typeof s.href=="string"&&typeof s.precedence=="string"){e=Be(s.href);var l=ae(r).hoistableStyles,a=l.get(e);if(a||(r=r.ownerDocument||r,a={type:"stylesheet",instance:null,count:0,state:{loading:0,preload:null}},l.set(e,a),(l=r.querySelector(Nt(e)))&&!l._p&&(a.instance=l,a.state.loading=5),H2.has(e)||(s={rel:"preload",as:"style",href:s.href,crossOrigin:s.crossOrigin,integrity:s.integrity,media:s.media,hrefLang:s.hrefLang,referrerPolicy:s.referrerPolicy},H2.set(e,s),l||fn(r,e,s,a.state))),t&&i===null)throw Error(n(528,""));return a}if(t&&i!==null)throw Error(n(529,""));return null;case"script":return t=s.async,s=s.src,typeof s=="string"&&t&&typeof t!="function"&&typeof t!="symbol"?(t=Le(s),s=ae(r).hoistableScripts,i=s.get(t),i||(i={type:"script",instance:null,count:0,state:null},s.set(t,i)),i):{type:"void",instance:null,count:0,state:null};default:throw Error(n(444,e))}}function Be(e){return'href="'+x2(e)+'"'}function Nt(e){return'link[rel="stylesheet"]['+e+"]"}function f6(e){return Y({},e,{"data-precedence":e.precedence,precedence:null})}function fn(e,t,s,i){e.querySelector('link[rel="preload"][as="style"]['+t+"]")?i.loading=1:(t=e.createElement("link"),i.preload=t,t.addEventListener("load",function(){return i.loading|=1}),t.addEventListener("error",function(){return i.loading|=2}),s2(t,"link",s),k0(t),e.head.appendChild(t))}function Le(e){return'[src="'+x2(e)+'"]'}function Ct(e){return"script[async]"+e}function h6(e,t,s){if(t.count++,t.instance===null)switch(t.type){case"style":var i=e.querySelector('style[data-href~="'+x2(s.href)+'"]');if(i)return t.instance=i,k0(i),i;var r=Y({},s,{"data-href":s.href,"data-precedence":s.precedence,href:null,precedence:null});return i=(e.ownerDocument||e).createElement("style"),k0(i),s2(i,"style",r),V3(i,s.precedence,e),t.instance=i;case"stylesheet":r=Be(s.href);var l=e.querySelector(Nt(r));if(l)return t.state.loading|=4,t.instance=l,k0(l),l;i=f6(s),(r=H2.get(r))&&d5(i,r),l=(e.ownerDocument||e).createElement("link"),k0(l);var a=l;return a._p=new Promise(function(u,c){a.onload=u,a.onerror=c}),s2(l,"link",i),t.state.loading|=4,V3(l,s.precedence,e),t.instance=l;case"script":return l=Le(s.src),(r=e.querySelector(Ct(l)))?(t.instance=r,k0(r),r):(i=s,(r=H2.get(l))&&(i=Y({},s),c5(i,r)),e=e.ownerDocument||e,r=e.createElement("script"),k0(r),s2(r,"link",i),e.head.appendChild(r),t.instance=r);case"void":return null;default:throw Error(n(443,t.type))}else t.type==="stylesheet"&&(t.state.loading&4)===0&&(i=t.instance,t.state.loading|=4,V3(i,s.precedence,e));return t.instance}function V3(e,t,s){for(var i=s.querySelectorAll('link[rel="stylesheet"][data-precedence],style[data-precedence]'),r=i.length?i[i.length-1]:null,l=r,a=0;a<i.length;a++){var u=i[a];if(u.dataset.precedence===t)l=u;else if(l!==r)break}l?l.parentNode.insertBefore(e,l.nextSibling):(t=s.nodeType===9?s.head:s,t.insertBefore(e,t.firstChild))}function d5(e,t){e.crossOrigin==null&&(e.crossOrigin=t.crossOrigin),e.referrerPolicy==null&&(e.referrerPolicy=t.referrerPolicy),e.title==null&&(e.title=t.title)}function c5(e,t){e.crossOrigin==null&&(e.crossOrigin=t.crossOrigin),e.referrerPolicy==null&&(e.referrerPolicy=t.referrerPolicy),e.integrity==null&&(e.integrity=t.integrity)}var K3=null;function y6(e,t,s){if(K3===null){var i=new Map,r=K3=new Map;r.set(s,i)}else r=K3,i=r.get(s),i||(i=new Map,r.set(s,i));if(i.has(e))return i;for(i.set(e,null),s=s.getElementsByTagName(e),r=0;r<s.length;r++){var l=s[r];if(!(l[Je]||l[I0]||e==="link"&&l.getAttribute("rel")==="stylesheet")&&l.namespaceURI!=="http://www.w3.org/2000/svg"){var a=l.getAttribute(t)||"";a=e+a;var u=i.get(a);u?u.push(l):i.set(a,[l])}}return i}function T6(e,t,s){e=e.ownerDocument||e,e.head.insertBefore(s,t==="title"?e.querySelector("head > title"):null)}function hn(e,t,s){if(s===1||t.itemProp!=null)return!1;switch(e){case"meta":case"title":return!0;case"style":if(typeof t.precedence!="string"||typeof t.href!="string"||t.href==="")break;return!0;case"link":if(typeof t.rel!="string"||typeof t.href!="string"||t.href===""||t.onLoad||t.onError)break;switch(t.rel){case"stylesheet":return e=t.disabled,typeof t.precedence=="string"&&e==null;default:return!0}case"script":if(t.async&&typeof t.async!="function"&&typeof t.async!="symbol"&&!t.onLoad&&!t.onError&&t.src&&typeof t.src=="string")return!0}return!1}function v6(e){return!(e.type==="stylesheet"&&(e.state.loading&3)===0)}function yn(e,t,s,i){if(s.type==="stylesheet"&&(typeof i.media!="string"||matchMedia(i.media).matches!==!1)&&(s.state.loading&4)===0){if(s.instance===null){var r=Be(i.href),l=t.querySelector(Nt(r));if(l){t=l._p,t!==null&&typeof t=="object"&&typeof t.then=="function"&&(e.count++,e=J3.bind(e),t.then(e,e)),s.state.loading|=4,s.instance=l,k0(l);return}l=t.ownerDocument||t,i=f6(i),(r=H2.get(r))&&d5(i,r),l=l.createElement("link"),k0(l);var a=l;a._p=new Promise(function(u,c){a.onload=u,a.onerror=c}),s2(l,"link",i),s.instance=l}e.stylesheets===null&&(e.stylesheets=new Map),e.stylesheets.set(s,t),(t=s.state.preload)&&(s.state.loading&3)===0&&(e.count++,s=J3.bind(e),t.addEventListener("load",s),t.addEventListener("error",s))}}var o5=0;function Tn(e,t){return e.stylesheets&&e.count===0&&$3(e,e.stylesheets),0<e.count||0<e.imgCount?function(s){var i=setTimeout(function(){if(e.stylesheets&&$3(e,e.stylesheets),e.unsuspend){var l=e.unsuspend;e.unsuspend=null,l()}},6e4+t);0<e.imgBytes&&o5===0&&(o5=62500*Fu());var r=setTimeout(function(){if(e.waitingForImages=!1,e.count===0&&(e.stylesheets&&$3(e,e.stylesheets),e.unsuspend)){var l=e.unsuspend;e.unsuspend=null,l()}},(e.imgBytes>o5?50:800)+t);return e.unsuspend=s,function(){e.unsuspend=null,clearTimeout(i),clearTimeout(r)}}:null}function J3(){if(this.count--,this.count===0&&(this.imgCount===0||!this.waitingForImages)){if(this.stylesheets)$3(this,this.stylesheets);else if(this.unsuspend){var e=this.unsuspend;this.unsuspend=null,e()}}}var w3=null;function $3(e,t){e.stylesheets=null,e.unsuspend!==null&&(e.count++,w3=new Map,t.forEach(vn,e),w3=null,J3.call(e))}function vn(e,t){if(!(t.state.loading&4)){var s=w3.get(e);if(s)var i=s.get(null);else{s=new Map,w3.set(e,s);for(var r=e.querySelectorAll("link[data-precedence],style[data-precedence]"),l=0;l<r.length;l++){var a=r[l];(a.nodeName==="LINK"||a.getAttribute("media")!=="not all")&&(s.set(a.dataset.precedence,a),i=a)}i&&s.set(null,i)}r=t.instance,a=r.getAttribute("data-precedence"),l=s.get(a)||i,l===i&&s.set(null,r),s.set(a,r),this.count++,i=J3.bind(this),r.addEventListener("load",i),r.addEventListener("error",i),l?l.parentNode.insertBefore(r,l.nextSibling):(e=e.nodeType===9?e.head:e,e.insertBefore(r,e.firstChild)),t.state.loading|=4}}var Dt={$$typeof:d0,Provider:null,Consumer:null,_currentValue:w,_currentValue2:w,_threadCount:0};function gn(e,t,s,i,r,l,a,u,c){this.tag=1,this.containerInfo=e,this.pingCache=this.current=this.pendingChildren=null,this.timeoutHandle=-1,this.callbackNode=this.next=this.pendingContext=this.context=this.cancelPendingCommit=null,this.callbackPriority=0,this.expirationTimes=a4(-1),this.entangledLanes=this.shellSuspendCounter=this.errorRecoveryDisabledLanes=this.expiredLanes=this.warmLanes=this.pingedLanes=this.suspendedLanes=this.pendingLanes=0,this.entanglements=a4(0),this.hiddenUpdates=a4(null),this.identifierPrefix=i,this.onUncaughtError=r,this.onCaughtError=l,this.onRecoverableError=a,this.pooledCache=null,this.pooledCacheLanes=0,this.formState=c,this.incompleteTransitions=new Map}function g6(e,t,s,i,r,l,a,u,c,y,A,U){return e=new gn(e,t,s,a,c,y,A,U,u),t=1,l===!0&&(t|=24),l=g2(3,null,null,t),e.current=l,l.stateNode=e,t=V4(),t.refCount++,e.pooledCache=t,t.refCount++,l.memoizedState={element:i,isDehydrated:s,cache:t},$4(l),e}function S6(e){return e?(e=he,e):he}function b6(e,t,s,i,r,l){r=S6(r),i.context===null?i.context=r:i.pendingContext=r,i=g1(t),i.payload={element:s},l=l===void 0?null:l,l!==null&&(i.callback=l),s=S1(e,i,t),s!==null&&(f2(s,e,t),dt(s,e,t))}function z6(e,t){if(e=e.memoizedState,e!==null&&e.dehydrated!==null){var s=e.retryLane;e.retryLane=s!==0&&s<t?s:t}}function m5(e,t){z6(e,t),(e=e.alternate)&&z6(e,t)}function M6(e){if(e.tag===13||e.tag===31){var t=Q1(e,67108864);t!==null&&f2(t,e,67108864),m5(e,67108864)}}function E6(e){if(e.tag===13||e.tag===31){var t=E2();t=u4(t);var s=Q1(e,t);s!==null&&f2(s,e,t),m5(e,t)}}var k3=!0;function Sn(e,t,s,i){var r=M.T;M.T=null;var l=L.p;try{L.p=2,p5(e,t,s,i)}finally{L.p=l,M.T=r}}function bn(e,t,s,i){var r=M.T;M.T=null;var l=L.p;try{L.p=8,p5(e,t,s,i)}finally{L.p=l,M.T=r}}function p5(e,t,s,i){if(k3){var r=_5(i);if(r===null)Ps(e,t,i,W3,s),x6(e,i);else if(Mn(r,e,t,s,i))i.stopPropagation();else if(x6(e,i),t&4&&-1<zn.indexOf(e)){for(;r!==null;){var l=le(r);if(l!==null)switch(l.tag){case 3:if(l=l.stateNode,l.current.memoizedState.isDehydrated){var a=Y1(l.pendingLanes);if(a!==0){var u=l;for(u.pendingLanes|=2,u.entangledLanes|=2;a;){var c=1<<31-T2(a);u.entanglements[1]|=c,a&=~c}K2(l),(b0&6)===0&&(U3=h2()+500,Et(0))}}break;case 31:case 13:u=Q1(l,2),u!==null&&f2(u,l,2),j3(),m5(l,2)}if(l=_5(i),l===null&&Ps(e,t,i,W3,s),l===r)break;r=l}r!==null&&i.stopPropagation()}else Ps(e,t,i,null,s)}}function _5(e){return e=h4(e),f5(e)}var W3=null;function f5(e){if(W3=null,e=re(e),e!==null){var t=E(e);if(t===null)e=null;else{var s=t.tag;if(s===13){if(e=S(t),e!==null)return e;e=null}else if(s===31){if(e=j(t),e!==null)return e;e=null}else if(s===3){if(t.stateNode.current.memoizedState.isDehydrated)return t.tag===3?t.stateNode.containerInfo:null;e=null}else t!==e&&(e=null)}}return W3=e,null}function A6(e){switch(e){case"beforetoggle":case"cancel":case"click":case"close":case"contextmenu":case"copy":case"cut":case"auxclick":case"dblclick":case"dragend":case"dragstart":case"drop":case"focusin":case"focusout":case"input":case"invalid":case"keydown":case"keypress":case"keyup":case"mousedown":case"mouseup":case"paste":case"pause":case"play":case"pointercancel":case"pointerdown":case"pointerup":case"ratechange":case"reset":case"resize":case"seeked":case"submit":case"toggle":case"touchcancel":case"touchend":case"touchstart":case"volumechange":case"change":case"selectionchange":case"textInput":case"compositionstart":case"compositionend":case"compositionupdate":case"beforeblur":case"afterblur":case"beforeinput":case"blur":case"fullscreenchange":case"focus":case"hashchange":case"popstate":case"select":case"selectstart":return 2;case"drag":case"dragenter":case"dragexit":case"dragleave":case"dragover":case"mousemove":case"mouseout":case"mouseover":case"pointermove":case"pointerout":case"pointerover":case"scroll":case"touchmove":case"wheel":case"mouseenter":case"mouseleave":case"pointerenter":case"pointerleave":return 8;case"message":switch(ua()){case j5:return 2;case H5:return 8;case Lt:case na:return 32;case q5:return 268435456;default:return 32}default:return 32}}var h5=!1,U1=null,R1=null,j1=null,Ut=new Map,Rt=new Map,H1=[],zn="mousedown mouseup touchcancel touchend touchstart auxclick dblclick pointercancel pointerdown pointerup dragend dragstart drop compositionend compositionstart keydown keypress keyup input textInput copy cut paste click change contextmenu reset".split(" ");function x6(e,t){switch(e){case"focusin":case"focusout":U1=null;break;case"dragenter":case"dragleave":R1=null;break;case"mouseover":case"mouseout":j1=null;break;case"pointerover":case"pointerout":Ut.delete(t.pointerId);break;case"gotpointercapture":case"lostpointercapture":Rt.delete(t.pointerId)}}function jt(e,t,s,i,r,l){return e===null||e.nativeEvent!==l?(e={blockedOn:t,domEventName:s,eventSystemFlags:i,nativeEvent:l,targetContainers:[r]},t!==null&&(t=le(t),t!==null&&M6(t)),e):(e.eventSystemFlags|=i,t=e.targetContainers,r!==null&&t.indexOf(r)===-1&&t.push(r),e)}function Mn(e,t,s,i,r){switch(t){case"focusin":return U1=jt(U1,e,t,s,i,r),!0;case"dragenter":return R1=jt(R1,e,t,s,i,r),!0;case"mouseover":return j1=jt(j1,e,t,s,i,r),!0;case"pointerover":var l=r.pointerId;return Ut.set(l,jt(Ut.get(l)||null,e,t,s,i,r)),!0;case"gotpointercapture":return l=r.pointerId,Rt.set(l,jt(Rt.get(l)||null,e,t,s,i,r)),!0}return!1}function O6(e){var t=re(e.target);if(t!==null){var s=E(t);if(s!==null){if(t=s.tag,t===13){if(t=S(s),t!==null){e.blockedOn=t,Q5(e.priority,function(){E6(s)});return}}else if(t===31){if(t=j(s),t!==null){e.blockedOn=t,Q5(e.priority,function(){E6(s)});return}}else if(t===3&&s.stateNode.current.memoizedState.isDehydrated){e.blockedOn=s.tag===3?s.stateNode.containerInfo:null;return}}}e.blockedOn=null}function F3(e){if(e.blockedOn!==null)return!1;for(var t=e.targetContainers;0<t.length;){var s=_5(e.nativeEvent);if(s===null){s=e.nativeEvent;var i=new s.constructor(s.type,s);f4=i,s.target.dispatchEvent(i),f4=null}else return t=le(s),t!==null&&M6(t),e.blockedOn=s,!1;t.shift()}return!0}function N6(e,t,s){F3(e)&&s.delete(t)}function En(){h5=!1,U1!==null&&F3(U1)&&(U1=null),R1!==null&&F3(R1)&&(R1=null),j1!==null&&F3(j1)&&(j1=null),Ut.forEach(N6),Rt.forEach(N6)}function I3(e,t){e.blockedOn===t&&(e.blockedOn=null,h5||(h5=!0,d.unstable_scheduleCallback(d.unstable_NormalPriority,En)))}var P3=null;function C6(e){P3!==e&&(P3=e,d.unstable_scheduleCallback(d.unstable_NormalPriority,function(){P3===e&&(P3=null);for(var t=0;t<e.length;t+=3){var s=e[t],i=e[t+1],r=e[t+2];if(typeof i!="function"){if(f5(i||s)===null)continue;break}var l=le(s);l!==null&&(e.splice(t,3),t-=3,_s(l,{pending:!0,data:r,method:s.method,action:i},i,r))}}))}function Ge(e){function t(c){return I3(c,e)}U1!==null&&I3(U1,e),R1!==null&&I3(R1,e),j1!==null&&I3(j1,e),Ut.forEach(t),Rt.forEach(t);for(var s=0;s<H1.length;s++){var i=H1[s];i.blockedOn===e&&(i.blockedOn=null)}for(;0<H1.length&&(s=H1[0],s.blockedOn===null);)O6(s),s.blockedOn===null&&H1.shift();if(s=(e.ownerDocument||e).$$reactFormReplay,s!=null)for(i=0;i<s.length;i+=3){var r=s[i],l=s[i+1],a=r[d2]||null;if(typeof l=="function")a||C6(s);else if(a){var u=null;if(l&&l.hasAttribute("formAction")){if(r=l,a=l[d2]||null)u=a.formAction;else if(f5(r)!==null)continue}else u=a.action;typeof u=="function"?s[i+1]=u:(s.splice(i,3),i-=3),C6(s)}}}function D6(){function e(l){l.canIntercept&&l.info==="react-transition"&&l.intercept({handler:function(){return new Promise(function(a){return r=a})},focusReset:"manual",scroll:"manual"})}function t(){r!==null&&(r(),r=null),i||setTimeout(s,20)}function s(){if(!i&&!navigation.transition){var l=navigation.currentEntry;l&&l.url!=null&&navigation.navigate(l.url,{state:l.getState(),info:"react-transition",history:"replace"})}}if(typeof navigation=="object"){var i=!1,r=null;return navigation.addEventListener("navigate",e),navigation.addEventListener("navigatesuccess",t),navigation.addEventListener("navigateerror",t),setTimeout(s,100),function(){i=!0,navigation.removeEventListener("navigate",e),navigation.removeEventListener("navigatesuccess",t),navigation.removeEventListener("navigateerror",t),r!==null&&(r(),r=null)}}}function y5(e){this._internalRoot=e}e4.prototype.render=y5.prototype.render=function(e){var t=this._internalRoot;if(t===null)throw Error(n(409));var s=t.current,i=E2();b6(s,i,e,t,null,null)},e4.prototype.unmount=y5.prototype.unmount=function(){var e=this._internalRoot;if(e!==null){this._internalRoot=null;var t=e.containerInfo;b6(e.current,2,null,e,null,null),j3(),t[ie]=null}};function e4(e){this._internalRoot=e}e4.prototype.unstable_scheduleHydration=function(e){if(e){var t=X5();e={blockedOn:null,target:e,priority:t};for(var s=0;s<H1.length&&t!==0&&t<H1[s].priority;s++);H1.splice(s,0,e),s===0&&O6(e)}};var U6=p.version;if(U6!=="19.2.7")throw Error(n(527,U6,"19.2.7"));L.findDOMNode=function(e){var t=e._reactInternals;if(t===void 0)throw typeof e.render=="function"?Error(n(188)):(e=Object.keys(e).join(","),Error(n(268,e)));return e=f(t),e=e!==null?B(e):null,e=e===null?null:e.stateNode,e};var An={bundleType:0,version:"19.2.7",rendererPackageName:"react-dom",currentDispatcherRef:M,reconcilerVersion:"19.2.7"};if(typeof __REACT_DEVTOOLS_GLOBAL_HOOK__<"u"){var t4=__REACT_DEVTOOLS_GLOBAL_HOOK__;if(!t4.isDisabled&&t4.supportsFiber)try{Ze=t4.inject(An),y2=t4}catch{}}return qt.createRoot=function(e,t){if(!x(e))throw Error(n(299));var s=!1,i="",r=Lr,l=Gr,a=Xr;return t!=null&&(t.unstable_strictMode===!0&&(s=!0),t.identifierPrefix!==void 0&&(i=t.identifierPrefix),t.onUncaughtError!==void 0&&(r=t.onUncaughtError),t.onCaughtError!==void 0&&(l=t.onCaughtError),t.onRecoverableError!==void 0&&(a=t.onRecoverableError)),t=g6(e,1,!1,null,null,s,i,null,r,l,a,D6),e[ie]=t.current,Is(e),new y5(t)},qt.hydrateRoot=function(e,t,s){if(!x(e))throw Error(n(299));var i=!1,r="",l=Lr,a=Gr,u=Xr,c=null;return s!=null&&(s.unstable_strictMode===!0&&(i=!0),s.identifierPrefix!==void 0&&(r=s.identifierPrefix),s.onUncaughtError!==void 0&&(l=s.onUncaughtError),s.onCaughtError!==void 0&&(a=s.onCaughtError),s.onRecoverableError!==void 0&&(u=s.onRecoverableError),s.formState!==void 0&&(c=s.formState)),t=g6(e,1,!0,t,s??null,i,r,c,l,a,u,D6),t.context=S6(null),s=t.current,i=E2(),i=u4(i),r=g1(i),r.callback=null,S1(s,r,i),s=i,t.current.lanes=s,Ke(t,s),K2(t),e[ie]=t.current,Is(e),new e4(t)},qt.version="19.2.7",qt}var Q6;function qn(){if(Q6)return g5.exports;Q6=1;function d(){if(!(typeof __REACT_DEVTOOLS_GLOBAL_HOOK__>"u"||typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE!="function"))try{__REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE(d)}catch(p){console.error(p)}}return d(),g5.exports=Hn(),g5.exports}var Yn=qn();const D5={power655:{id:"power655",label:"Power 6/55",shortLabel:"6/55",maxNumber:55,pickCount:6,totalCombinations:28989675,dataFileName:"power655.jsonl",prizeByMatch:{3:5e4,4:5e5,5:5e9,6:4e10}},power645:{id:"power645",label:"Power 6/45",shortLabel:"6/45",maxNumber:45,pickCount:6,totalCombinations:8145060,dataFileName:"power645.jsonl",prizeByMatch:{3:3e4,4:3e5,5:1e7,6:12e9}},power535:{id:"power535",label:"Power 5/35",shortLabel:"5/35",maxNumber:35,pickCount:5,totalCombinations:324632,dataFileName:"power535.jsonl",prizeByMatch:{3:3e4,4:5e5,5:1e10}}},Bn="power655",M5=Object.values(D5),l4=D5.power655,Z6=new Map;function I6(d,p){if(p<0||p>d)return 0;if(p===0||p===d)return 1;const T=Math.min(p,d-p),n=`${d}:${T}`,x=Z6.get(n);if(x!==void 0)return x;let E=1;for(let j=1;j<=T;j+=1)E=E*(d-T+j)/j;const S=Math.round(E);return Z6.set(n,S),S}function Qe(d){return[...d].sort((p,T)=>p-T)}function U5(d,p=l4){return d.length!==p.pickCount||new Set(d).size!==p.pickCount?!1:d.every(n=>Number.isInteger(n)&&n>=1&&n<=p.maxNumber)}function te(d,p=l4){const T=Qe(d);if(!U5(T,p))throw new Error(`Combination must contain ${p.pickCount} unique integers from 1 to ${p.maxNumber}.`);let n=0,x=0;for(let E=0;E<p.pickCount;E+=1){const S=T[E];for(let j=x+1;j<S;j+=1)n+=I6(p.maxNumber-j,p.pickCount-E-1);x=S}return n}function r4(d,p=l4){if(!Number.isInteger(d)||d<0||d>=p.totalCombinations)throw new Error(`Index must be an integer from 0 to ${p.totalCombinations-1}.`);const T=[];let n=d,x=0;for(let E=0;E<p.pickCount;E+=1)for(let S=x+1;S<=p.maxNumber;S+=1){const j=I6(p.maxNumber-S,p.pickCount-E-1);if(n<j){T.push(S),x=S;break}n-=j}return T}function o1(d){return d.map(p=>String(p).padStart(2,"0")).join(" ")}function Ln(d){return d.trim().split(/[\s,;-]+/).filter(Boolean).map(T=>Number(T))}function Xe(d=l4){const p=Array.from({length:d.maxNumber},(T,n)=>n+1);for(let T=p.length-1;T>0;T-=1){const n=Math.floor(Math.random()*(T+1));[p[T],p[n]]=[p[n],p[T]]}return Qe(p.slice(0,d.pickCount))}const u2=5500,s4=4,E5=1;function V6(d,p,T,n,x){const E=d%u2,S=Math.floor(d/u2);return E>=p&&E<=T&&S>=n&&S<=x}function Gn({product:d,importedIndexes:p,selectedIndexes:T,randomIndex:n,focusRequest:x,mode:E,zoom:S,onZoomChange:j,onSelect:N}){const f=k.useRef(null),B=k.useRef(null),Y=k.useRef(null),X=k.useRef(null),i0=k.useRef(0),h0=k.useRef(null),u0=k.useRef(s4*S+E5),y0=k.useRef(null),r0=k.useRef(null),n0=k.useRef({importedIndexes:p,selectedIndexes:T,importedList:[],selectedList:[],randomIndex:n,mode:E,cellSize:s4*S,stride:s4*S+E5,width:0,height:0,dpr:window.devicePixelRatio||1,hoverIndex:null}),d0=s4*S,P=d0+E5,m0=Math.ceil(d.totalCombinations/u2),U0=u2*P,W=m0*P,Y0=k.useMemo(()=>[...p],[p]),F0=k.useMemo(()=>[...T],[T]);function H0(v,O,q,H,z,G,Z,F,f0){v.fillStyle=q;const C0=Math.max(1,F.cellSize);for(const p0 of O){if(!V6(p0,H,z,G,Z))continue;const A0=p0%u2,r2=Math.floor(p0/u2);v.fillRect(A0*F.stride-f0.scrollLeft,r2*F.stride-f0.scrollTop,C0,C0)}}function t0(){const v=Y.current,O=B.current,q=v==null?void 0:v.getContext("2d");if(!v||!O||!q)return;const H=n0.current,z=H.width,G=H.height;if(z===0||G===0)return;q.setTransform(H.dpr,0,0,H.dpr,0,0),q.clearRect(0,0,z,G),q.fillStyle="#121417",q.fillRect(0,0,z,G);const Z=Math.max(0,Math.floor(O.scrollLeft/H.stride)),F=Math.min(u2-1,Math.ceil((O.scrollLeft+z)/H.stride)),f0=Math.max(0,Math.floor(O.scrollTop/H.stride)),C0=Math.min(m0-1,Math.ceil((O.scrollTop+G)/H.stride)),p0=F-Z+1,A0=C0-f0+1,r2=H.mode==="heatmap"?"#303338":"#2b2b2b";q.fillStyle=r2;const q2=Math.max(1,H.cellSize);for(let n2=0;n2<A0;n2+=1){const J2=f0+n2,G2=J2*H.stride-O.scrollTop;for(let X2=0;X2<p0;X2+=1){const se=Z+X2;if(J2*u2+se>=d.totalCombinations)break;q.fillRect(se*H.stride-O.scrollLeft,G2,q2,q2)}}if(H0(q,H.importedList,H.mode==="heatmap"?"#ff6b5f":"#ee3f46",Z,F,f0,C0,H,O),H0(q,H.selectedList,"#27a7ff",Z,F,f0,C0,H,O),H.randomIndex!==null&&H0(q,[H.randomIndex],"#f7c948",Z,F,f0,C0,H,O),H.cellSize>=22){q.fillStyle="#d8dde6",q.font="10px Inter, system-ui, sans-serif";for(let n2=f0;n2<=C0;n2+=1){const J2=n2*H.stride-O.scrollTop;for(let G2=Z;G2<=F;G2+=1){const X2=n2*u2+G2;if(X2>=d.totalCombinations)break;q.fillText(o1(r4(X2,d)),G2*H.stride-O.scrollLeft+3,J2+14)}}}if(H.hoverIndex!==null&&V6(H.hoverIndex,Z,F,f0,C0)){const n2=H.hoverIndex%u2,J2=Math.floor(H.hoverIndex/u2);q.strokeStyle="#ffffff",q.lineWidth=1,q.strokeRect(n2*H.stride-O.scrollLeft-1,J2*H.stride-O.scrollTop-1,H.cellSize+2,H.cellSize+2)}}function E0(){cancelAnimationFrame(i0.current),i0.current=requestAnimationFrame(t0)}function K(v){return Math.min(10,Math.max(.55,Number(v.toFixed(2))))}function G0(v,O,q){const H=B.current;if(!H){j(K(v));return}y0.current={xRatio:(H.scrollLeft+O)/P,yRatio:(H.scrollTop+q)/P,viewportX:O,viewportY:q},j(K(v))}k.useEffect(()=>{const v=B.current;if(v&&u0.current!==P){const O=y0.current??{xRatio:(v.scrollLeft+v.clientWidth/2)/u0.current,yRatio:(v.scrollTop+v.clientHeight/2)/u0.current,viewportX:v.clientWidth/2,viewportY:v.clientHeight/2};v.scrollLeft=Math.max(0,O.xRatio*P-O.viewportX),v.scrollTop=Math.max(0,O.yRatio*P-O.viewportY),u0.current=P,y0.current=null}n0.current={...n0.current,importedIndexes:p,selectedIndexes:T,importedList:Y0,selectedList:F0,randomIndex:n,mode:E,cellSize:d0,stride:P},E0()},[d0,p,Y0,E,d,n,m0,T,F0,P]),k.useEffect(()=>{const v=Y.current,O=B.current,q=f.current;if(!v||!O||!q)return;const H=v,z=q;function G(){const F=z.getBoundingClientRect(),f0=window.devicePixelRatio||1;h0.current=F,n0.current.width=F.width,n0.current.height=F.height,n0.current.dpr=f0,H.width=Math.floor(F.width*f0),H.height=Math.floor(F.height*f0),H.style.width=`${F.width}px`,H.style.height=`${F.height}px`,E0()}const Z=new ResizeObserver(G);return Z.observe(z),O.addEventListener("scroll",E0,{passive:!0}),G(),()=>{cancelAnimationFrame(i0.current),Z.disconnect(),O.removeEventListener("scroll",E0)}},[d,m0]),k.useEffect(()=>{const v=B.current;if(!v||x===null)return;const O=requestAnimationFrame(()=>{const q=Math.floor(x.index/u2),H=x.index%u2,z=Math.max(0,v.scrollWidth-v.clientWidth),G=Math.max(0,v.scrollHeight-v.clientHeight),Z=Math.min(z,Math.max(0,H*P+d0/2-v.clientWidth/2)),F=Math.min(G,Math.max(0,q*P+d0/2-v.clientHeight/2));n0.current.hoverIndex=x.index,v.scrollTo({left:Z,top:F,behavior:"smooth"}),E0()});return()=>cancelAnimationFrame(O)},[d0,x,P]);function Z0(v){var f0;const O=B.current,q=h0.current??((f0=f.current)==null?void 0:f0.getBoundingClientRect());if(!q||!O)return null;const H=v.clientX-q.left+O.scrollLeft,z=v.clientY-q.top+O.scrollTop,G=Math.floor(H/P),Z=Math.floor(z/P);if(G<0||G>=u2||Z<0||Z>=m0)return null;const F=Z*u2+G;return F>=d.totalCombinations?null:F}function M(v,O){const q=X.current,H=n0.current.hoverIndex;if(n0.current.hoverIndex=O,!q||O===null){q&&(q.hidden=!0),H!==null&&E0();return}q.hidden=!1,q.style.transform=`translate(${v.clientX+14}px, ${v.clientY+14}px)`,H!==O&&(q.textContent=`#${O.toLocaleString("en-US")} - ${o1(r4(O,d))}`,E0())}function L(v){const O=B.current,q=r0.current;if(q!=null&&q.active&&O){O.scrollLeft=q.left-(v.clientX-q.x),O.scrollTop=q.top-(v.clientY-q.y);return}M(v,Z0(v))}function w(v){const O=B.current;!O||v.button!==0||(r0.current={x:v.clientX,y:v.clientY,left:O.scrollLeft,top:O.scrollTop,active:!1},v.currentTarget.setPointerCapture(v.pointerId))}function T0(v){const O=r0.current,q=O?Math.abs(v.clientX-O.x)+Math.abs(v.clientY-O.y):0;if(r0.current=null,q>8)return;const H=Z0(v);H!==null&&N(H)}function S0(){r0.current=null,n0.current.hoverIndex=null,X.current&&(X.current.hidden=!0),E0()}function m(v){var q;const O=B.current;if(O){if(v.preventDefault(),v.ctrlKey||v.metaKey){const H=h0.current??((q=f.current)==null?void 0:q.getBoundingClientRect());if(!H)return;const z=v.deltaY<0?1.18:1/1.18;G0(S*z,v.clientX-H.left,v.clientY-H.top);return}O.scrollLeft+=v.shiftKey?v.deltaY:v.deltaX,O.scrollTop+=v.shiftKey?v.deltaX:v.deltaY}}k.useEffect(()=>{const v=Y.current;if(v)return v.addEventListener("wheel",m,{passive:!1}),()=>v.removeEventListener("wheel",m)},[S,P]);function D(v){r0.current&&Math.abs(v.clientX-r0.current.x)+Math.abs(v.clientY-r0.current.y)>8&&(r0.current.active=!0),L(v)}return R.jsxs("div",{className:"grid-wrapper",ref:f,children:[R.jsx("div",{className:"grid-scroller",ref:B,children:R.jsx("div",{style:{width:U0,height:W}})}),R.jsx("canvas",{ref:Y,className:"grid-canvas",onPointerDown:w,onPointerMove:D,onPointerUp:T0,onPointerLeave:S0}),R.jsx("div",{ref:X,className:"tooltip",hidden:!0})]})}function Xn({inputRef:d,onFileChange:p}){return R.jsx("input",{ref:d,className:"hidden-input",type:"file",accept:".csv,.json,.jsonl,application/json,text/csv,text/plain",onChange:p})}/**
 * @license lucide-react v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Qn=d=>d.replace(/([a-z0-9])([A-Z])/g,"$1-$2").toLowerCase(),P6=(...d)=>d.filter((p,T,n)=>!!p&&p.trim()!==""&&n.indexOf(p)===T).join(" ").trim();/**
 * @license lucide-react v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Vn=k.forwardRef(({color:d="currentColor",size:p=24,strokeWidth:T=2,absoluteStrokeWidth:n,className:x="",children:E,iconNode:S,...j},N)=>k.createElement("svg",{ref:N,...Zn,width:p,height:p,stroke:d,strokeWidth:n?Number(T)*24/Number(p):T,className:P6("lucide",x),...j},[...S.map(([f,B])=>k.createElement(f,B)),...Array.isArray(E)?E:[E]]));/**
 * @license lucide-react v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const i2=(d,p)=>{const T=k.forwardRef(({className:n,...x},E)=>k.createElement(Vn,{ref:E,iconNode:p,className:P6(`lucide-${Qn(d)}`,n),...x}));return T.displayName=`${d}`,T};/**
 * @license lucide-react v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const K6=i2("Activity",[["path",{d:"M22 12h-2.48a2 2 0 0 0-1.93 1.46l-2.35 8.36a.25.25 0 0 1-.48 0L9.24 2.18a.25.25 0 0 0-.48 0l-2.35 8.36A2 2 0 0 1 4.49 12H2",key:"169zse"}]]);/**
 * @license lucide-react v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Kn=i2("Calculator",[["rect",{width:"16",height:"20",x:"4",y:"2",rx:"2",key:"1nb95v"}],["line",{x1:"8",x2:"16",y1:"6",y2:"6",key:"x4nwl0"}],["line",{x1:"16",x2:"16",y1:"14",y2:"18",key:"wjye3r"}],["path",{d:"M16 10h.01",key:"1m94wz"}],["path",{d:"M12 10h.01",key:"1nrarc"}],["path",{d:"M8 10h.01",key:"19clt8"}],["path",{d:"M12 14h.01",key:"1etili"}],["path",{d:"M8 14h.01",key:"6423bh"}],["path",{d:"M12 18h.01",key:"mhygvu"}],["path",{d:"M8 18h.01",key:"lrp35t"}]]);/**
 * @license lucide-react v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Jn=i2("ChevronDown",[["path",{d:"m6 9 6 6 6-6",key:"qrunsl"}]]);/**
 * @license lucide-react v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const wn=i2("Crosshair",[["circle",{cx:"12",cy:"12",r:"10",key:"1mglay"}],["line",{x1:"22",x2:"18",y1:"12",y2:"12",key:"l9bcsi"}],["line",{x1:"6",x2:"2",y1:"12",y2:"12",key:"13hhkx"}],["line",{x1:"12",x2:"12",y1:"6",y2:"2",key:"10w3f3"}],["line",{x1:"12",x2:"12",y1:"22",y2:"18",key:"15g9kq"}]]);/**
 * @license lucide-react v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const $n=i2("Download",[["path",{d:"M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4",key:"ih7n3h"}],["polyline",{points:"7 10 12 15 17 10",key:"2ggqvy"}],["line",{x1:"12",x2:"12",y1:"15",y2:"3",key:"1vk2je"}]]);/**
 * @license lucide-react v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const kn=i2("Eraser",[["path",{d:"m7 21-4.3-4.3c-1-1-1-2.5 0-3.4l9.6-9.6c1-1 2.5-1 3.4 0l5.6 5.6c1 1 1 2.5 0 3.4L13 21",key:"182aya"}],["path",{d:"M22 21H7",key:"t4ddhn"}],["path",{d:"m5 11 9 9",key:"1mo9qw"}]]);/**
 * @license lucide-react v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Wn=i2("Grid2x2",[["path",{d:"M12 3v18",key:"108xh3"}],["path",{d:"M3 12h18",key:"1i2n21"}],["rect",{x:"3",y:"3",width:"18",height:"18",rx:"2",key:"h1oib"}]]);/**
 * @license lucide-react v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Fn=i2("LockKeyhole",[["circle",{cx:"12",cy:"16",r:"1",key:"1au0dj"}],["rect",{x:"3",y:"10",width:"18",height:"12",rx:"2",key:"6s8ecr"}],["path",{d:"M7 10V7a5 5 0 0 1 10 0v3",key:"1pqi11"}]]);/**
 * @license lucide-react v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const In=i2("LogIn",[["path",{d:"M15 3h4a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2h-4",key:"u53s6r"}],["polyline",{points:"10 17 15 12 10 7",key:"1ail0h"}],["line",{x1:"15",x2:"3",y1:"12",y2:"12",key:"v6grx8"}]]);/**
 * @license lucide-react v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Pn=i2("Minus",[["path",{d:"M5 12h14",key:"1ays0h"}]]);/**
 * @license lucide-react v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const ed=i2("RotateCcw",[["path",{d:"M3 12a9 9 0 1 0 9-9 9.75 9.75 0 0 0-6.74 2.74L3 8",key:"1357e3"}],["path",{d:"M3 3v5h5",key:"1xhq8a"}]]);/**
 * @license lucide-react v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const td=i2("Search",[["circle",{cx:"11",cy:"11",r:"8",key:"4ej97u"}],["path",{d:"m21 21-4.3-4.3",key:"1qie3q"}]]);/**
 * @license lucide-react v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const sd=i2("Shuffle",[["path",{d:"m18 14 4 4-4 4",key:"10pe0f"}],["path",{d:"m18 2 4 4-4 4",key:"pucp1d"}],["path",{d:"M2 18h1.973a4 4 0 0 0 3.3-1.7l5.454-8.6a4 4 0 0 1 3.3-1.7H22",key:"1ailkh"}],["path",{d:"M2 6h1.972a4 4 0 0 1 3.6 2.2",key:"km57vx"}],["path",{d:"M22 18h-6.041a4 4 0 0 1-3.3-1.8l-.359-.45",key:"os18l9"}]]);/**
 * @license lucide-react v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const id=i2("ThermometerSun",[["path",{d:"M12 9a4 4 0 0 0-2 7.5",key:"1jvsq6"}],["path",{d:"M12 3v2",key:"1w22ol"}],["path",{d:"m6.6 18.4-1.4 1.4",key:"w2yidj"}],["path",{d:"M20 4v10.54a4 4 0 1 1-4 0V4a2 2 0 0 1 4 0Z",key:"iof6y5"}],["path",{d:"M4 13H2",key:"118le4"}],["path",{d:"M6.34 7.34 4.93 5.93",key:"1brd51"}]]);/**
 * @license lucide-react v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const rd=i2("Upload",[["path",{d:"M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4",key:"ih7n3h"}],["polyline",{points:"17 8 12 3 7 8",key:"t8dd8p"}],["line",{x1:"12",x2:"12",y1:"3",y2:"15",key:"widbto"}]]);/**
 * @license lucide-react v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const ld=i2("User",[["path",{d:"M19 21v-2a4 4 0 0 0-4-4H9a4 4 0 0 0-4 4v2",key:"975kel"}],["circle",{cx:"12",cy:"7",r:"4",key:"17ys0d"}]]);/**
 * @license lucide-react v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const ad=i2("ZoomIn",[["circle",{cx:"11",cy:"11",r:"8",key:"4ej97u"}],["line",{x1:"21",x2:"16.65",y1:"21",y2:"16.65",key:"13gj7c"}],["line",{x1:"11",x2:"11",y1:"8",y2:"14",key:"1vmskp"}],["line",{x1:"8",x2:"14",y1:"11",y2:"11",key:"durymu"}]]);function ud({onLogin:d}){const[p,T]=k.useState(""),[n,x]=k.useState(""),[E,S]=k.useState("");function j(N){N.preventDefault();const f=p.trim();if(!f||!n.trim()){S("Nhap du username va password.");return}S(""),d(f)}return R.jsx("main",{className:"login-shell",children:R.jsxs("section",{className:"login-panel",children:[R.jsxs("div",{className:"login-brand",children:[R.jsx("p",{className:"eyebrow",children:"Vietlott Power 6/55"}),R.jsx("h1",{children:"Combination Space"})]}),R.jsxs("form",{className:"login-form",onSubmit:j,children:[R.jsxs("label",{className:"field-row",children:[R.jsx(ld,{size:18}),R.jsx("input",{autoComplete:"username",placeholder:"Username",value:p,onChange:N=>T(N.target.value)})]}),R.jsxs("label",{className:"field-row",children:[R.jsx(Fn,{size:18}),R.jsx("input",{autoComplete:"current-password",placeholder:"Password",type:"password",value:n,onChange:N=>x(N.target.value)})]}),E&&R.jsx("p",{className:"login-error",children:E}),R.jsxs("button",{className:"primary login-submit",type:"submit",children:[R.jsx(In,{size:17}),"Login"]})]})]})})}function nd({entries:d}){return R.jsxs("section",{className:"panel log-panel",children:[R.jsx("h2",{children:"Log"}),R.jsx("div",{className:"log-list",children:d.length===0?R.jsx("p",{className:"empty-state",children:"Chưa có hành động."}):d.map(p=>R.jsxs("div",{className:`log-entry ${p.level}`,children:[R.jsx("time",{children:p.at}),R.jsx("span",{children:p.message})]},p.id))})]})}function dd({value:d,onChange:p}){const[T,n]=k.useState(!1),x=k.useRef(null),E=M5.find(S=>S.id===d)??M5[0];return k.useEffect(()=>{function S(N){var f;(f=x.current)!=null&&f.contains(N.target)||n(!1)}function j(N){N.key==="Escape"&&n(!1)}return document.addEventListener("pointerdown",S),document.addEventListener("keydown",j),()=>{document.removeEventListener("pointerdown",S),document.removeEventListener("keydown",j)}},[]),R.jsxs("div",{className:"product-selector",ref:x,children:[R.jsx("span",{className:"product-selector-label",children:"Product"}),R.jsxs("button",{type:"button",className:"product-select-button","aria-haspopup":"listbox","aria-expanded":T,onClick:()=>n(S=>!S),children:[R.jsx("span",{children:E.label}),R.jsx(Jn,{size:15,"aria-hidden":"true"})]}),T?R.jsx("div",{className:"product-menu",role:"listbox","aria-label":"Product",children:M5.map(S=>R.jsx("button",{type:"button",className:`product-option ${S.id===d?"active":""}`,role:"option","aria-selected":S.id===d,onClick:()=>{p(S.id),n(!1)},children:S.label},S.id))}):null]})}function cd({onSearch:d}){const[p,T]=k.useState("");function n(x){x.preventDefault(),d(p)}return R.jsxs("form",{className:"search-box",onSubmit:n,children:[R.jsx(td,{size:17}),R.jsx("input",{"aria-label":"Search combination",placeholder:"07 13 22 31 44 52",value:p,onChange:x=>T(x.target.value)}),R.jsx("button",{type:"submit",children:"Search Combination"})]})}function od({product:d,importedCount:p,selectedCount:T}){const n=p/d.totalCombinations*100;return R.jsxs("section",{className:"panel stats-panel",children:[R.jsx("h2",{children:"Thống kê"}),R.jsxs("div",{className:"stat-row",children:[R.jsx("span",{children:"Tổng tổ hợp"}),R.jsx("strong",{children:d.totalCombinations.toLocaleString("en-US")})]}),R.jsxs("div",{className:"stat-row",children:[R.jsx("span",{children:"Đã xuất hiện"}),R.jsx("strong",{children:p.toLocaleString("en-US")})]}),R.jsxs("div",{className:"stat-row",children:[R.jsx("span",{children:"Đã chọn"}),R.jsx("strong",{children:T.toLocaleString("en-US")})]}),R.jsxs("div",{className:"stat-row",children:[R.jsx("span",{children:"Tỷ lệ phủ"}),R.jsxs("strong",{children:[n.toFixed(6),"%"]})]}),R.jsxs("div",{className:"legend",children:[R.jsxs("span",{children:[R.jsx("i",{className:"swatch gray"})," Gray"]}),R.jsxs("span",{children:[R.jsx("i",{className:"swatch red"})," Red"]}),R.jsxs("span",{children:[R.jsx("i",{className:"swatch blue"})," Blue"]}),R.jsxs("span",{children:[R.jsx("i",{className:"swatch yellow"})," Yellow"]})]})]})}function md({mode:d,zoom:p,onImportClick:T,onClearImported:n,onClearSelected:x,onExportSelected:E,onRandomPick:S,onCalculatedPick:j,onBacktestPick:N,onStatTest:f,onResetView:B,onToggleMode:Y,onZoomIn:X,onZoomOut:i0}){return R.jsxs("div",{className:"toolbar",children:[R.jsxs("button",{className:"primary",onClick:T,title:"Import Data",children:[R.jsx(rd,{size:16}),"Import Data"]}),R.jsxs("button",{onClick:n,title:"Clear Imported Data",children:[R.jsx(kn,{size:16}),"Clear Imported"]}),R.jsxs("button",{onClick:x,title:"Clear Selected Cells",children:[R.jsx(Pn,{size:16}),"Clear Selected"]}),R.jsxs("button",{onClick:E,title:"Export Selected Cells",children:[R.jsx($n,{size:16}),"Export Selected"]}),R.jsxs("button",{onClick:S,title:"Random Pick",children:[R.jsx(sd,{size:16}),"Random Pick"]}),R.jsxs("button",{onClick:j,title:"Calculated Pick",children:[R.jsx(Kn,{size:16}),"Calculated Pick"]}),R.jsxs("button",{onClick:N,title:"Replay Backtest",children:[R.jsx(K6,{size:16}),"Backtest"]}),R.jsxs("button",{onClick:f,title:"Random Monte Carlo Statistical Test",children:[R.jsx(K6,{size:16}),"Stat Test"]}),R.jsxs("button",{onClick:B,title:"Reset View",children:[R.jsx(ed,{size:16}),"Reset View"]}),R.jsxs("button",{onClick:Y,title:"Toggle Grid / Heatmap Mode",children:[d==="grid"?R.jsx(id,{size:16}):R.jsx(Wn,{size:16}),d==="grid"?"Heatmap":"Grid"]}),R.jsxs("button",{onClick:X,title:"Zoom In",children:[R.jsx(ad,{size:16}),"Zoom In"]}),R.jsxs("button",{onClick:i0,title:"Zoom Out",children:[R.jsx(wn,{size:16}),"Zoom Out"]}),R.jsxs("span",{className:"zoom-readout",title:"Current grid zoom",children:[Math.round(p*100),"%"]})]})}const pd=.18;function _d(d){return d.id==="power535"?4e4:d.id==="power645"?2e4:12345}function fd(d){return d.id==="power535"?{coldNumberWeight:.24,hotNumberWeight:.16,lowPairWeight:.22,hotPairWeight:.12,spreadWeight:.12,balanceWeight:.1,repeatNumberPenaltyWeight:.08,clusterPenaltyWeight:.08}:d.id==="power645"?{coldNumberWeight:.36,hotNumberWeight:.08,lowPairWeight:.28,hotPairWeight:.1,spreadWeight:.1,balanceWeight:.08,repeatNumberPenaltyWeight:.06,clusterPenaltyWeight:.06}:{coldNumberWeight:.48,hotNumberWeight:.04,lowPairWeight:.3,hotPairWeight:.06,spreadWeight:.08,balanceWeight:.04,repeatNumberPenaltyWeight:.04,clusterPenaltyWeight:.05}}function ea(d,p){return`${d}:${p}`}function hd(d,p){const T=Array.from({length:p.maxNumber+1},()=>0),n=new Map;for(const x of d){const E=r4(x,p);for(const S of E)T[S]+=1;for(let S=0;S<E.length;S+=1)for(let j=S+1;j<E.length;j+=1){const N=ea(E[S],E[j]);n.set(N,(n.get(N)??0)+1)}}return{numberFrequency:T,pairFrequency:n,maxNumberFrequency:Math.max(1,...T),maxPairFrequency:Math.max(1,...n.values())}}function yd(d,p,T){let n=0,x=0;for(const m0 of d)n+=p.numberFrequency[m0],x=Math.max(x,p.numberFrequency[m0]);let E=0,S=0,j=0;for(let m0=0;m0<d.length;m0+=1)for(let U0=m0+1;U0<d.length;U0+=1){const W=p.pairFrequency.get(ea(d[m0],d[U0]))??0;E+=W,S=Math.max(S,W),j+=1}const N=fd(T),f=n/T.pickCount,B=E/j,Y=1-f/p.maxNumberFrequency,X=f/p.maxNumberFrequency,i0=1-B/p.maxPairFrequency,h0=B/p.maxPairFrequency,u0=(d[d.length-1]-d[0])/(T.maxNumber-1),y0=d.filter(m0=>m0%2===1).length,r0=T.pickCount/2,n0=1-Math.abs(y0-r0)/r0,d0=x/p.maxNumberFrequency,P=S/p.maxPairFrequency;return{score:Y*N.coldNumberWeight+X*N.hotNumberWeight+i0*N.lowPairWeight+h0*N.hotPairWeight+u0*N.spreadWeight+n0*N.balanceWeight-d0*N.repeatNumberPenaltyWeight-P*N.clusterPenaltyWeight+Math.random()*1e-4,averageNumberFrequency:f,averagePairFrequency:B}}function Td(d,p,T,n){if(p.length===0||T<=0)return 0;const x=new Set(d);return Math.max(...p.map(S=>S.filter(j=>x.has(j)).length))/n.pickCount*T}function ta(d,p,T,n={}){const x=T??_d(p);if(d.size===0){const y0=Xe(p);return{numbers:y0,index:te(y0,p),score:0,baseScore:0,diversityPenalty:0,candidateCount:1,averageNumberFrequency:0,averagePairFrequency:0}}const E=hd(d,p),S=n.diversityMemory??[],j=n.diversityPenaltyWeight??pd;let N=Xe(p),f=te(N,p),B=Number.NEGATIVE_INFINITY,Y=Number.NEGATIVE_INFINITY,X=0,i0=0,h0=0;const u0=new Set;for(let y0=0;y0<x;y0+=1){const r0=Xe(p),n0=te(r0,p);if(u0.has(n0)||d.has(n0))continue;u0.add(n0);const d0=yd(r0,E,p),P=Td(r0,S,j,p),m0=d0.score-P;m0>B&&(N=r0,f=n0,B=m0,Y=d0.score,X=P,i0=d0.averageNumberFrequency,h0=d0.averagePairFrequency)}return{numbers:N,index:f,score:B,baseScore:Y,diversityPenalty:X,candidateCount:u0.size,averageNumberFrequency:i0,averagePairFrequency:h0}}function sa(d,p,T){const n=Qe(d);return U5(n,T)?{index:te(n,T),numbers:n,source:p}:`${p}: bộ số không hợp lệ (${d.join(", ")})`}function J6(d,p){const T=[],n=[];return d.split(/\r?\n/).map(E=>E.trim()).filter(Boolean).forEach((E,S)=>{const j=E.split(",").map(X=>X.trim());if(S===0&&j.some(X=>/[a-z_]/i.test(X)))return;const f=j.map(X=>Number(X)),B=f.length>=p.pickCount+1?f.slice(1,p.pickCount+1):f.slice(0,p.pickCount);if(B.some(X=>!Number.isFinite(X))){n.push(`CSV dòng ${S+1}: không đọc được số.`);return}const Y=sa(B,`CSV dòng ${S+1}`,p);if(typeof Y=="string"){n.push(Y);return}T.push(Y)}),{combinations:T,errors:n}}function w6(d,p){const T=[],n=[],x=d.trim();if(!x)return{combinations:T,errors:n};const E=[];try{const S=JSON.parse(x);E.push(...Array.isArray(S)?S:[S])}catch{x.split(/\r?\n/).forEach((S,j)=>{if(S.trim())try{E.push(JSON.parse(S))}catch{n.push(`JSON dòng ${j+1}: lỗi định dạng.`)}})}return E.forEach((S,j)=>{let N;if(Array.isArray(S))N=S.map(B=>Number(B)).slice(0,p.pickCount);else if(S&&typeof S=="object"){const B=S.result??S.numbers;Array.isArray(B)&&(N=B.map(Y=>Number(Y)).slice(0,p.pickCount))}if(!N){n.push(`JSON bản ghi ${j+1}: không tìm thấy mảng result/numbers.`);return}const f=sa(N,`JSON bản ghi ${j+1}`,p);if(typeof f=="string"){n.push(f);return}T.push(f)}),{combinations:T,errors:n}}function $6(d,p,T){const n=p.toLowerCase();if(n.endsWith(".csv"))return J6(d,T);if(n.endsWith(".json")||n.endsWith(".jsonl"))return w6(d,T);const x=J6(d,T);return x.combinations.length>0?x:w6(d,T)}const k6=["Random","Frequency Weighted","Hot Numbers","Cold Numbers","Delay","Pair Frequency","Triple Frequency","Your Algorithm"],ia=18;function vd(d){return d.id==="power535"?2e4:d.id==="power645"?8e3:5e3}function N5(d,p){return d<p?`${d}:${p}`:`${p}:${d}`}function ra(d,p,T){return[d,p,T].sort((n,x)=>n-x).join(":")}function gd(d,p){return{name:d,distribution:Array.from({length:p.pickCount+1},()=>0),totalMatches:0,exactHits:0,bestMatch:-1,totalRevenue:0,bestPrediction:null}}function Sd(d,p){const T=Array.from({length:p.maxNumber+1},()=>0),n=Array.from({length:p.maxNumber+1},()=>-1),x=new Map,E=new Map;return d.forEach((S,j)=>{for(const N of S.numbers)T[N]+=1,n[N]=j;for(let N=0;N<S.numbers.length;N+=1)for(let f=N+1;f<S.numbers.length;f+=1){const B=N5(S.numbers[N],S.numbers[f]);x.set(B,(x.get(B)??0)+1);for(let Y=f+1;Y<S.numbers.length;Y+=1){const X=ra(S.numbers[N],S.numbers[f],S.numbers[Y]);E.set(X,(E.get(X)??0)+1)}}}),{numberFrequency:T,lastSeen:n,pairFrequency:x,tripleFrequency:E}}function Yt(d,p){const T=[],n=Array.from({length:d.maxNumber},(x,E)=>E+1);for(;T.length<d.pickCount;){let x=n[0],E=Number.NEGATIVE_INFINITY;for(const S of n){const j=p(S,T)+Math.random()*1e-6;j>E&&(E=j,x=S)}T.push(x),n.splice(n.indexOf(x),1)}return Qe(T)}function bd(d,p){const T=[],n=Array.from({length:p.maxNumber},(x,E)=>E+1);for(;T.length<p.pickCount;){const x=n.reduce((j,N)=>j+d.numberFrequency[N]+1,0);let E=Math.random()*x,S=n[0];for(const j of n)if(E-=d.numberFrequency[j]+1,E<=0){S=j;break}T.push(S),n.splice(n.indexOf(S),1)}return Qe(T)}function la(d,p,T,n,x=[]){if(p.length===0||d==="Random")return Xe(n);const E=Sd(p,n);if(d==="Frequency Weighted")return bd(E,n);if(d==="Hot Numbers")return Yt(n,S=>E.numberFrequency[S]);if(d==="Cold Numbers"){const S=Math.max(...E.numberFrequency);return Yt(n,j=>S-E.numberFrequency[j])}return d==="Delay"?Yt(n,S=>E.lastSeen[S]===-1?p.length+1:p.length-E.lastSeen[S]):d==="Pair Frequency"?Yt(n,(S,j)=>j.length===0?E.numberFrequency[S]+1:j.reduce((f,B)=>f+(E.pairFrequency.get(N5(S,B))??0),0)/j.length+.05*E.numberFrequency[S]):d==="Triple Frequency"?Yt(n,(S,j)=>{let N=0,f=0;for(let Y=0;Y<j.length;Y+=1)for(let X=Y+1;X<j.length;X+=1)N+=E.tripleFrequency.get(ra(S,j[Y],j[X]))??0,f+=1;const B=j.reduce((Y,X)=>Y+(E.pairFrequency.get(N5(S,X))??0),0);return(f>0?N/f:0)+.25*B+.03*E.numberFrequency[S]}):ta(T,n,vd(n),{diversityMemory:x,diversityPenaltyWeight:n.id==="power535"?.28:.18}).numbers}function i4(d){return d.reduce((p,T)=>p+T,0)/d.length}function A5(d,p=i4(d)){if(d.length<2)return 0;const T=d.reduce((n,x)=>n+(x-p)**2,0)/(d.length-1);return Math.sqrt(T)}function x5(d,p){return d.filter(T=>T<=p).length/d.length*100}function O5(d,p){return(d.filter(T=>T>=p).length+1)/(d.length+1)}function W6(d,p,T){const n=d.filter(x=>p.includes(x)).length;return{matches:n,revenue:T.prizeByMatch[n]??0}}async function zd(d,p,T){const n=new Map(k6.map(j=>[j,gd(j,p)])),x=[d[0]],E=new Set([d[0].index]);let S=[];for(let j=1;j<d.length;j+=1){const N=d[j];for(const f of k6){const B=la(f,x,E,p,f==="Your Algorithm"?S:[]),Y=te(B,p),X=B.filter(h0=>N.numbers.includes(h0)).length,i0=n.get(f);i0.distribution[X]+=1,i0.totalMatches+=X,i0.totalRevenue+=p.prizeByMatch[X]??0,X===p.pickCount&&(i0.exactHits+=1),X>i0.bestMatch&&(i0.bestMatch=X,i0.bestPrediction={index:Y,numbers:B,actual:N.numbers,drawIndex:j}),f==="Your Algorithm"&&(S=[B,...S].slice(0,ia))}x.push(N),E.add(N.index),j%25===0&&(T==null||T({drawIndex:j,totalDraws:d.length-1,results:[...n.values()]}),await new Promise(f=>setTimeout(f,0)))}return[...n.values()]}function Bt(d,p){const T=p*1e4,n=d.totalRevenue-T,x=d.distribution.reduce((E,S,j)=>E+(j>=3?S:0),0);return{avgMatches:d.totalMatches/p,hits3:d.distribution[3],hits4:d.distribution[4],hits5:d.distribution[5],hits3Plus:x,exactHits:d.exactHits,roi:T>0?n/T*100:0}}async function Md(d,p,T=500,n){const x=d.length-1,E=x*1e4,S=[d[0]],j=new Set([d[0].index]);let N=[];const f=Array.from({length:p.pickCount+1},()=>0),B=Array.from({length:T},()=>0),Y=Array.from({length:T},()=>0),X=Array.from({length:T},()=>0);let i0=0,h0=0,u0=0;for(let H0=1;H0<d.length;H0+=1){const t0=d[H0],E0=la("Your Algorithm",S,j,p,N),K=W6(E0,t0.numbers,p);f[K.matches]+=1,i0+=K.matches,u0+=K.revenue,K.matches>=3&&(h0+=1),N=[E0,...N].slice(0,ia);for(let G0=0;G0<T;G0+=1){const Z0=W6(Xe(p),t0.numbers,p);B[G0]+=Z0.matches,X[G0]+=Z0.revenue,Z0.matches>=3&&(Y[G0]+=1)}S.push(t0),j.add(t0.index),H0%25===0&&(n==null||n(H0,x),await new Promise(G0=>setTimeout(G0,0)))}const y0=B.map(H0=>H0/x),r0=X.map(H0=>(H0-E)/E*100),n0=i0/x,d0=(u0-E)/E*100,P=i4(y0),m0=A5(y0,P),U0=i4(Y),W=A5(Y,U0),Y0=i4(r0),F0=A5(r0,Y0);return{randomRuns:T,testedDraws:x,your:{avgMatches:n0,hits3Plus:h0,roi:d0,distribution:f},random:{avgMatchesMean:P,avgMatchesStd:m0,hits3PlusMean:U0,hits3PlusStd:W,roiMean:Y0,roiStd:F0},avgMatchesZScore:m0>0?(n0-P)/m0:0,avgMatchesPercentile:x5(y0,n0),avgMatchesPValue:O5(y0,n0),hits3PlusPercentile:x5(Y,h0),hits3PlusPValue:O5(Y,h0),roiPercentile:x5(r0,d0),roiPValue:O5(r0,d0)}}const Ed=`{"date":"2025-06-29","id":"00001","result":[7,9,10,16,19,9],"process_time":"2025-07-08 16:42:15.649180"}
...
{"date":"2026-07-14","id":"00761","result":[1,19,23,31,34,7],"process_time":"2026-07-14T21:03:41.935776"}
{"date":"2026-07-14","id":"00762","result":[10,18,19,28,33,9],"process_time":"2026-07-14T21:03:41.935716"}
`,Ad=`{"date":"2017-10-25","id":"00198","result":[12,17,23,25,34,38],"process_time":"2023-01-30 14:08:46.805928"}\r
...
`,xd=`{"date":"2017-08-01","id":"00001","result":[5,10,14,23,24,38,35],"process_time":"2022-05-07 07:56:43.143266"}
...
`,Od="http://127.0.0.1:8787/logs",F6=500,Nd=12,Cd={power655:xd,power645:Ad,power535:Ed};let Dd=0;function Ud(){return new Date().toLocaleTimeString("vi-VN",{hour:"2-digit",minute:"2-digit",second:"2-digit"})}function Rd(d,p){const T=new Blob([p.join(`
`)],{type:"text/csv;charset=utf-8"}),n=URL.createObjectURL(T),x=document.createElement("a");x.href=n,x.download=d,x.click(),URL.revokeObjectURL(n)}function jd(d){return["index",...Array.from({length:d},(T,n)=>`n${n+1}`),"selected_at"].join(",")}function Hd(d,p){return Array.from({length:Math.max(0,p-2)},(T,n)=>n+3).map(T=>`${T}=${d[T]??0}`).join(" | ")}function qd(d){fetch(Od,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(d)}).catch(()=>{console.debug("Log server is not running; skipped file history write.")})}function Yd(){const d=k.useRef(null),[p,T]=k.useState(()=>localStorage.getItem("power655_user")),[n,x]=k.useState(Bn),[E,S]=k.useState(()=>new Set),[j,N]=k.useState([]),[f,B]=k.useState(()=>new Map),[Y,X]=k.useState([]),[i0,h0]=k.useState("grid"),[u0,y0]=k.useState(1.4),[r0,n0]=k.useState(null),[d0,P]=k.useState(null),[m0,U0]=k.useState(!1),[W,Y0]=k.useState(!1),[F0,H0]=k.useState([]),t0=D5[n],E0=k.useMemo(()=>new Set(f.keys()),[f]);function K(z,G){const Z={id:++Dd,at:Ud(),level:z,message:G};X(F=>[Z,...F].slice(0,120)),qd({...Z,user:p??"anonymous"})}function G0(z){localStorage.setItem("power655_user",z),T(z)}function Z0(){localStorage.removeItem("power655_user"),T(null)}k.useEffect(()=>{try{const z=$6(Cd[n],t0.dataFileName,t0);S(new Set(z.combinations.map(G=>G.index))),N(z.combinations),B(new Map),n0(null),H0([]),P({index:0,id:Date.now()+Math.random()}),K("success",`Auto-loaded data/${t0.dataFileName} for ${t0.label}: ${z.combinations.length.toLocaleString("en-US")} bộ hợp lệ.`),z.errors.length>0&&(z.errors.slice(0,8).forEach(G=>K("warn",G)),z.errors.length>8&&K("warn",`Auto-load còn ${z.errors.length-8} lỗi khác đã rút gọn.`))}catch(z){K("error",`Auto-load data/${t0.dataFileName} thất bại: ${z instanceof Error?z.message:"không đọc được dữ liệu"}.`)}},[t0,n]);function M(z,G=Math.max(u0,3.2)){y0(Math.min(10,Math.max(.55,G))),P({index:z,id:Date.now()+Math.random()})}function L(){var z;(z=d.current)==null||z.click()}async function w(z){var Z;const G=(Z=z.target.files)==null?void 0:Z[0];if(z.target.value="",!!G)try{const F=await G.text(),f0=$6(F,G.name,t0);S(C0=>{const p0=new Set(C0);return f0.combinations.forEach(A0=>p0.add(A0.index)),p0}),N(C0=>{const p0=new Set(C0.map(r2=>r2.index)),A0=f0.combinations.filter(r2=>!p0.has(r2.index));return[...C0,...A0]}),K("success",`Import file "${G.name}" thành công: ${f0.combinations.length.toLocaleString("en-US")} bộ hợp lệ.`),f0.errors.length>0&&(f0.errors.slice(0,12).forEach(C0=>K("warn",C0)),f0.errors.length>12&&K("warn",`Còn ${f0.errors.length-12} lỗi khác đã bị rút gọn.`))}catch(F){K("error",`Lỗi định dạng file: ${F instanceof Error?F.message:"không đọc được file"}.`)}}function T0(z){const G=r4(z,t0);B(Z=>{const F=new Map(Z);return F.has(z)?(F.delete(z),K("info",`Bỏ chọn #${z.toLocaleString("en-US")} - ${o1(G)}.`)):(F.set(z,{index:z,numbers:G,selectedAt:new Date().toISOString()}),K("info",`Click chọn #${z.toLocaleString("en-US")} - ${o1(G)}.`)),F})}function S0(z){const G=Qe(Ln(z));if(!U5(G,t0)){K("error",`Search lỗi: "${z}" không phải bộ ${t0.pickCount} số hợp lệ cho ${t0.label}.`);return}const Z=te(G,t0);K("info",`Search ${o1(G)} tại #${Z.toLocaleString("en-US")}.`),M(Z)}function m(){const z=Xe(t0),G=te(z,t0);n0(G),K("success",`Random Pick: ${o1(z)} tại #${G.toLocaleString("en-US")}.`),M(G,Math.max(u0,3.6))}function D(){E.size===0&&K("warn","Calculated Pick cần dữ liệu import; đang dùng random fallback.");const z=ta(E,t0,void 0,{diversityMemory:F0});n0(z.index),H0(G=>[z.numbers,...G].slice(0,Nd)),K("success",`Calculated Pick: ${o1(z.numbers)} tại #${z.index.toLocaleString("en-US")} | score ${z.score.toFixed(4)} | base ${z.baseScore.toFixed(4)} | diversity penalty ${z.diversityPenalty.toFixed(4)} | avg number freq ${z.averageNumberFrequency.toFixed(2)} | avg pair freq ${z.averagePairFrequency.toFixed(2)} | ${z.candidateCount.toLocaleString("en-US")} candidates.`),M(z.index,Math.max(u0,3.6))}async function v(){if(m0){K("warn","Replay Backtest đang chạy, hãy đợi lượt hiện tại hoàn tất.");return}if(j.length<2){K("warn","Replay Backtest cần ít nhất 2 bộ số lịch sử.");return}U0(!0),K("info",`Replay Backtest comparison started: ${j.length.toLocaleString("en-US")} historical draws.`);try{const z=await zd(j,t0,({drawIndex:p0,totalDraws:A0,results:r2})=>{if(p0%100===0){const q2=r2.find(n2=>n2.name==="Your Algorithm");K("info",`Replay progress ${p0}/${A0}: Your avg=${q2?(q2.totalMatches/p0).toFixed(3):"n/a"}, Random avg=${(r2[0].totalMatches/p0).toFixed(3)}.`)}}),G=j.length-1,Z=[...z].sort((p0,A0)=>Bt(A0,G).avgMatches-Bt(p0,G).avgMatches);K("success",`Replay Backtest done. Tested=${G.toLocaleString("en-US")} draws. Baseline included. No strategy used actual draw data before picking.`);for(const p0 of Z){const A0=Bt(p0,G);K(p0.name==="Your Algorithm"?"success":"info",`${p0.name}: avg=${A0.avgMatches.toFixed(3)} | ${Hd(p0.distribution,t0.pickCount)} | 3+ total=${A0.hits3Plus} | exact=${A0.exactHits} | best=${p0.bestMatch} | ROI=${A0.roi.toFixed(2)}% | dist [${p0.distribution.map((r2,q2)=>`${q2}:${r2}`).join(" ")}].`)}const F=z.find(p0=>p0.name==="Your Algorithm"),f0=z.find(p0=>p0.name==="Random");if(F&&f0){const p0=Bt(F,G),A0=Bt(f0,G);K(p0.avgMatches>A0.avgMatches?"success":"warn",`Your vs Random: avg delta=${(p0.avgMatches-A0.avgMatches).toFixed(3)}, 3+ hits delta=${p0.hits3Plus-A0.hits3Plus}.`)}const C0=Z[0].bestPrediction;C0&&(n0(C0.index),M(C0.index,Math.max(u0,3.6)),K("info",`Best replay sample from top strategy ${Z[0].name} at draw #${C0.drawIndex+1}: predicted ${o1(C0.numbers)} vs actual ${o1(C0.actual)}.`))}catch(z){K("error",`Replay Backtest failed: ${z instanceof Error?z.message:"unknown error"}.`)}finally{U0(!1)}}async function O(){if(W){K("warn","Stat Test đang chạy, hãy đợi lượt hiện tại hoàn tất.");return}if(j.length<2){K("warn","Stat Test cần ít nhất 2 bộ số lịch sử.");return}Y0(!0),K("info",`Stat Test started: Your Algorithm vs ${F6.toLocaleString("en-US")} random replay runs on ${j.length-1} draws.`);try{const z=await Md(j,t0,F6,(G,Z)=>{G%100===0&&K("info",`Stat Test progress: ${G}/${Z} draws.`)});K("success",`Stat Test avg matches: Your=${z.your.avgMatches.toFixed(4)}, Random=${z.random.avgMatchesMean.toFixed(4)} ± ${z.random.avgMatchesStd.toFixed(4)}, z=${z.avgMatchesZScore.toFixed(2)}, percentile=${z.avgMatchesPercentile.toFixed(1)}%, p≈${z.avgMatchesPValue.toFixed(4)}.`),K(z.hits3PlusPercentile>=95?"success":"info",`Stat Test 3+ hits: Your=${z.your.hits3Plus}, Random=${z.random.hits3PlusMean.toFixed(2)} ± ${z.random.hits3PlusStd.toFixed(2)}, percentile=${z.hits3PlusPercentile.toFixed(1)}%, p≈${z.hits3PlusPValue.toFixed(4)}.`),K(z.roiPercentile>=95?"success":"info",`Stat Test ROI: Your=${z.your.roi.toFixed(2)}%, Random=${z.random.roiMean.toFixed(2)}% ± ${z.random.roiStd.toFixed(2)}%, percentile=${z.roiPercentile.toFixed(1)}%, p≈${z.roiPValue.toFixed(4)}.`),K("info",`Stat Test Your distribution: [${z.your.distribution.map((G,Z)=>`${Z}:${G}`).join(" ")}].`)}catch(z){K("error",`Stat Test failed: ${z instanceof Error?z.message:"unknown error"}.`)}finally{Y0(!1)}}function q(){if(f.size===0){K("warn","Export Selected Cells: chưa có ô nào được chọn.");return}const z=[jd(t0.pickCount)];[...f.values()].sort((G,Z)=>G.index-Z.index).forEach(G=>z.push([G.index,...G.numbers,G.selectedAt].join(","))),Rd(`selected-${t0.id}-combinations.csv`,z),K("success",`Export Selected Cells: ${f.size.toLocaleString("en-US")} dòng CSV.`)}function H(){y0(1.4),P({index:0,id:Date.now()+Math.random()}),K("info","Reset View về đầu không gian tổ hợp.")}return p?R.jsxs("main",{className:"app-shell",children:[R.jsxs("header",{className:"app-header",children:[R.jsxs("div",{children:[R.jsxs("p",{className:"eyebrow",children:["Vietlott ",t0.label]}),R.jsx("h1",{children:"Combination Space Dashboard"})]}),R.jsxs("div",{className:"header-actions",children:[R.jsx(dd,{value:n,onChange:x}),R.jsx(cd,{onSearch:S0}),R.jsx("button",{onClick:Z0,title:"Logout",children:"Logout"})]})]}),R.jsx(md,{mode:i0,zoom:u0,onImportClick:L,onClearImported:()=>{S(new Set),N([]),H0([]),K("info","Clear Imported Data hoàn tất.")},onClearSelected:()=>{B(new Map),K("info","Clear Selected Cells hoàn tất.")},onExportSelected:q,onRandomPick:m,onCalculatedPick:D,onBacktestPick:v,onStatTest:O,onResetView:H,onToggleMode:()=>{h0(z=>z==="grid"?"heatmap":"grid"),K("info","Toggle Grid / Heatmap Mode.")},onZoomIn:()=>y0(z=>Math.min(10,Number((z*1.22).toFixed(2)))),onZoomOut:()=>y0(z=>Math.max(.55,Number((z/1.22).toFixed(2))))}),R.jsxs("div",{className:"workspace",children:[R.jsx("section",{className:"grid-section",children:R.jsx(Gn,{product:t0,importedIndexes:E,selectedIndexes:E0,randomIndex:r0,focusRequest:d0,mode:i0,zoom:u0,onZoomChange:y0,onSelect:T0})}),R.jsxs("aside",{className:"side-panel",children:[R.jsx(od,{product:t0,importedCount:E.size,selectedCount:f.size}),R.jsx(nd,{entries:Y})]})]}),R.jsx(Xn,{inputRef:d,onFileChange:w})]}):R.jsx(ud,{onLogin:G0})}Yn.createRoot(document.getElementById("root")).render(R.jsx(k.StrictMode,{children:R.jsx(Yd,{})}));
